...
{
		HX_STACK_FRAME("ApplicationMain","create",0x2f7db141,"ApplicationMain.create","ApplicationMain.hx",21,0x0780ded5)
		HX_STACK_LINE(23)
...
{
		HX_STACK_FRAME("ApplicationMain","init",0x9137fa15,"ApplicationMain.init","ApplicationMain.hx",65,0x0780ded5)
		HX_STACK_LINE(67)
		...
		Void run(Dynamic __){
			HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","ApplicationMain.hx",69,0x0780ded5)
			HX_STACK_ARG(__,"__")
			{
				HX_STACK_LINE(71)
				(loaded[(int)0])++;
...
{
		HX_STACK_FRAME("ApplicationMain","main",0x93d2f73e,"ApplicationMain.main","ApplicationMain.hx",95,0x0780ded5)
		struct _Function_1_1{
			inline static Dynamic Block( ){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","ApplicationMain.hx",109,0x0780ded5)
				{
					...
					__result->Add(HX_HCSTRING("height","\xe7","\x07","\x4c","\x02") , (int)600,false);
					...
					__result->Add(HX_HCSTRING("title","\x98","\x15","\x3b","\x10") , HX_HCSTRING("Platformer","\x00","\x62","\x83","\x96"),false);
		...
		struct _Function_1_2{
			inline static Dynamic Block( Dynamic &tmp){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","ApplicationMain.hx",97,0x0780ded5)
				{
					hx::Anon __result = hx::Anon_obj::Create();
					__result->Add(HX_HCSTRING("build","\x2e","\xdb","\xea","\xba") , HX_HCSTRING("14","\xe3","\x2a","\x00","\x00"),false);
					__result->Add(HX_HCSTRING("company","\x3d","\x15","\x69","\x83") , HX_HCSTRING("Company Name","\x4e","\x48","\x0d","\xcb"),false);
					__result->Add(HX_HCSTRING("file","\x7c","\xce","\xbb","\x43") , HX_HCSTRING("Platformer","\x00","\x62","\x83","\x96"),false);
					__result->Add(HX_HCSTRING("fps","\xe9","\xc7","\x4d","\x00") , (int)30,false);
					__result->Add(HX_HCSTRING("name","\x4b","\x72","\xff","\x48") , HX_HCSTRING("Platformer","\x00","\x62","\x83","\x96"),false);
					__result->Add(HX_HCSTRING("orientation","\xd0","\xee","\xfe","\xfd") , HX_HCSTRING("","\x00","\x00","\x00","\x00"),false);
					__result->Add(HX_HCSTRING("packageName","\xf1","\x04","\xad","\x04") , HX_HCSTRING("com.sample.platformer","\x37","\xd0","\xb5","\x1c"),false);
...
{
		HX_STACK_FRAME("ApplicationMain","start",0x45b5d9bd,"ApplicationMain.start","ApplicationMain.hx",154,0x0780ded5)
		HX_STACK_LINE(156)
		::lime::Assets_obj::initialize();
		HX_STACK_LINE(203)
		::DocumentClass_obj::__new();
		HX_STACK_LINE(161)
		::openfl::display::MovieClip tmp = ::openfl::Lib_obj::current;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(161)
		::openfl::events::Event tmp1 = ::openfl::events::Event_obj::__new(HX_HCSTRING("resize","\xf4","\x59","\x7b","\x08"),false,false);		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(161)
		tmp->stage->dispatchEvent(tmp1);
		HX_STACK_LINE(163)
