...
{  hx::ObjectPtr< _Event_String_Void_obj > _result_ = new _Event_String_Void_obj();
...
Dynamic _Event_String_Void_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
...
Dynamic _Event_String_Void_obj::__SetField(const ::String &inName,const Dynamic &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 8:
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*Array< bool >*/ ,(int)offsetof(_Event_String_Void_obj,__repeat),HX_HCSTRING("__repeat","\x7b","\x02","\xac","\xae")},
	{hx::fsObject /*Array< int >*/ ,(int)offsetof(_Event_String_Void_obj,__priorities),HX_HCSTRING("__priorities","\xe2","\xcb","\xe6","\x1c")},
	{hx::fsObject /*cpp::ArrayBase*/ ,(int)offsetof(_Event_String_Void_obj,__listeners),HX_HCSTRING("__listeners","\x5f","\xae","\xba","\x21")},
	{ hx::fsUnknown, 0, null()}
};
