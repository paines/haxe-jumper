...
;
		...
		HX_STACK_LINE(108)
		::lime::app::_Event_lime_ui_Joystick_Void tmp8 = ::lime::ui::Joystick_obj::onConnect;		HX_STACK_VAR(tmp8,"tmp8");
		HX_STACK_LINE(108)
		Dynamic tmp9 = this->__onJoystickConnect_dyn();		HX_STACK_VAR(tmp9,"tmp9");
		HX_STACK_LINE(108)
		tmp8->add(tmp9,null(),null());
		HX_STACK_LINE(110)
		::lime::app::_Event_lime_ui_Touch_Void tmp10 = ::lime::ui::Touch_obj::onStart;		HX_STACK_VAR(tmp10,"tmp10");
		HX_STACK_LINE(110)
		...
		HX_STACK_LINE(112)
		::lime::app::_Event_lime_ui_Touch_Void tmp14 = ::lime::ui::Touch_obj::onEnd;		HX_STACK_VAR(tmp14,"tmp14");
		HX_STACK_LINE(112)
...
Void Module_obj::removeWindow( ::lime::ui::Window window){
{
		...
		if ((tmp)){
			...
			HX_STACK_LINE(130)
			int tmp4 = this->__windows->indexOf(tmp3,null());		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(130)
			int tmp5 = tmp4;		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(130)
			tmp1 = (tmp5 > (int)-1);
...
Void Module_obj::unregisterModule( ::lime::app::Application application){
{
		...
		tmp4->remove(tmp5);
		HX_STACK_LINE(170)
		::lime::app::_Event_lime_ui_Joystick_Void tmp6 = ::lime::ui::Joystick_obj::onConnect;		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(170)
		...
		tmp8->remove(tmp9);
		HX_STACK_LINE(172)
		::lime::app::_Event_lime_ui_Touch_Void tmp10 = ::lime::ui::Touch_obj::onMove;		HX_STACK_VAR(tmp10,"tmp10");
		HX_STACK_LINE(172)
