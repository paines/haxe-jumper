...
{
HX_STACK_FRAME("lime.app.Promise_String","new",0xecf99bcd,"lime.app.Promise_String.new","lime/app/Promise.hx",16,0x10ba4f0b)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(18)
...
{  hx::ObjectPtr< Promise_String_obj > _result_ = new Promise_String_obj();
...
::lime::app::Promise_String Promise_String_obj::progress( Float progress){
...
HX_DEFINE_DYNAMIC_FUNC1(Promise_String_obj,progress,return )

bool Promise_String_obj::get_isComplete( ){
	HX_STACK_FRAME("lime.app.Promise_String","get_isComplete",0x76565cbf,"lime.app.Promise_String.get_isComplete","lime/app/Promise.hx",115,0x10ba4f0b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(117)
	::lime::app::Future tmp = this->future;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(117)
...
bool Promise_String_obj::get_isError( ){
	HX_STACK_FRAME("lime.app.Promise_String","get_isError",0x6e5c5002,"lime.app.Promise_String.get_isError","lime/app/Promise.hx",122,0x10ba4f0b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(124)
	::lime::app::Future tmp = this->future;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(124)
...
Dynamic Promise_String_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
...
Dynamic Promise_String_obj::__SetField(const ::String &inName,const Dynamic &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 6:
