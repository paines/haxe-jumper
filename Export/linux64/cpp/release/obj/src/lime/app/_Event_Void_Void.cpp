...
{  hx::ObjectPtr< _Event_Void_Void_obj > _result_ = new _Event_Void_Void_obj();
...
{
		HX_STACK_FRAME("lime.app._Event_Void_Void","cancel",0x875173c7,"lime.app._Event_Void_Void.cancel","lime/app/Event.hx",211,0xbda45bec)
		HX_STACK_THIS(this)
		HX_STACK_LINE(211)
		this->canceled = true;
	}
...
bool _Event_Void_Void_obj::has( Dynamic listener){
	HX_STACK_FRAME("lime.app._Event_Void_Void","has",0xd4b876ed,"lime.app._Event_Void_Void.has","lime/app/Event.hx",247,0xbda45bec)
	HX_STACK_THIS(this)
	HX_STACK_ARG(listener,"listener")
	HX_STACK_LINE(250)
	{
...
{
		HX_STACK_FRAME("lime.app._Event_Void_Void","remove",0xd3a62291,"lime.app._Event_Void_Void.remove","lime/app/Event.hx",262,0xbda45bec)
		HX_STACK_THIS(this)
		HX_STACK_ARG(listener,"listener")
		HX_STACK_LINE(265)
...
{
		HX_STACK_FRAME("lime.app._Event_Void_Void","dispatch",0x14a94247,"lime.app._Event_Void_Void.dispatch","lime/app/Event.hx",135,0xbda45bec)
		HX_STACK_THIS(this)
		HX_STACK_LINE(137)
		this->canceled = false;
		HX_STACK_LINE(139)
...
Dynamic _Event_Void_Void_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
...
Dynamic _Event_Void_Void_obj::__SetField(const ::String &inName,const Dynamic &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 8:
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*Array< bool >*/ ,(int)offsetof(_Event_Void_Void_obj,__repeat),HX_HCSTRING("__repeat","\x7b","\x02","\xac","\xae")},
	{hx::fsObject /*Array< int >*/ ,(int)offsetof(_Event_Void_Void_obj,__priorities),HX_HCSTRING("__priorities","\xe2","\xcb","\xe6","\x1c")},
	{hx::fsObject /*cpp::ArrayBase*/ ,(int)offsetof(_Event_Void_Void_obj,__listeners),HX_HCSTRING("__listeners","\x5f","\xae","\xba","\x21")},
	{ hx::fsUnknown, 0, null()}
};
