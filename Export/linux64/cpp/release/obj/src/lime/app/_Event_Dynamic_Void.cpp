...
{
		HX_STACK_FRAME("lime.app._Event_Dynamic_Void","cancel",0xb3546cb6,"lime.app._Event_Dynamic_Void.cancel","lime/app/Event.hx",211,0xbda45bec)
		HX_STACK_THIS(this)
		HX_STACK_LINE(211)
		this->canceled = true;
	}
...
bool _Event_Dynamic_Void_obj::has( Dynamic listener){
	HX_STACK_FRAME("lime.app._Event_Dynamic_Void","has",0xa031229e,"lime.app._Event_Dynamic_Void.has","lime/app/Event.hx",247,0xbda45bec)
	HX_STACK_THIS(this)
	HX_STACK_ARG(listener,"listener")
	HX_STACK_LINE(250)
	{
...
{
		HX_STACK_FRAME("lime.app._Event_Dynamic_Void","remove",0xffa91b80,"lime.app._Event_Dynamic_Void.remove","lime/app/Event.hx",262,0xbda45bec)
		HX_STACK_THIS(this)
		HX_STACK_ARG(listener,"listener")
		HX_STACK_LINE(265)
...
{
		HX_STACK_FRAME("lime.app._Event_Dynamic_Void","dispatch",0x820f94f6,"lime.app._Event_Dynamic_Void.dispatch","lime/app/Event.hx",135,0xbda45bec)
		HX_STACK_THIS(this)
		HX_STACK_ARG(a,"a")
		HX_STACK_LINE(137)
		this->canceled = false;
