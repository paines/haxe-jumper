...
{
HX_STACK_FRAME("lime.app.Promise_lime_graphics_Image","new",0xe4010c79,"lime.app.Promise_lime_graphics_Image.new","lime/app/Promise.hx",16,0x10ba4f0b)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(18)
...
{  hx::ObjectPtr< Promise_lime_graphics_Image_obj > _result_ = new Promise_lime_graphics_Image_obj();
		...
		if ((tmp6)){
			HX_STACK_LINE(32)
			{
				...
				while((true)){
					...
					++(_g);
					HX_STACK_LINE(34)
					::lime::graphics::Image tmp11 = data;		HX_STACK_VAR(tmp11,"tmp11");
					HX_STACK_LINE(34)
...
::lime::app::Promise_lime_graphics_Image Promise_lime_graphics_Image_obj::progress( Float progress){
...
HX_DEFINE_DYNAMIC_FUNC1(Promise_lime_graphics_Image_obj,progress,return )

bool Promise_lime_graphics_Image_obj::get_isComplete( ){
	HX_STACK_FRAME("lime.app.Promise_lime_graphics_Image","get_isComplete",0xcb429393,"lime.app.Promise_lime_graphics_Image.get_isComplete","lime/app/Promise.hx",115,0x10ba4f0b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(117)
	::lime::app::Future tmp = this->future;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(117)
...
bool Promise_lime_graphics_Image_obj::get_isError( ){
	HX_STACK_FRAME("lime.app.Promise_lime_graphics_Image","get_isError",0x9c864cae,"lime.app.Promise_lime_graphics_Image.get_isError","lime/app/Promise.hx",122,0x10ba4f0b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(124)
	::lime::app::Future tmp = this->future;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(124)
...
Dynamic Promise_lime_graphics_Image_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
...
Dynamic Promise_lime_graphics_Image_obj::__SetField(const ::String &inName,const Dynamic &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 6:
