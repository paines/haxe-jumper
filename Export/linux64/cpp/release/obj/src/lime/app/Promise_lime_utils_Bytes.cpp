...
{
HX_STACK_FRAME("lime.app.Promise_lime_utils_Bytes","new",0xf368956f,"lime.app.Promise_lime_utils_Bytes.new","lime/app/Promise.hx",16,0x10ba4f0b)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(18)
...
{  hx::ObjectPtr< Promise_lime_utils_Bytes_obj > _result_ = new Promise_lime_utils_Bytes_obj();
		...
		if ((tmp6)){
			HX_STACK_LINE(32)
			{
				...
				while((true)){
					...
					++(_g);
					HX_STACK_LINE(34)
					::lime::utils::Bytes tmp11 = data;		HX_STACK_VAR(tmp11,"tmp11");
					HX_STACK_LINE(34)
...
bool Promise_lime_utils_Bytes_obj::get_isComplete( ){
	HX_STACK_FRAME("lime.app.Promise_lime_utils_Bytes","get_isComplete",0x176b625d,"lime.app.Promise_lime_utils_Bytes.get_isComplete","lime/app/Promise.hx",115,0x10ba4f0b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(117)
	::lime::app::Future tmp = this->future;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(117)
...
bool Promise_lime_utils_Bytes_obj::get_isError( ){
	HX_STACK_FRAME("lime.app.Promise_lime_utils_Bytes","get_isError",0xdeb0bba4,"lime.app.Promise_lime_utils_Bytes.get_isError","lime/app/Promise.hx",122,0x10ba4f0b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(124)
	::lime::app::Future tmp = this->future;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(124)
...
Dynamic Promise_lime_utils_Bytes_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
...
Dynamic Promise_lime_utils_Bytes_obj::__SetField(const ::String &inName,const Dynamic &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 6:
