...
{
HX_STACK_FRAME("lime.app.Promise_lime_text_Font","new",0x708368f3,"lime.app.Promise_lime_text_Font.new","lime/app/Promise.hx",16,0x10ba4f0b)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(18)
...
{  hx::ObjectPtr< Promise_lime_text_Font_obj > _result_ = new Promise_lime_text_Font_obj();
		...
		if ((tmp6)){
			HX_STACK_LINE(32)
			{
				...
				while((true)){
					...
					++(_g);
					HX_STACK_LINE(34)
					::lime::text::Font tmp11 = data;		HX_STACK_VAR(tmp11,"tmp11");
					HX_STACK_LINE(34)
...
bool Promise_lime_text_Font_obj::get_isComplete( ){
	HX_STACK_FRAME("lime.app.Promise_lime_text_Font","get_isComplete",0x8a9ff559,"lime.app.Promise_lime_text_Font.get_isComplete","lime/app/Promise.hx",115,0x10ba4f0b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(117)
	::lime::app::Future tmp = this->future;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(117)
...
bool Promise_lime_text_Font_obj::get_isError( ){
	HX_STACK_FRAME("lime.app.Promise_lime_text_Font","get_isError",0xc3d0b328,"lime.app.Promise_lime_text_Font.get_isError","lime/app/Promise.hx",122,0x10ba4f0b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(124)
	::lime::app::Future tmp = this->future;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(124)
...
Dynamic Promise_lime_text_Font_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
...
Dynamic Promise_lime_text_Font_obj::__SetField(const ::String &inName,const Dynamic &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 6:
