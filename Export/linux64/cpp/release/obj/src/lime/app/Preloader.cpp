...
{
HX_STACK_FRAME("lime.app.Preloader","new",0x922e2422,"lime.app.Preloader.new","lime/app/Preloader.hx",22,0xcf198510)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(27)
	...
	HX_STACK_LINE(44)
	::lime::app::_Event_Int_Int_Void tmp = this->onProgress;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(44)
...
{
		HX_STACK_FRAME("lime.app.Preloader","load",0x54e69024,"lime.app.Preloader.load","lime/app/Preloader.hx",67,0xcf198510)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("lime.app.Preloader","start",0xfff3bca4,"lime.app.Preloader.start","lime/app/Preloader.hx",272,0xcf198510)
		HX_STACK_THIS(this)
		HX_STACK_LINE(274)
		this->complete = true;
		HX_STACK_LINE(284)
		::lime::app::_Event_Void_Void tmp = this->onComplete;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(284)
		tmp->dispatch();
	}
return null();
...
{
		HX_STACK_FRAME("lime.app.Preloader","update",0x765c7787,"lime.app.Preloader.update","lime/app/Preloader.hx",289,0xcf198510)
		HX_STACK_THIS(this)
