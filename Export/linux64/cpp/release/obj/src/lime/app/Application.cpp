...
Void Application_obj::removeWindow( ::lime::ui::Window window){
{
		...
		if ((tmp1)){
			...
			window->close();
			HX_STACK_LINE(255)
			bool tmp5 = (window->renderer != null());		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(255)
			if ((tmp5)){
				HX_STACK_LINE(257)
				::lime::graphics::Renderer tmp6 = window->renderer;		HX_STACK_VAR(tmp6,"tmp6");
				HX_STACK_LINE(257)
				this->removeRenderer(tmp6);
			}
			HX_STACK_LINE(261)
			::lime::ui::Window tmp6 = this->__windows->__get((int)0).StaticCast< ::lime::ui::Window >();		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(261)
...
Float Application_obj::get_frameRate( ){
	HX_STACK_FRAME("lime.app.Application","get_frameRate",0x719f92a0,"lime.app.Application.get_frameRate","lime/app/Application.hx",292,0x8bc55476)
	HX_STACK_THIS(this)
	HX_STACK_LINE(294)
	::lime::_backend::native::NativeApplication tmp = this->backend;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(294)
...
Float Application_obj::set_frameRate( Float value){
	HX_STACK_FRAME("lime.app.Application","set_frameRate",0xb6a574ac,"lime.app.Application.set_frameRate","lime/app/Application.hx",299,0x8bc55476)
	HX_STACK_THIS(this)
...
::lime::app::Preloader Application_obj::get_preloader( ){
	HX_STACK_FRAME("lime.app.Application","get_preloader",0xbaf66569,"lime.app.Application.get_preloader","lime/app/Application.hx",306,0x8bc55476)
	HX_STACK_THIS(this)
	HX_STACK_LINE(308)
...
::lime::graphics::Renderer Application_obj::get_renderer( ){
	HX_STACK_FRAME("lime.app.Application","get_renderer",0xa67be3b0,"lime.app.Application.get_renderer","lime/app/Application.hx",313,0x8bc55476)
	HX_STACK_THIS(this)
	HX_STACK_LINE(315)
...
::lime::ui::Window Application_obj::get_window( ){
	HX_STACK_FRAME("lime.app.Application","get_window",0xc86a4d1d,"lime.app.Application.get_window","lime/app/Application.hx",327,0x8bc55476)
	HX_STACK_THIS(this)
	HX_STACK_LINE(329)
