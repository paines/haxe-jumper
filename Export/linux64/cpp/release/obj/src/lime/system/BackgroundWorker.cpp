...
Void BackgroundWorker_obj::__doWork( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(140)
		::lime::app::_Event_Dynamic_Void tmp = this->doWork;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(140)
		...
		if ((tmp2)){
			...
			if ((tmp5)){
				...
				if ((tmp9)){
					...
					this->canceled = true;
					HX_STACK_LINE(175)
					::lime::app::_Event_Dynamic_Void tmp10 = this->onError;		HX_STACK_VAR(tmp10,"tmp10");
					HX_STACK_LINE(175)
				...
				if ((tmp8)){
					...
					if ((tmp12)){
						...
						this->canceled = true;
						HX_STACK_LINE(186)
						::lime::app::_Event_Dynamic_Void tmp13 = this->onComplete;		HX_STACK_VAR(tmp13,"tmp13");
						HX_STACK_LINE(186)
					...
					if ((tmp10)){
						HX_STACK_LINE(194)
						::lime::app::_Event_Dynamic_Void tmp11 = this->onProgress;		HX_STACK_VAR(tmp11,"tmp11");
						HX_STACK_LINE(194)
