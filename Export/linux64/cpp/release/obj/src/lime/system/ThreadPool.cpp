...
Void ThreadPool_obj::__doWork( ){
{
		...
		while((true)){
			...
			if ((tmp2)){
				HX_STACK_LINE(136)
				::lime::app::_Event_Dynamic_Void tmp3 = this->doWork;		HX_STACK_VAR(tmp3,"tmp3");
				HX_STACK_LINE(136)
			...
			while((true)){
				...
				HX_STACK_LINE(157)
				{
					...
					switch( (int)(_g->__Index())){
						case (int)3: {
							HX_STACK_LINE(161)
							::lime::app::_Event_Dynamic_Void tmp7 = this->onProgress;		HX_STACK_VAR(tmp7,"tmp7");
							HX_STACK_LINE(161)
						...
						case (int)0: case (int)1: {
							...
							if ((tmp14)){
								HX_STACK_LINE(176)
								::lime::app::_Event_Dynamic_Void tmp15 = this->onComplete;		HX_STACK_VAR(tmp15,"tmp15");
								HX_STACK_LINE(176)
								...
								HX_STACK_LINE(180)
								::lime::app::_Event_Dynamic_Void tmp15 = this->onError;		HX_STACK_VAR(tmp15,"tmp15");
								HX_STACK_LINE(180)
								Dynamic tmp16 = message->__Field(HX_HCSTRING("state","\x11","\x76","\x0b","\x84"), hx::paccDynamic );		HX_STACK_VAR(tmp16,"tmp16");
								HX_STACK_LINE(180)
								tmp15->dispatch(tmp16);
