...
{
		HX_STACK_FRAME("lime.system.System","exit",0x19210697,"lime.system.System.exit","lime/system/System.hx",113,0x6434b429)
...
::lime::_system::Display System_obj::getDisplay( int id){
	HX_STACK_FRAME("lime.system.System","getDisplay",0x2e892085,"lime.system.System.getDisplay","lime/system/System.hx",151,0x6434b429)
	HX_STACK_ARG(id,"id")
	HX_STACK_LINE(154)
...
int System_obj::getTimer( ){
	HX_STACK_FRAME("lime.system.System","getTimer",0xb1bf8f48,"lime.system.System.getTimer","lime/system/System.hx",222,0x6434b429)
	HX_STACK_LINE(222)
...
bool lazy = __o_lazy.Default(false);
	HX_STACK_FRAME("lime.system.System","load",0x1dbaa99f,"lime.system.System.load","lime/system/System.hx",234,0x6434b429)
...
::String System_obj::__getDirectory( int type){
	HX_STACK_FRAME("lime.system.System","__getDirectory",0xc98892d0,"lime.system.System.__getDirectory","lime/system/System.hx",245,0x6434b429)
	HX_STACK_ARG(type,"type")
	HX_STACK_LINE(249)
	::haxe::ds::IntMap tmp = ::lime::_system::System_obj::__directories;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(249)
	...
	if ((tmp2)){
		HX_STACK_LINE(251)
		::haxe::ds::IntMap tmp3 = ::lime::_system::System_obj::__directories;		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(251)
		...
		HX_STACK_LINE(257)
		bool tmp3 = (type == (int)1);		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(257)
		if ((tmp3)){
			HX_STACK_LINE(259)
			...
			if ((tmp5)){
				HX_STACK_LINE(262)
				::lime::app::Application tmp7 = ::lime::app::Application_obj::current;		HX_STACK_VAR(tmp7,"tmp7");
				HX_STACK_LINE(262)
				::lime::app::Application tmp8 = tmp7;		HX_STACK_VAR(tmp8,"tmp8");
				HX_STACK_LINE(262)
				Dynamic tmp9 = tmp8->config;		HX_STACK_VAR(tmp9,"tmp9");
				HX_STACK_LINE(262)
				tmp6 = (tmp9 != null());
			}
			else{
			...
			if ((tmp6)){
				...
				::lime::app::Application tmp7 = ::lime::app::Application_obj::current;		HX_STACK_VAR(tmp7,"tmp7");
				HX_STACK_LINE(264)
				::String tmp8 = tmp7->config->__Field(HX_HCSTRING("company","\x3d","\x15","\x69","\x83"), hx::paccDynamic );		HX_STACK_VAR(tmp8,"tmp8");
				HX_STACK_LINE(264)
				...
				if ((tmp9)){
					...
					HX_STACK_LINE(266)
					::String tmp11 = tmp10->config->__Field(HX_HCSTRING("company","\x3d","\x15","\x69","\x83"), hx::paccDynamic );		HX_STACK_VAR(tmp11,"tmp11");
					HX_STACK_LINE(266)
					company = tmp11;
				}
				HX_STACK_LINE(270)
				::lime::app::Application tmp10 = ::lime::app::Application_obj::current;		HX_STACK_VAR(tmp10,"tmp10");
				HX_STACK_LINE(270)
				::String tmp11 = tmp10->config->__Field(HX_HCSTRING("file","\x7c","\xce","\xbb","\x43"), hx::paccDynamic );		HX_STACK_VAR(tmp11,"tmp11");
				HX_STACK_LINE(270)
				bool tmp12 = (tmp11 != null());		HX_STACK_VAR(tmp12,"tmp12");
				HX_STACK_LINE(270)
				if ((tmp12)){
					HX_STACK_LINE(272)
					::lime::app::Application tmp13 = ::lime::app::Application_obj::current;		HX_STACK_VAR(tmp13,"tmp13");
					HX_STACK_LINE(272)
					::String tmp14 = tmp13->config->__Field(HX_HCSTRING("file","\x7c","\xce","\xbb","\x43"), hx::paccDynamic );		HX_STACK_VAR(tmp14,"tmp14");
					HX_STACK_LINE(272)
					file = tmp14;
				}
			}
			HX_STACK_LINE(278)
			path = ((Dynamic)(::lime::_system::System_obj::cffi_lime_system_get_directory.call(type,company,file)));
		}
		else{
			HX_STACK_LINE(282)
			path = ((Dynamic)(::lime::_system::System_obj::cffi_lime_system_get_directory.call(type,null(),null())));
		}
		HX_STACK_LINE(289)
		::String seperator = HX_HCSTRING("/","\x2f","\x00","\x00","\x00");		HX_STACK_VAR(seperator,"seperator");
		HX_STACK_LINE(292)
		...
		if ((tmp6)){
			...
			HX_STACK_LINE(292)
			::String tmp9 = seperator;		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(292)
			::String tmp10 = tmp8;		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(292)
			::String tmp11 = tmp9;		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(292)
			bool tmp12 = ::StringTools_obj::endsWith(tmp10,tmp11);		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(292)
		...
		HX_STACK_LINE(298)
		::haxe::ds::IntMap tmp8 = ::lime::_system::System_obj::__directories;		HX_STACK_VAR(tmp8,"tmp8");
		HX_STACK_LINE(298)
...
bool System_obj::get_allowScreenTimeout( ){
	HX_STACK_FRAME("lime.system.System","get_allowScreenTimeout",0x287e314e,"lime.system.System.get_allowScreenTimeout","lime/system/System.hx",338,0x6434b429)
	HX_STACK_LINE(338)
...
bool System_obj::set_allowScreenTimeout( bool value){
	HX_STACK_FRAME("lime.system.System","set_allowScreenTimeout",0x5c29adc2,"lime.system.System.set_allowScreenTimeout","lime/system/System.hx",349,0x6434b429)
...
::String System_obj::get_applicationDirectory( ){
	HX_STACK_FRAME("lime.system.System","get_applicationDirectory",0xf6955c7f,"lime.system.System.get_applicationDirectory","lime/system/System.hx",357,0x6434b429)
	HX_STACK_LINE(359)
	::String tmp = ::lime::_system::System_obj::__getDirectory((int)0);		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(359)
	return tmp;
}
...
::String System_obj::get_applicationStorageDirectory( ){
	HX_STACK_FRAME("lime.system.System","get_applicationStorageDirectory",0x34818fe0,"lime.system.System.get_applicationStorageDirectory","lime/system/System.hx",364,0x6434b429)
	HX_STACK_LINE(366)
	::String tmp = ::lime::_system::System_obj::__getDirectory((int)1);		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(366)
	return tmp;
}
...
::String System_obj::get_desktopDirectory( ){
	HX_STACK_FRAME("lime.system.System","get_desktopDirectory",0x483b2773,"lime.system.System.get_desktopDirectory","lime/system/System.hx",371,0x6434b429)
	HX_STACK_LINE(373)
	::String tmp = ::lime::_system::System_obj::__getDirectory((int)2);		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(373)
	return tmp;
}
...
::String System_obj::get_documentsDirectory( ){
	HX_STACK_FRAME("lime.system.System","get_documentsDirectory",0x4a6a8557,"lime.system.System.get_documentsDirectory","lime/system/System.hx",378,0x6434b429)
	HX_STACK_LINE(380)
	::String tmp = ::lime::_system::System_obj::__getDirectory((int)3);		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(380)
	return tmp;
}
...
::String System_obj::get_fontsDirectory( ){
	HX_STACK_FRAME("lime.system.System","get_fontsDirectory",0x8242b40b,"lime.system.System.get_fontsDirectory","lime/system/System.hx",385,0x6434b429)
	HX_STACK_LINE(387)
	::String tmp = ::lime::_system::System_obj::__getDirectory((int)4);		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(387)
	return tmp;
}
...
int System_obj::get_numDisplays( ){
	HX_STACK_FRAME("lime.system.System","get_numDisplays",0x5056f915,"lime.system.System.get_numDisplays","lime/system/System.hx",395,0x6434b429)
	HX_STACK_LINE(395)
...
::String System_obj::get_userDirectory( ){
	HX_STACK_FRAME("lime.system.System","get_userDirectory",0x2b5522e0,"lime.system.System.get_userDirectory","lime/system/System.hx",403,0x6434b429)
	HX_STACK_LINE(405)
	::String tmp = ::lime::_system::System_obj::__getDirectory((int)5);		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(405)
	return tmp;
}
...
struct _Function_0_1{
	inline static ::haxe::ds::IntMap Block( ){
		HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","lime/system/System.hx",47,0x6434b429)
		{
			HX_STACK_LINE(47)
