			...
			if ((tmp72)){
				...
				if ((tmp73)){
					...
					if ((tmp74)){
						...
						HX_STACK_LINE(180)
						bool tmp75 = false;		HX_STACK_VAR(tmp75,"tmp75");
						HX_STACK_LINE(180)
						if ((tmp75)){
							HX_STACK_LINE(180)
							...
							HX_STACK_LINE(180)
							{
								...
								HX_STACK_LINE(180)
								::haxe::io::Bytes tmp78 = hx::Throw(HX_CSTRING("Invalid field access on null object"));		HX_STACK_VAR(tmp78,"tmp78");
								HX_STACK_LINE(180)
								::haxe::io::Bytes srcData = tmp78;		HX_STACK_VAR(srcData,"srcData");
								HX_STACK_LINE(180)
								int tmp79 = hx::Throw(HX_CSTRING("Invalid field access on null object"));		HX_STACK_VAR(tmp79,"tmp79");
								HX_STACK_LINE(180)
								int srcLength = tmp79;		HX_STACK_VAR(srcLength,"srcLength");
								HX_STACK_LINE(180)
								int tmp80 = hx::Throw(HX_CSTRING("Invalid field access on null object"));		HX_STACK_VAR(tmp80,"tmp80");
								HX_STACK_LINE(180)
								int srcByteOffset = tmp80;		HX_STACK_VAR(srcByteOffset,"srcByteOffset");
								HX_STACK_LINE(180)
								int tmp81 = hx::Throw(HX_CSTRING("Invalid field access on null object"));		HX_STACK_VAR(tmp81,"tmp81");
								HX_STACK_LINE(180)
								int srcElementSize = tmp81;		HX_STACK_VAR(srcElementSize,"srcElementSize");
								HX_STACK_LINE(180)
								int elementSize = _this->bytesPerElement;		HX_STACK_VAR(elementSize,"elementSize");
								HX_STACK_LINE(180)
								int tmp82 = hx::Throw(HX_CSTRING("Invalid field access on null object"));		HX_STACK_VAR(tmp82,"tmp82");
								HX_STACK_LINE(180)
								int tmp83 = _this->type;		HX_STACK_VAR(tmp83,"tmp83");
								HX_STACK_LINE(180)
								bool tmp84 = (tmp82 == tmp83);		HX_STACK_VAR(tmp84,"tmp84");
								HX_STACK_LINE(180)
								if ((tmp84)){
									HX_STACK_LINE(180)
									int srcLength1 = srcData->length;		HX_STACK_VAR(srcLength1,"srcLength1");
									HX_STACK_LINE(180)
									int tmp85 = (srcLength1 - srcByteOffset);		HX_STACK_VAR(tmp85,"tmp85");
									HX_STACK_LINE(180)
									int cloneLength = tmp85;		HX_STACK_VAR(cloneLength,"cloneLength");
									HX_STACK_LINE(180)
									::haxe::io::Bytes tmp86;		HX_STACK_VAR(tmp86,"tmp86");
									HX_STACK_LINE(180)
									{
										HX_STACK_LINE(180)
										::haxe::io::Bytes this2;		HX_STACK_VAR(this2,"this2");
										...
										HX_STACK_LINE(180)
										::haxe::io::Bytes tmp88 = ::haxe::io::Bytes_obj::alloc(tmp87);		HX_STACK_VAR(tmp88,"tmp88");
										HX_STACK_LINE(180)
										this2 = tmp88;
										HX_STACK_LINE(180)
										tmp86 = this2;
									...
									_this->buffer = tmp86;
									HX_STACK_LINE(180)
									::haxe::io::Bytes tmp87 = srcData;		HX_STACK_VAR(tmp87,"tmp87");
									HX_STACK_LINE(180)
									int tmp88 = srcByteOffset;		HX_STACK_VAR(tmp88,"tmp88");
									HX_STACK_LINE(180)
									int tmp89 = cloneLength;		HX_STACK_VAR(tmp89,"tmp89");
									HX_STACK_LINE(180)
								...
								HX_STACK_LINE(180)
								int tmp85 = (_this->bytesPerElement * srcLength);		HX_STACK_VAR(tmp85,"tmp85");
								HX_STACK_LINE(180)
							...
							HX_STACK_LINE(180)
							bool tmp76 = (data != null());		HX_STACK_VAR(tmp76,"tmp76");
							HX_STACK_LINE(180)
							if ((tmp76)){
								HX_STACK_LINE(180)
								::lime::utils::ArrayBufferView tmp77;		HX_STACK_VAR(tmp77,"tmp77");
								HX_STACK_LINE(180)
								{
									HX_STACK_LINE(180)
									::lime::utils::ArrayBufferView tmp78 = ::lime::utils::ArrayBufferView_obj::__new((int)0,(int)4);		HX_STACK_VAR(tmp78,"tmp78");
									HX_STACK_LINE(180)
									::lime::utils::ArrayBufferView _this = tmp78;		HX_STACK_VAR(_this,"_this");
									HX_STACK_LINE(180)
									bool tmp79 = false;		HX_STACK_VAR(tmp79,"tmp79");
									HX_STACK_LINE(180)
									if ((tmp79)){
										HX_STACK_LINE(180)
									...
									HX_STACK_LINE(180)
									int tmp80 = hx::Mod((int)0,_this->bytesPerElement);		HX_STACK_VAR(tmp80,"tmp80");
									HX_STACK_LINE(180)
									...
									HX_STACK_LINE(180)
									bool tmp82 = true;		HX_STACK_VAR(tmp82,"tmp82");
									HX_STACK_LINE(180)
									if ((tmp82)){
										HX_STACK_LINE(180)
										int tmp83 = bufferByteLength;		HX_STACK_VAR(tmp83,"tmp83");
										HX_STACK_LINE(180)
										newByteLength = tmp83;
										HX_STACK_LINE(180)
										int tmp84 = hx::Mod(bufferByteLength,_this->bytesPerElement);		HX_STACK_VAR(tmp84,"tmp84");
										HX_STACK_LINE(180)
										...
										HX_STACK_LINE(180)
										bool tmp86 = (newByteLength < (int)0);		HX_STACK_VAR(tmp86,"tmp86");
										HX_STACK_LINE(180)
										if ((tmp86)){
											HX_STACK_LINE(180)
											HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError);
										...
										HX_STACK_LINE(180)
										int tmp83 = (null() * _this->bytesPerElement);		HX_STACK_VAR(tmp83,"tmp83");
										HX_STACK_LINE(180)
										newByteLength = tmp83;
										HX_STACK_LINE(180)
										int tmp84 = newByteLength;		HX_STACK_VAR(tmp84,"tmp84");
										HX_STACK_LINE(180)
										int newRange = tmp84;		HX_STACK_VAR(newRange,"newRange");
										HX_STACK_LINE(180)
										bool tmp85 = (newRange > bufferByteLength);		HX_STACK_VAR(tmp85,"tmp85");
										HX_STACK_LINE(180)
										if ((tmp85)){
											HX_STACK_LINE(180)
											HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError);
									...
									HX_STACK_LINE(180)
									Float tmp83 = (Float(newByteLength) / Float(_this->bytesPerElement));		HX_STACK_VAR(tmp83,"tmp83");
									HX_STACK_LINE(180)
