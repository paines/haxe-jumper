					...
					case (int)0: {
						...
						HX_STACK_LINE(76)
						{
							...
							if ((tmp6)){
								...
								HX_STACK_LINE(83)
								Dynamic tmp9 = device;		HX_STACK_VAR(tmp9,"tmp9");
								HX_STACK_LINE(83)
								alc->resumeDevice(tmp9);
								HX_STACK_LINE(84)
								Dynamic tmp10 = currentContext;		HX_STACK_VAR(tmp10,"tmp10");
								HX_STACK_LINE(84)
...
{
		HX_STACK_FRAME("lime.audio.AudioManager","shutdown",0x46165d1c,"lime.audio.AudioManager.shutdown","lime/audio/AudioManager.hx",97,0x9f466694)
		HX_STACK_LINE(99)
		::lime::audio::AudioContext tmp = ::lime::audio::AudioManager_obj::context;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(99)
		bool tmp1 = (tmp != null());		HX_STACK_VAR(tmp1,"tmp1");
...
{
		HX_STACK_FRAME("lime.audio.AudioManager","suspend",0xf724c1b6,"lime.audio.AudioManager.suspend","lime/audio/AudioManager.hx",125,0x9f466694)
		HX_STACK_LINE(127)
		::lime::audio::AudioContext tmp = ::lime::audio::AudioManager_obj::context;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(127)
		bool tmp1 = (tmp != null());		HX_STACK_VAR(tmp1,"tmp1");
					...
					case (int)0: {
						...
						HX_STACK_LINE(131)
						{
							...
							if ((tmp6)){
								...
								HX_STACK_LINE(138)
								Dynamic tmp8 = currentContext;		HX_STACK_VAR(tmp8,"tmp8");
								HX_STACK_LINE(138)
								Dynamic tmp9 = alc->getContextsDevice(tmp8);		HX_STACK_VAR(tmp9,"tmp9");
								HX_STACK_LINE(138)
								Dynamic device = tmp9;		HX_STACK_VAR(device,"device");
								HX_STACK_LINE(139)
								Dynamic tmp10 = device;		HX_STACK_VAR(tmp10,"tmp10");
								HX_STACK_LINE(139)
