...
Void ALC_obj::pauseDevice( Dynamic device){
{
		...
		HX_STACK_ARG(device,"device")
		HX_STACK_LINE(188)
		::lime::audio::openal::ALC_obj::cffi_lime_alc_pause_device.call(hx::DynamicPtr(device));
	}
return null();
}
...
Void ALC_obj::resumeDevice( Dynamic device){
{
		...
		HX_STACK_ARG(device,"device")
		HX_STACK_LINE(206)
		::lime::audio::openal::ALC_obj::cffi_lime_alc_resume_device.call(hx::DynamicPtr(device));
	}
return null();
}
...
static hx::StaticInfo sStaticStorageInfo[] = {
	...
	{hx::fsObject /*::cpp::Function< void ( ::hx::Object * ) >*/ ,(void *) &ALC_obj::cffi_lime_alc_pause_device,HX_HCSTRING("cffi_lime_alc_pause_device","\xd7","\x00","\xd5","\xdb")},
	...
	{hx::fsObject /*::cpp::Function< void ( ::hx::Object * ) >*/ ,(void *) &ALC_obj::cffi_lime_alc_resume_device,HX_HCSTRING("cffi_lime_alc_resume_device","\x50","\x42","\x22","\x87")},
