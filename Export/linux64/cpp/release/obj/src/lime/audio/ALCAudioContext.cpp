...
{
		HX_STACK_FRAME("lime.audio.ALCAudioContext","pauseDevice",0x5b995bde,"lime.audio.ALCAudioContext.pauseDevice","lime/audio/ALCAudioContext.hx",119,0x89fdd0e0)
		HX_STACK_THIS(this)
		HX_STACK_ARG(device,"device")
		HX_STACK_LINE(121)
		Dynamic tmp = device;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(121)
		::lime::audio::openal::ALC_obj::pauseDevice(tmp);
	}
return null();
}
...
{
		HX_STACK_FRAME("lime.audio.ALCAudioContext","processContext",0x44a59ace,"lime.audio.ALCAudioContext.processContext","lime/audio/ALCAudioContext.hx",126,0x89fdd0e0)
		HX_STACK_THIS(this)
		HX_STACK_ARG(context,"context")
		HX_STACK_LINE(128)
		Dynamic tmp = context;		HX_STACK_VAR(tmp,"tmp");
...
{
		HX_STACK_FRAME("lime.audio.ALCAudioContext","resumeDevice",0xa9bade31,"lime.audio.ALCAudioContext.resumeDevice","lime/audio/ALCAudioContext.hx",133,0x89fdd0e0)
		HX_STACK_THIS(this)
		HX_STACK_ARG(device,"device")
		HX_STACK_LINE(135)
		Dynamic tmp = device;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(135)
		::lime::audio::openal::ALC_obj::resumeDevice(tmp);
	}
return null();
}
...
{
		HX_STACK_FRAME("lime.audio.ALCAudioContext","suspendContext",0x778c7961,"lime.audio.ALCAudioContext.suspendContext","lime/audio/ALCAudioContext.hx",140,0x89fdd0e0)
		HX_STACK_THIS(this)
		HX_STACK_ARG(context,"context")
		HX_STACK_LINE(142)
		Dynamic tmp = context;		HX_STACK_VAR(tmp,"tmp");
