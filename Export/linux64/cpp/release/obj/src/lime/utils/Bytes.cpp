...
::lime::utils::Bytes Bytes_obj::readFile( ::String path){
	...
	{
		HX_STACK_LINE(63)
		::lime::utils::Bytes tmp1 = ::lime::utils::Bytes_obj::alloc((int)0);		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(63)
		Dynamic bytes = tmp1;		HX_STACK_VAR(bytes,"bytes");
		HX_STACK_LINE(63)
		tmp = ::lime::utils::Bytes_obj::cffi_lime_bytes_read_file.call(path,hx::DynamicPtr(bytes));
	}
	HX_STACK_LINE(63)
	return tmp;
	HX_STACK_LINE(69)
...
::lime::utils::Bytes Bytes_obj::__fromNativePointer( Dynamic data,int length){
	HX_STACK_FRAME("lime.utils.Bytes","__fromNativePointer",0x91d44183,"lime.utils.Bytes.__fromNativePointer","lime/utils/Bytes.hx",75,0x9fbf972b)
...
Dynamic Bytes_obj::lime_bytes_from_data_pointer( Float data,int length){
	HX_STACK_FRAME("lime.utils.Bytes","lime_bytes_from_data_pointer",0x7df5f9b8,"lime.utils.Bytes.lime_bytes_from_data_pointer","lime/utils/Bytes.hx",92,0x9fbf972b)
	HX_STACK_ARG(data,"data")
	HX_STACK_ARG(length,"length")
	HX_STACK_LINE(92)
...
Float Bytes_obj::lime_bytes_get_data_pointer( Dynamic data){
	HX_STACK_FRAME("lime.utils.Bytes","lime_bytes_get_data_pointer",0x1d4bd736,"lime.utils.Bytes.lime_bytes_get_data_pointer","lime/utils/Bytes.hx",93,0x9fbf972b)
	HX_STACK_ARG(data,"data")
	HX_STACK_LINE(93)
...
Dynamic Bytes_obj::lime_bytes_read_file( ::String path,Dynamic bytes){
	HX_STACK_FRAME("lime.utils.Bytes","lime_bytes_read_file",0xab69b060,"lime.utils.Bytes.lime_bytes_read_file","lime/utils/Bytes.hx",94,0x9fbf972b)
	HX_STACK_ARG(path,"path")
	HX_STACK_ARG(bytes,"bytes")
	HX_STACK_LINE(94)
	return ::lime::utils::Bytes_obj::cffi_lime_bytes_read_file.call(path,hx::DynamicPtr(bytes));
}
...
static hx::StaticInfo sStaticStorageInfo[] = {
	...
	{hx::fsObject /*::cpp::Function< ::hx::Object * ( ::String ,::hx::Object * ) >*/ ,(void *) &Bytes_obj::cffi_lime_bytes_read_file,HX_HCSTRING("cffi_lime_bytes_read_file","\x40","\x58","\x83","\x5f")},
	{ hx::fsUnknown, 0, null()}
};
#endif
