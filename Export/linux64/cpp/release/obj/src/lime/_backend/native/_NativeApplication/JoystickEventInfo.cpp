...
::lime::_backend::native::_NativeApplication::JoystickEventInfo JoystickEventInfo_obj::clone( ){
	HX_STACK_FRAME("lime._backend.native._NativeApplication.JoystickEventInfo","clone",0x8796a4de,"lime._backend.native._NativeApplication.JoystickEventInfo.clone","lime/_backend/native/NativeApplication.hx",788,0xb13849fd)
	HX_STACK_THIS(this)
	HX_STACK_LINE(790)
