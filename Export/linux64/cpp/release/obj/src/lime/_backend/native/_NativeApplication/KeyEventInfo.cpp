...
{
HX_STACK_FRAME("lime._backend.native._NativeApplication.KeyEventInfo","new",0x9d1330f8,"lime._backend.native._NativeApplication.KeyEventInfo.new","lime/_backend/native/NativeApplication.hx",820,0xb13849fd)
HX_STACK_THIS(this)
...
::lime::_backend::native::_NativeApplication::KeyEventInfo KeyEventInfo_obj::clone( ){
	HX_STACK_FRAME("lime._backend.native._NativeApplication.KeyEventInfo","clone",0x1c2dc9f5,"lime._backend.native._NativeApplication.KeyEventInfo.clone","lime/_backend/native/NativeApplication.hx",830,0xb13849fd)
	HX_STACK_THIS(this)
	HX_STACK_LINE(832)
