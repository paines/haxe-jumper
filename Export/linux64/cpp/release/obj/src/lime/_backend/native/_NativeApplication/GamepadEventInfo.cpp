...
{
HX_STACK_FRAME("lime._backend.native._NativeApplication.GamepadEventInfo","new",0xafb72336,"lime._backend.native._NativeApplication.GamepadEventInfo.new","lime/_backend/native/NativeApplication.hx",733,0xb13849fd)
HX_STACK_THIS(this)
...
::lime::_backend::native::_NativeApplication::GamepadEventInfo GamepadEventInfo_obj::clone( ){
	HX_STACK_FRAME("lime._backend.native._NativeApplication.GamepadEventInfo","clone",0x156147b3,"lime._backend.native._NativeApplication.GamepadEventInfo.clone","lime/_backend/native/NativeApplication.hx",744,0xb13849fd)
	HX_STACK_THIS(this)
	HX_STACK_LINE(746)
