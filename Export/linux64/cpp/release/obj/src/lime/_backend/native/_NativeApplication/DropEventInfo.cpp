...
::lime::_backend::native::_NativeApplication::DropEventInfo DropEventInfo_obj::clone( ){
	HX_STACK_FRAME("lime._backend.native._NativeApplication.DropEventInfo","clone",0xb714194b,"lime._backend.native._NativeApplication.DropEventInfo.clone","lime/_backend/native/NativeApplication.hx",706,0xb13849fd)
	HX_STACK_THIS(this)
	HX_STACK_LINE(708)
