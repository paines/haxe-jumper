...
{
HX_STACK_FRAME("lime._backend.native._NativeApplication.MouseEventInfo","new",0x1e4161f2,"lime._backend.native._NativeApplication.MouseEventInfo.new","lime/_backend/native/NativeApplication.hx",861,0xb13849fd)
HX_STACK_THIS(this)
...
::lime::_backend::native::_NativeApplication::MouseEventInfo MouseEventInfo_obj::clone( ){
	HX_STACK_FRAME("lime._backend.native._NativeApplication.MouseEventInfo","clone",0xea05ad6f,"lime._backend.native._NativeApplication.MouseEventInfo.clone","lime/_backend/native/NativeApplication.hx",874,0xb13849fd)
	HX_STACK_THIS(this)
	HX_STACK_LINE(876)
