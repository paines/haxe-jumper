...
{
HX_STACK_FRAME("lime._backend.native._NativeApplication.WindowEventInfo","new",0xd11afd2d,"lime._backend.native._NativeApplication.WindowEventInfo.new","lime/_backend/native/NativeApplication.hx",1063,0xb13849fd)
HX_STACK_THIS(this)
...
::lime::_backend::native::_NativeApplication::WindowEventInfo WindowEventInfo_obj::clone( ){
	HX_STACK_FRAME("lime._backend.native._NativeApplication.WindowEventInfo","clone",0x3ae8cd6a,"lime._backend.native._NativeApplication.WindowEventInfo.clone","lime/_backend/native/NativeApplication.hx",1075,0xb13849fd)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1077)
