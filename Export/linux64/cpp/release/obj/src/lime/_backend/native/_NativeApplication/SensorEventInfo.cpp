...
::lime::_backend::native::_NativeApplication::SensorEventInfo SensorEventInfo_obj::clone( ){
	HX_STACK_FRAME("lime._backend.native._NativeApplication.SensorEventInfo","clone",0x0a92d260,"lime._backend.native._NativeApplication.SensorEventInfo.clone","lime/_backend/native/NativeApplication.hx",949,0xb13849fd)
	HX_STACK_THIS(this)
	HX_STACK_LINE(951)
