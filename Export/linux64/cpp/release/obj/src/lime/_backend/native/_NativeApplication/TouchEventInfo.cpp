...
{
HX_STACK_FRAME("lime._backend.native._NativeApplication.TouchEventInfo","new",0x974ae818,"lime._backend.native._NativeApplication.TouchEventInfo.new","lime/_backend/native/NativeApplication.hx",1019,0xb13849fd)
HX_STACK_THIS(this)
...
::lime::_backend::native::_NativeApplication::TouchEventInfo TouchEventInfo_obj::clone( ){
	HX_STACK_FRAME("lime._backend.native._NativeApplication.TouchEventInfo","clone",0xdd198915,"lime._backend.native._NativeApplication.TouchEventInfo.clone","lime/_backend/native/NativeApplication.hx",1033,0xb13849fd)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1035)
