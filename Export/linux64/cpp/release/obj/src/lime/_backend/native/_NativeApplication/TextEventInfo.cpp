...
{
HX_STACK_FRAME("lime._backend.native._NativeApplication.TextEventInfo","new",0xb1ead390,"lime._backend.native._NativeApplication.TextEventInfo.new","lime/_backend/native/NativeApplication.hx",977,0xb13849fd)
HX_STACK_THIS(this)
...
::lime::_backend::native::_NativeApplication::TextEventInfo TextEventInfo_obj::clone( ){
	HX_STACK_FRAME("lime._backend.native._NativeApplication.TextEventInfo","clone",0xd025428d,"lime._backend.native._NativeApplication.TextEventInfo.clone","lime/_backend/native/NativeApplication.hx",988,0xb13849fd)
	HX_STACK_THIS(this)
	HX_STACK_LINE(990)
