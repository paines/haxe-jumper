...
{
HX_STACK_FRAME("lime._backend.native._NativeApplication.ApplicationEventInfo","new",0x285f59a7,"lime._backend.native._NativeApplication.ApplicationEventInfo.new","lime/_backend/native/NativeApplication.hx",665,0xb13849fd)
HX_STACK_THIS(this)
...
::lime::_backend::native::_NativeApplication::ApplicationEventInfo ApplicationEventInfo_obj::clone( ){
	HX_STACK_FRAME("lime._backend.native._NativeApplication.ApplicationEventInfo","clone",0x3158bc64,"lime._backend.native._NativeApplication.ApplicationEventInfo.clone","lime/_backend/native/NativeApplication.hx",673,0xb13849fd)
	HX_STACK_THIS(this)
	HX_STACK_LINE(675)
