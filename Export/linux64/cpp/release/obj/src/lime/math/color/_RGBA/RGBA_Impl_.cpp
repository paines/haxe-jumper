			...
			if ((tmp2)){
				...
				if ((tmp3)){
					...
					HX_STACK_LINE(27)
					{
						...
						_this->__FieldRef(HX_HCSTRING("byteOffset","\xbb","\x20","\x44","\x38")) = (int)0;
						HX_STACK_LINE(27)
						_this->__FieldRef(HX_HCSTRING("length","\xe6","\x94","\x07","\x9f")) = array->__Field(HX_HCSTRING("length","\xe6","\x94","\x07","\x9f"), hx::paccDynamic );
						HX_STACK_LINE(27)
						int tmp6 = (_this->__Field(HX_HCSTRING("length","\xe6","\x94","\x07","\x9f"), hx::paccDynamic ) * _this->__Field(HX_HCSTRING("bytesPerElement","\xaa","\x67","\x89","\x18"), hx::paccDynamic ));		HX_STACK_VAR(tmp6,"tmp6");
						HX_STACK_LINE(27)
						_this->__FieldRef(HX_HCSTRING("byteLength","\x0e","\x1e","\x0c","\x77")) = tmp6;
						...
						_this->__FieldRef(HX_HCSTRING("buffer","\x00","\xbd","\x94","\xd0")) = tmp7;
						HX_STACK_LINE(27)
						_this->__Field(HX_HCSTRING("copyFromArray","\x5a","\xdd","\xdd","\x3b"), hx::paccDynamic )(((Array< Float >)(array)),null());
						HX_STACK_LINE(27)
						tmp4 = _this;
					}
					HX_STACK_LINE(27)
					...
					if ((tmp4)){
						...
						if ((tmp5)){
							...
							{
								HX_STACK_LINE(27)
								::lime::utils::ArrayBufferView tmp7 = ::lime::utils::ArrayBufferView_obj::__new((int)0,(int)7);		HX_STACK_VAR(tmp7,"tmp7");
								HX_STACK_LINE(27)
				...
				if ((tmp4)){
					...
					if ((tmp5)){
						...
						HX_STACK_LINE(35)
						{
							...
							HX_STACK_LINE(35)
							int tmp13 = _this->__Field(HX_HCSTRING("type","\xba","\xf2","\x08","\x4d"), hx::paccDynamic );		HX_STACK_VAR(tmp13,"tmp13");
							HX_STACK_LINE(35)
							...
							if ((tmp14)){
								...
								HX_STACK_LINE(35)
								_this->__FieldRef(HX_HCSTRING("buffer","\x00","\xbd","\x94","\xd0")) = tmp16;
								HX_STACK_LINE(35)
								...
								HX_STACK_LINE(35)
								_this->__Field(HX_HCSTRING("buffer","\x00","\xbd","\x94","\xd0"), hx::paccDynamic )->__Field(HX_HCSTRING("blit","\x35","\x38","\x19","\x41"), hx::paccDynamic )((int)0,tmp17,tmp18,tmp19);
							}
							else{
								HX_STACK_LINE(35)
								HX_STACK_DO_THROW(HX_HCSTRING("unimplemented","\x09","\x2f","\x74","\xb4"));
							...
							HX_STACK_LINE(35)
							int tmp15 = (_this->__Field(HX_HCSTRING("bytesPerElement","\xaa","\x67","\x89","\x18"), hx::paccDynamic ) * srcLength);		HX_STACK_VAR(tmp15,"tmp15");
							HX_STACK_LINE(35)
							_this->__FieldRef(HX_HCSTRING("byteLength","\x0e","\x1e","\x0c","\x77")) = tmp15;
							HX_STACK_LINE(35)
							_this->__FieldRef(HX_HCSTRING("byteOffset","\xbb","\x20","\x44","\x38")) = (int)0;
							HX_STACK_LINE(35)
							_this->__FieldRef(HX_HCSTRING("length","\xe6","\x94","\x07","\x9f")) = srcLength;
						...
						if ((tmp6)){
							...
							HX_STACK_LINE(35)
							{
								...
								HX_STACK_LINE(35)
								int tmp10 = hx::Mod((int)0,_this->__Field(HX_HCSTRING("bytesPerElement","\xaa","\x67","\x89","\x18"), hx::paccDynamic ));		HX_STACK_VAR(tmp10,"tmp10");
								HX_STACK_LINE(35)
								...
								if ((tmp13)){
									...
									newByteLength = tmp14;
									HX_STACK_LINE(35)
									int tmp15 = hx::Mod(bufferByteLength,_this->__Field(HX_HCSTRING("bytesPerElement","\xaa","\x67","\x89","\x18"), hx::paccDynamic ));		HX_STACK_VAR(tmp15,"tmp15");
									HX_STACK_LINE(35)
									...
									HX_STACK_LINE(35)
									int tmp14 = (null() * _this->__Field(HX_HCSTRING("bytesPerElement","\xaa","\x67","\x89","\x18"), hx::paccDynamic ));		HX_STACK_VAR(tmp14,"tmp14");
									HX_STACK_LINE(35)
									newByteLength = tmp14;
									HX_STACK_LINE(35)
								...
								_this->__FieldRef(HX_HCSTRING("byteLength","\x0e","\x1e","\x0c","\x77")) = newByteLength;
								HX_STACK_LINE(35)
								Float tmp14 = (Float(newByteLength) / Float(_this->__Field(HX_HCSTRING("bytesPerElement","\xaa","\x67","\x89","\x18"), hx::paccDynamic )));		HX_STACK_VAR(tmp14,"tmp14");
								HX_STACK_LINE(35)
								int tmp15 = ::Std_obj::_int(tmp14);		HX_STACK_VAR(tmp15,"tmp15");
								HX_STACK_LINE(35)
								_this->__FieldRef(HX_HCSTRING("length","\xe6","\x94","\x07","\x9f")) = tmp15;
								HX_STACK_LINE(35)
								tmp7 = _this;
							}
							HX_STACK_LINE(35)
		...
		if ((tmp2)){
			...
			if ((tmp5)){
				...
				HX_STACK_LINE(80)
				{
					...
					HX_STACK_LINE(80)
					tmp6 = ::__hxcpp_memory_get_ui32(this2->buffer->b,(this2->byteOffset + (((int(this1) & int((int)255))) * (int)4)));
				}
				HX_STACK_LINE(80)
				::lime::math::color::_RGBA::RGBA_Impl__obj::a16 = tmp6;
				HX_STACK_LINE(81)
				{
					HX_STACK_LINE(81)
					...
					HX_STACK_LINE(81)
					int tmp11 = ::lime::math::color::_RGBA::RGBA_Impl__obj::a16;		HX_STACK_VAR(tmp11,"tmp11");
					HX_STACK_LINE(81)
					...
					HX_STACK_LINE(81)
					int tmp25 = (int(tmp15) | int(tmp24));		HX_STACK_VAR(tmp25,"tmp25");
					HX_STACK_LINE(81)
	...
	HX_STACK_ARG(premultiplied,"premultiplied")
{
		...
		if ((tmp1)){
			...
			if ((tmp5)){
				...
				HX_STACK_LINE(108)
				::lime::math::color::_RGBA::RGBA_Impl__obj::unmult = tmp8;
				HX_STACK_LINE(108)
				{
					HX_STACK_LINE(108)
					...
					HX_STACK_LINE(108)
					{
						...
						HX_STACK_LINE(108)
						Float tmp15 = ::lime::math::color::_RGBA::RGBA_Impl__obj::unmult;		HX_STACK_VAR(tmp15,"tmp15");
						HX_STACK_LINE(108)
						Float tmp16 = (tmp14 * tmp15);		HX_STACK_VAR(tmp16,"tmp16");
						HX_STACK_LINE(108)
						int tmp17 = ::Math_obj::round(tmp16);		HX_STACK_VAR(tmp17,"tmp17");
						HX_STACK_LINE(108)
						int idx = tmp17;		HX_STACK_VAR(idx,"idx");
						HX_STACK_LINE(108)
						int tmp18 = ::__hxcpp_memory_get_byte(this2->buffer->b,(this2->byteOffset + idx));		HX_STACK_VAR(tmp18,"tmp18");
						HX_STACK_LINE(108)
						tmp9 = (int(tmp18) & int((int)255));
					}
					HX_STACK_LINE(108)
					...
					HX_STACK_LINE(108)
					{
						...
						HX_STACK_LINE(108)
						Float tmp16 = ::lime::math::color::_RGBA::RGBA_Impl__obj::unmult;		HX_STACK_VAR(tmp16,"tmp16");
						HX_STACK_LINE(108)
						Float tmp17 = (tmp15 * tmp16);		HX_STACK_VAR(tmp17,"tmp17");
						HX_STACK_LINE(108)
						int tmp18 = ::Math_obj::round(tmp17);		HX_STACK_VAR(tmp18,"tmp18");
						HX_STACK_LINE(108)
						int idx = tmp18;		HX_STACK_VAR(idx,"idx");
						HX_STACK_LINE(108)
						int tmp19 = ::__hxcpp_memory_get_byte(this2->buffer->b,(this2->byteOffset + idx));		HX_STACK_VAR(tmp19,"tmp19");
						HX_STACK_LINE(108)
						tmp10 = (int(tmp19) & int((int)255));
					}
					HX_STACK_LINE(108)
					...
					HX_STACK_LINE(108)
					{
						...
						HX_STACK_LINE(108)
						Float tmp17 = ::lime::math::color::_RGBA::RGBA_Impl__obj::unmult;		HX_STACK_VAR(tmp17,"tmp17");
						HX_STACK_LINE(108)
					...
					HX_STACK_LINE(108)
					int tmp12 = (int(r) & int((int)255));		HX_STACK_VAR(tmp12,"tmp12");
					HX_STACK_LINE(108)
					...
					HX_STACK_LINE(108)
					int tmp20 = (int(this1) & int((int)255));		HX_STACK_VAR(tmp20,"tmp20");
					HX_STACK_LINE(108)
		...
		if ((tmp3)){
			...
			HX_STACK_LINE(127)
			{
				...
				HX_STACK_LINE(127)
				{
					...
					int tmp13 = tmp12;		HX_STACK_VAR(tmp13,"tmp13");
					HX_STACK_LINE(127)
					Float tmp14 = ::lime::math::color::_RGBA::RGBA_Impl__obj::unmult;		HX_STACK_VAR(tmp14,"tmp14");
					HX_STACK_LINE(127)
	...
	HX_STACK_ARG(premultiplied,"premultiplied")
{
		...
		if ((tmp)){
			...
			if ((tmp3)){
				HX_STACK_LINE(138)
				bool tmp4 = (this1 != (int)0);		HX_STACK_VAR(tmp4,"tmp4");
				HX_STACK_LINE(138)
				if ((tmp4)){
					HX_STACK_LINE(138)
					this1 = (int)0;
				...
				if ((tmp6)){
					...
					HX_STACK_LINE(138)
					{
						...
						::lime::utils::ArrayBufferView this2 = tmp8;		HX_STACK_VAR(this2,"this2");
						HX_STACK_LINE(138)
						tmp7 = ::__hxcpp_memory_get_ui32(this2->buffer->b,(this2->byteOffset + (((int(this1) & int((int)255))) * (int)4)));
					}
					HX_STACK_LINE(138)
					::lime::math::color::_RGBA::RGBA_Impl__obj::a16 = tmp7;
					HX_STACK_LINE(138)
					{
						HX_STACK_LINE(138)
						...
						int tmp11 = tmp10;		HX_STACK_VAR(tmp11,"tmp11");
						HX_STACK_LINE(138)
						int tmp12 = ::lime::math::color::_RGBA::RGBA_Impl__obj::a16;		HX_STACK_VAR(tmp12,"tmp12");
						HX_STACK_LINE(138)
...
int RGBA_Impl__obj::__fromARGB( int argb){
	...
	HX_STACK_LINE(172)
	{
		...
		HX_STACK_LINE(172)
		{
			...
			int tmp13 = (int(tmp12) << int((int)16));		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(172)
			int tmp14 = (int(tmp7) | int(tmp13));		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(172)
			...
			HX_STACK_LINE(172)
			int tmp20 = (int(argb) >> int((int)24));		HX_STACK_VAR(tmp20,"tmp20");
			HX_STACK_LINE(172)
			int tmp21 = tmp20;		HX_STACK_VAR(tmp21,"tmp21");
			HX_STACK_LINE(172)
			int tmp22 = (int(tmp21) & int((int)255));		HX_STACK_VAR(tmp22,"tmp22");
...
int RGBA_Impl__obj::__fromBGRA( int bgra){
	...
	HX_STACK_LINE(179)
	{
		...
		HX_STACK_LINE(179)
		{
			...
			HX_STACK_LINE(179)
			int tmp22 = (int(bgra) & int((int)255));		HX_STACK_VAR(tmp22,"tmp22");
			HX_STACK_LINE(179)
			int tmp23 = tmp22;		HX_STACK_VAR(tmp23,"tmp23");
			HX_STACK_LINE(179)
			int tmp24 = (int(tmp23) & int((int)255));		HX_STACK_VAR(tmp24,"tmp24");
