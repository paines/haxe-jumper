...
Void BGRA_Impl__obj::multiplyAlpha( int this1){
{
		...
		if ((tmp2)){
			...
			if ((tmp5)){
				...
				HX_STACK_LINE(45)
				::lime::math::color::_BGRA::BGRA_Impl__obj::a16 = tmp6;
				HX_STACK_LINE(46)
				{
					HX_STACK_LINE(46)
					...
					HX_STACK_LINE(46)
					int tmp11 = ::lime::math::color::_BGRA::BGRA_Impl__obj::a16;		HX_STACK_VAR(tmp11,"tmp11");
					HX_STACK_LINE(46)
					...
					HX_STACK_LINE(46)
					int tmp20 = ::lime::math::color::_BGRA::BGRA_Impl__obj::a16;		HX_STACK_VAR(tmp20,"tmp20");
					HX_STACK_LINE(46)
					...
					HX_STACK_LINE(46)
					int tmp30 = ::lime::math::color::_BGRA::BGRA_Impl__obj::a16;		HX_STACK_VAR(tmp30,"tmp30");
					HX_STACK_LINE(46)
	...
	HX_STACK_ARG(premultiplied,"premultiplied")
{
		...
		if ((tmp1)){
			...
			if ((tmp5)){
				...
				HX_STACK_LINE(73)
				::lime::math::color::_BGRA::BGRA_Impl__obj::unmult = tmp8;
				HX_STACK_LINE(73)
				{
					HX_STACK_LINE(73)
					...
					HX_STACK_LINE(73)
					{
						...
						HX_STACK_LINE(73)
						Float tmp15 = ::lime::math::color::_BGRA::BGRA_Impl__obj::unmult;		HX_STACK_VAR(tmp15,"tmp15");
						HX_STACK_LINE(73)
					...
					HX_STACK_LINE(73)
					{
						...
						HX_STACK_LINE(73)
						Float tmp16 = ::lime::math::color::_BGRA::BGRA_Impl__obj::unmult;		HX_STACK_VAR(tmp16,"tmp16");
						HX_STACK_LINE(73)
					...
					HX_STACK_LINE(73)
					{
						...
						HX_STACK_LINE(73)
						Float tmp17 = ::lime::math::color::_BGRA::BGRA_Impl__obj::unmult;		HX_STACK_VAR(tmp17,"tmp17");
						HX_STACK_LINE(73)
					...
					HX_STACK_LINE(73)
					int tmp12 = (int(b) & int((int)255));		HX_STACK_VAR(tmp12,"tmp12");
					HX_STACK_LINE(73)
		...
		if ((tmp3)){
			...
			HX_STACK_LINE(92)
			{
				...
				HX_STACK_LINE(92)
				{
					...
					int tmp13 = tmp12;		HX_STACK_VAR(tmp13,"tmp13");
					HX_STACK_LINE(92)
					Float tmp14 = ::lime::math::color::_BGRA::BGRA_Impl__obj::unmult;		HX_STACK_VAR(tmp14,"tmp14");
					HX_STACK_LINE(92)
		...
		if ((tmp)){
			...
			if ((tmp3)){
				...
				if ((tmp6)){
					...
					HX_STACK_LINE(103)
					::lime::math::color::_BGRA::BGRA_Impl__obj::a16 = tmp7;
					HX_STACK_LINE(103)
					{
						HX_STACK_LINE(103)
						...
						int tmp11 = tmp10;		HX_STACK_VAR(tmp11,"tmp11");
						HX_STACK_LINE(103)
						int tmp12 = ::lime::math::color::_BGRA::BGRA_Impl__obj::a16;		HX_STACK_VAR(tmp12,"tmp12");
						HX_STACK_LINE(103)
						...
						HX_STACK_LINE(103)
						int tmp21 = ::lime::math::color::_BGRA::BGRA_Impl__obj::a16;		HX_STACK_VAR(tmp21,"tmp21");
						HX_STACK_LINE(103)
						...
						HX_STACK_LINE(103)
						int tmp31 = ::lime::math::color::_BGRA::BGRA_Impl__obj::a16;		HX_STACK_VAR(tmp31,"tmp31");
						HX_STACK_LINE(103)
...
int BGRA_Impl__obj::__fromARGB( int argb){
	...
	HX_STACK_LINE(137)
	{
		...
		HX_STACK_LINE(137)
		{
			...
			HX_STACK_LINE(137)
			int tmp13 = (int(argb) >> int((int)16));		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(137)
			int tmp14 = tmp13;		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(137)
			int tmp15 = (int(tmp14) & int((int)255));		HX_STACK_VAR(tmp15,"tmp15");
...
int BGRA_Impl__obj::__fromRGBA( int rgba){
	...
	HX_STACK_LINE(144)
	{
		...
		HX_STACK_LINE(144)
		{
			...
			HX_STACK_LINE(144)
			int tmp8 = (int(rgba) >> int((int)16));		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(144)
			int tmp9 = tmp8;		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(144)
			int tmp10 = (int(tmp9) & int((int)255));		HX_STACK_VAR(tmp10,"tmp10");
			...
			HX_STACK_LINE(144)
			int tmp22 = (int(rgba) & int((int)255));		HX_STACK_VAR(tmp22,"tmp22");
			HX_STACK_LINE(144)
			int tmp23 = tmp22;		HX_STACK_VAR(tmp23,"tmp23");
			HX_STACK_LINE(144)
			int tmp24 = (int(tmp23) & int((int)255));		HX_STACK_VAR(tmp24,"tmp24");
