...
Void ARGB_Impl__obj::multiplyAlpha( int this1){
{
		...
		if ((tmp4)){
			...
			HX_STACK_LINE(43)
			bool tmp9 = (tmp8 != (int)255);		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(43)
			if ((tmp9)){
				HX_STACK_LINE(45)
				...
				{
					HX_STACK_LINE(45)
					::lime::utils::ArrayBufferView tmp11 = ::lime::math::color::_RGBA::RGBA_Impl__obj::__alpha16;		HX_STACK_VAR(tmp11,"tmp11");
					HX_STACK_LINE(45)
					::lime::utils::ArrayBufferView this2 = tmp11;		HX_STACK_VAR(this2,"this2");
					HX_STACK_LINE(45)
					tmp10 = ::__hxcpp_memory_get_ui32(this2->buffer->b,(this2->byteOffset + (((int((int(this1) >> int((int)24))) & int((int)255))) * (int)4)));
				}
				HX_STACK_LINE(45)
				::lime::math::color::_ARGB::ARGB_Impl__obj::a16 = tmp10;
				HX_STACK_LINE(46)
				{
					HX_STACK_LINE(46)
					...
					HX_STACK_LINE(46)
					int tmp26 = (int(tmp16) | int(tmp25));		HX_STACK_VAR(tmp26,"tmp26");
					HX_STACK_LINE(46)
					...
					HX_STACK_LINE(46)
					int tmp31 = ::lime::math::color::_ARGB::ARGB_Impl__obj::a16;		HX_STACK_VAR(tmp31,"tmp31");
					HX_STACK_LINE(46)
					...
					HX_STACK_LINE(46)
					int tmp39 = ::lime::math::color::_ARGB::ARGB_Impl__obj::a16;		HX_STACK_VAR(tmp39,"tmp39");
					HX_STACK_LINE(46)
					...
					HX_STACK_LINE(46)
					int tmp43 = (int(tmp36) | int(tmp42));		HX_STACK_VAR(tmp43,"tmp43");
					HX_STACK_LINE(46)
					this1 = tmp43;
				}
			}
	...
	HX_STACK_ARG(premultiplied,"premultiplied")
{
		...
		if ((tmp1)){
			...
			if ((tmp7)){
				...
				HX_STACK_LINE(73)
				::lime::math::color::_ARGB::ARGB_Impl__obj::unmult = tmp12;
				HX_STACK_LINE(73)
				{
					HX_STACK_LINE(73)
					...
					{
						HX_STACK_LINE(73)
						::lime::utils::ArrayBufferView tmp14 = ::lime::math::color::_RGBA::RGBA_Impl__obj::__clamp;		HX_STACK_VAR(tmp14,"tmp14");
						HX_STACK_LINE(73)
						...
						int tmp18 = tmp17;		HX_STACK_VAR(tmp18,"tmp18");
						HX_STACK_LINE(73)
						Float tmp19 = ::lime::math::color::_ARGB::ARGB_Impl__obj::unmult;		HX_STACK_VAR(tmp19,"tmp19");
						HX_STACK_LINE(73)
						...
						HX_STACK_LINE(73)
						int tmp22 = ::__hxcpp_memory_get_byte(this2->buffer->b,(this2->byteOffset + idx));		HX_STACK_VAR(tmp22,"tmp22");
						HX_STACK_LINE(73)
						tmp13 = (int(tmp22) & int((int)255));
					}
					HX_STACK_LINE(73)
					...
					{
						HX_STACK_LINE(73)
						::lime::utils::ArrayBufferView tmp15 = ::lime::math::color::_RGBA::RGBA_Impl__obj::__clamp;		HX_STACK_VAR(tmp15,"tmp15");
						HX_STACK_LINE(73)
						::lime::utils::ArrayBufferView this2 = tmp15;		HX_STACK_VAR(this2,"this2");
						HX_STACK_LINE(73)
						int tmp16 = (int(this1) >> int((int)8));		HX_STACK_VAR(tmp16,"tmp16");
						HX_STACK_LINE(73)
						...
						HX_STACK_LINE(73)
						Float tmp20 = ::lime::math::color::_ARGB::ARGB_Impl__obj::unmult;		HX_STACK_VAR(tmp20,"tmp20");
						HX_STACK_LINE(73)
						...
						HX_STACK_LINE(73)
						int tmp23 = ::__hxcpp_memory_get_byte(this2->buffer->b,(this2->byteOffset + idx));		HX_STACK_VAR(tmp23,"tmp23");
						HX_STACK_LINE(73)
						tmp14 = (int(tmp23) & int((int)255));
					}
					HX_STACK_LINE(73)
					...
					HX_STACK_LINE(73)
					{
						...
						HX_STACK_LINE(73)
						::lime::utils::ArrayBufferView this2 = tmp16;		HX_STACK_VAR(this2,"this2");
						HX_STACK_LINE(73)
						int tmp17 = (int(this1) & int((int)255));		HX_STACK_VAR(tmp17,"tmp17");
						HX_STACK_LINE(73)
						int tmp18 = tmp17;		HX_STACK_VAR(tmp18,"tmp18");
						HX_STACK_LINE(73)
						Float tmp19 = ::lime::math::color::_ARGB::ARGB_Impl__obj::unmult;		HX_STACK_VAR(tmp19,"tmp19");
					...
					HX_STACK_LINE(73)
					int tmp16 = (int(this1) >> int((int)24));		HX_STACK_VAR(tmp16,"tmp16");
					HX_STACK_LINE(73)
					int tmp17 = tmp16;		HX_STACK_VAR(tmp17,"tmp17");
					HX_STACK_LINE(73)
					int tmp18 = (int(tmp17) & int((int)255));		HX_STACK_VAR(tmp18,"tmp18");
...
Void ARGB_Impl__obj::unmultiplyAlpha( int this1){
{
		...
		if ((tmp5)){
			...
			int tmp9 = tmp8;		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(91)
			Float tmp10 = (Float(((Float)255.0)) / Float(tmp9));		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(91)
			::lime::math::color::_ARGB::ARGB_Impl__obj::unmult = tmp10;
			HX_STACK_LINE(92)
			{
				HX_STACK_LINE(92)
				...
				HX_STACK_LINE(92)
				{
					...
					int tmp16 = tmp15;		HX_STACK_VAR(tmp16,"tmp16");
					HX_STACK_LINE(92)
					Float tmp17 = ::lime::math::color::_ARGB::ARGB_Impl__obj::unmult;		HX_STACK_VAR(tmp17,"tmp17");
					HX_STACK_LINE(92)
					Float tmp18 = (tmp16 * tmp17);		HX_STACK_VAR(tmp18,"tmp18");
					HX_STACK_LINE(92)
					int tmp19 = ::Math_obj::floor(tmp18);		HX_STACK_VAR(tmp19,"tmp19");
					HX_STACK_LINE(92)
					int idx = tmp19;		HX_STACK_VAR(idx,"idx");
					HX_STACK_LINE(92)
					int tmp20 = ::__hxcpp_memory_get_byte(this2->buffer->b,(this2->byteOffset + idx));		HX_STACK_VAR(tmp20,"tmp20");
					HX_STACK_LINE(92)
					tmp11 = (int(tmp20) & int((int)255));
				}
				HX_STACK_LINE(92)
				int r = tmp11;		HX_STACK_VAR(r,"r");
				HX_STACK_LINE(92)
				Dynamic tmp12;		HX_STACK_VAR(tmp12,"tmp12");
				HX_STACK_LINE(92)
				{
					HX_STACK_LINE(92)
					::lime::utils::ArrayBufferView tmp13 = ::lime::math::color::_RGBA::RGBA_Impl__obj::__clamp;		HX_STACK_VAR(tmp13,"tmp13");
					HX_STACK_LINE(92)
					::lime::utils::ArrayBufferView this2 = tmp13;		HX_STACK_VAR(this2,"this2");
					HX_STACK_LINE(92)
					int tmp14 = (int(this1) >> int((int)8));		HX_STACK_VAR(tmp14,"tmp14");
					HX_STACK_LINE(92)
					...
					int tmp17 = tmp16;		HX_STACK_VAR(tmp17,"tmp17");
					HX_STACK_LINE(92)
					Float tmp18 = ::lime::math::color::_ARGB::ARGB_Impl__obj::unmult;		HX_STACK_VAR(tmp18,"tmp18");
					HX_STACK_LINE(92)
					Float tmp19 = (tmp17 * tmp18);		HX_STACK_VAR(tmp19,"tmp19");
					HX_STACK_LINE(92)
					int tmp20 = ::Math_obj::floor(tmp19);		HX_STACK_VAR(tmp20,"tmp20");
					HX_STACK_LINE(92)
					int idx = tmp20;		HX_STACK_VAR(idx,"idx");
					HX_STACK_LINE(92)
					int tmp21 = ::__hxcpp_memory_get_byte(this2->buffer->b,(this2->byteOffset + idx));		HX_STACK_VAR(tmp21,"tmp21");
					HX_STACK_LINE(92)
					tmp12 = (int(tmp21) & int((int)255));
				}
				HX_STACK_LINE(92)
				...
				HX_STACK_LINE(92)
				{
					...
					::lime::utils::ArrayBufferView this2 = tmp14;		HX_STACK_VAR(this2,"this2");
					HX_STACK_LINE(92)
					int tmp15 = (int(this1) & int((int)255));		HX_STACK_VAR(tmp15,"tmp15");
					HX_STACK_LINE(92)
					int tmp16 = tmp15;		HX_STACK_VAR(tmp16,"tmp16");
					HX_STACK_LINE(92)
					Float tmp17 = ::lime::math::color::_ARGB::ARGB_Impl__obj::unmult;		HX_STACK_VAR(tmp17,"tmp17");
	...
	HX_STACK_ARG(premultiplied,"premultiplied")
{
		...
		if ((tmp)){
			...
			if ((tmp5)){
				...
				int tmp9 = tmp8;		HX_STACK_VAR(tmp9,"tmp9");
				HX_STACK_LINE(103)
				bool tmp10 = (tmp9 != (int)255);		HX_STACK_VAR(tmp10,"tmp10");
				HX_STACK_LINE(103)
				if ((tmp10)){
					HX_STACK_LINE(103)
					Dynamic tmp11;		HX_STACK_VAR(tmp11,"tmp11");
					...
					{
						HX_STACK_LINE(103)
						::lime::utils::ArrayBufferView tmp12 = ::lime::math::color::_RGBA::RGBA_Impl__obj::__alpha16;		HX_STACK_VAR(tmp12,"tmp12");
						HX_STACK_LINE(103)
						::lime::utils::ArrayBufferView this2 = tmp12;		HX_STACK_VAR(this2,"this2");
						HX_STACK_LINE(103)
						tmp11 = ::__hxcpp_memory_get_ui32(this2->buffer->b,(this2->byteOffset + (((int((int(this1) >> int((int)24))) & int((int)255))) * (int)4)));
					}
					HX_STACK_LINE(103)
					::lime::math::color::_ARGB::ARGB_Impl__obj::a16 = tmp11;
					HX_STACK_LINE(103)
					{
						HX_STACK_LINE(103)
						...
						HX_STACK_LINE(103)
						int tmp18 = (int(this1) >> int((int)16));		HX_STACK_VAR(tmp18,"tmp18");
						HX_STACK_LINE(103)
						int tmp19 = tmp18;		HX_STACK_VAR(tmp19,"tmp19");
						HX_STACK_LINE(103)
						int tmp20 = (int(tmp19) & int((int)255));		HX_STACK_VAR(tmp20,"tmp20");
						...
						HX_STACK_LINE(103)
						int tmp27 = (int(tmp17) | int(tmp26));		HX_STACK_VAR(tmp27,"tmp27");
						HX_STACK_LINE(103)
						...
						HX_STACK_LINE(103)
						int tmp32 = ::lime::math::color::_ARGB::ARGB_Impl__obj::a16;		HX_STACK_VAR(tmp32,"tmp32");
						HX_STACK_LINE(103)
						...
						HX_STACK_LINE(103)
						int tmp40 = ::lime::math::color::_ARGB::ARGB_Impl__obj::a16;		HX_STACK_VAR(tmp40,"tmp40");
						HX_STACK_LINE(103)
						...
						HX_STACK_LINE(103)
						int tmp44 = (int(tmp37) | int(tmp43));		HX_STACK_VAR(tmp44,"tmp44");
						HX_STACK_LINE(103)
						this1 = tmp44;
					}
				}
		...
		switch( (int)(tmp1)){
			case (int)2: {
				...
				HX_STACK_LINE(112)
				{
					...
					int tmp4 = (int(tmp3) & int((int)255));		HX_STACK_VAR(tmp4,"tmp4");
					HX_STACK_LINE(112)
					int val = tmp4;		HX_STACK_VAR(val,"val");
					HX_STACK_LINE(112)
...
int ARGB_Impl__obj::__fromBGRA( int bgra){
	...
	HX_STACK_LINE(137)
	{
		...
		HX_STACK_LINE(137)
		{
			...
			HX_STACK_LINE(137)
			int tmp13 = (int(bgra) >> int((int)16));		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(137)
			int tmp14 = tmp13;		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(137)
			int tmp15 = (int(tmp14) & int((int)255));		HX_STACK_VAR(tmp15,"tmp15");
			...
			int tmp24 = (int(tmp23) & int((int)255));		HX_STACK_VAR(tmp24,"tmp24");
			HX_STACK_LINE(137)
			int tmp25 = (int(tmp19) | int(tmp24));		HX_STACK_VAR(tmp25,"tmp25");
			HX_STACK_LINE(137)
			argb = tmp25;
		}
		HX_STACK_LINE(137)
...
int ARGB_Impl__obj::__fromRGBA( int rgba){
	...
	HX_STACK_LINE(144)
	{
		...
		HX_STACK_LINE(144)
		{
			...
			int tmp5 = (int(tmp4) << int((int)24));		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(144)
			int tmp6 = (int(rgba) >> int((int)24));		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(144)
			int tmp7 = tmp6;		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(144)
			int tmp8 = (int(tmp7) & int((int)255));		HX_STACK_VAR(tmp8,"tmp8");
			...
			int tmp12 = (int(tmp5) | int(tmp11));		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(144)
			int tmp13 = (int(rgba) >> int((int)16));		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(144)
			int tmp14 = tmp13;		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(144)
			int tmp15 = (int(tmp14) & int((int)255));		HX_STACK_VAR(tmp15,"tmp15");
...
int ARGB_Impl__obj::set_a( int this1,int value){
	...
	HX_STACK_LINE(166)
	{
		...
		HX_STACK_LINE(166)
		int tmp8 = (int(tmp1) | int(tmp7));		HX_STACK_VAR(tmp8,"tmp8");
		HX_STACK_LINE(166)
...
int ARGB_Impl__obj::set_b( int this1,int value){
	...
	HX_STACK_LINE(181)
	{
		...
		int tmp19 = (int(tmp12) | int(tmp18));		HX_STACK_VAR(tmp19,"tmp19");
		HX_STACK_LINE(181)
		int tmp20 = (int(value) & int((int)255));		HX_STACK_VAR(tmp20,"tmp20");
		HX_STACK_LINE(181)
...
int ARGB_Impl__obj::set_g( int this1,int value){
	...
	HX_STACK_LINE(196)
	{
		...
		int tmp12 = (int(tmp5) | int(tmp11));		HX_STACK_VAR(tmp12,"tmp12");
		HX_STACK_LINE(196)
		int tmp13 = (int(value) & int((int)255));		HX_STACK_VAR(tmp13,"tmp13");
		HX_STACK_LINE(196)
		int tmp14 = (int(tmp13) << int((int)8));		HX_STACK_VAR(tmp14,"tmp14");
		HX_STACK_LINE(196)
...
int ARGB_Impl__obj::set_r( int this1,int value){
	...
	HX_STACK_LINE(211)
	{
		...
		int tmp5 = (int(tmp4) << int((int)24));		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(211)
		int tmp6 = (int(value) & int((int)255));		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(211)
		int tmp7 = (int(tmp6) << int((int)16));		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(211)
		int tmp8 = (int(tmp5) | int(tmp7));		HX_STACK_VAR(tmp8,"tmp8");
