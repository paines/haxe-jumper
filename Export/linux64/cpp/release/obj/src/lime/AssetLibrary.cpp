...
{
HX_STACK_FRAME("lime.AssetLibrary","new",0xa1312ef6,"lime.AssetLibrary.new","lime/Assets.hx",889,0x48c77341)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(892)
...
bool AssetLibrary_obj::exists( ::String id,::String type){
	HX_STACK_FRAME("lime.AssetLibrary","exists",0xcc578106,"lime.AssetLibrary.exists","lime/Assets.hx",904,0x48c77341)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
...
::lime::audio::AudioBuffer AssetLibrary_obj::getAudioBuffer( ::String id){
	HX_STACK_FRAME("lime.AssetLibrary","getAudioBuffer",0xf990deaa,"lime.AssetLibrary.getAudioBuffer","lime/Assets.hx",911,0x48c77341)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_LINE(911)
	return null();
...
::lime::utils::Bytes AssetLibrary_obj::getBytes( ::String id){
	HX_STACK_FRAME("lime.AssetLibrary","getBytes",0xc0e5199f,"lime.AssetLibrary.getBytes","lime/Assets.hx",918,0x48c77341)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_LINE(918)
	return null();
...
::lime::text::Font AssetLibrary_obj::getFont( ::String id){
	HX_STACK_FRAME("lime.AssetLibrary","getFont",0xf2426f1b,"lime.AssetLibrary.getFont","lime/Assets.hx",925,0x48c77341)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_LINE(925)
	return null();
...
::lime::graphics::Image AssetLibrary_obj::getImage( ::String id){
	HX_STACK_FRAME("lime.AssetLibrary","getImage",0xc0b6308f,"lime.AssetLibrary.getImage","lime/Assets.hx",932,0x48c77341)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_LINE(932)
	return null();
...
::String AssetLibrary_obj::getPath( ::String id){
	HX_STACK_FRAME("lime.AssetLibrary","getPath",0xf8d3f6f1,"lime.AssetLibrary.getPath","lime/Assets.hx",939,0x48c77341)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_LINE(939)
	return null();
...
::String AssetLibrary_obj::getText( ::String id){
	HX_STACK_FRAME("lime.AssetLibrary","getText",0xfb7bddf9,"lime.AssetLibrary.getText","lime/Assets.hx",944,0x48c77341)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_LINE(948)
...
bool AssetLibrary_obj::isLocal( ::String id,::String type){
	HX_STACK_FRAME("lime.AssetLibrary","isLocal",0xf175ceb7,"lime.AssetLibrary.isLocal","lime/Assets.hx",971,0x48c77341)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_ARG(type,"type")
	HX_STACK_LINE(971)
...
Array< ::String > AssetLibrary_obj::list( ::String type){
	HX_STACK_FRAME("lime.AssetLibrary","list",0x68888108,"lime.AssetLibrary.list","lime/Assets.hx",978,0x48c77341)
	HX_STACK_THIS(this)
	HX_STACK_ARG(type,"type")
	HX_STACK_LINE(978)
	return null();
...
::lime::app::Future AssetLibrary_obj::load( ){
	HX_STACK_FRAME("lime.AssetLibrary","load",0x688cfed0,"lime.AssetLibrary.load","lime/Assets.hx",983,0x48c77341)
	HX_STACK_THIS(this)
	HX_STACK_LINE(983)
	...
	::lime::AssetLibrary run(){
		HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","lime/Assets.hx",985,0x48c77341)
		{
			HX_STACK_LINE(985)
...
::lime::app::Future AssetLibrary_obj::loadAudioBuffer( ::String id){
	HX_STACK_FRAME("lime.AssetLibrary","loadAudioBuffer",0x68b85986,"lime.AssetLibrary.loadAudioBuffer","lime/Assets.hx",990,0x48c77341)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_LINE(990)
	::lime::AssetLibrary _g = hx::ObjectPtr<OBJ_>(this);		HX_STACK_VAR(_g,"_g");
	...
	::lime::audio::AudioBuffer run(){
		HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","lime/Assets.hx",992,0x48c77341)
		{
			HX_STACK_LINE(992)
			::String tmp = id;		HX_STACK_VAR(tmp,"tmp");
			HX_STACK_LINE(992)
...
::lime::app::Future AssetLibrary_obj::loadBytes( ::String id){
	HX_STACK_FRAME("lime.AssetLibrary","loadBytes",0x3c9ac77b,"lime.AssetLibrary.loadBytes","lime/Assets.hx",997,0x48c77341)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_LINE(997)
	::lime::AssetLibrary _g = hx::ObjectPtr<OBJ_>(this);		HX_STACK_VAR(_g,"_g");
	...
	::lime::utils::Bytes run(){
		HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","lime/Assets.hx",999,0x48c77341)
		{
			HX_STACK_LINE(999)
			::String tmp = id;		HX_STACK_VAR(tmp,"tmp");
			HX_STACK_LINE(999)
...
::lime::app::Future AssetLibrary_obj::loadFont( ::String id){
	HX_STACK_FRAME("lime.AssetLibrary","loadFont",0x57d630bf,"lime.AssetLibrary.loadFont","lime/Assets.hx",1004,0x48c77341)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_LINE(1004)
	::lime::AssetLibrary _g = hx::ObjectPtr<OBJ_>(this);		HX_STACK_VAR(_g,"_g");
	...
	int __ArgCount() const { return 0; }
	::lime::text::Font run(){
		HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","lime/Assets.hx",1006,0x48c77341)
		{
			HX_STACK_LINE(1006)
			::String tmp = id;		HX_STACK_VAR(tmp,"tmp");
			HX_STACK_LINE(1006)
...
::lime::app::Future AssetLibrary_obj::loadImage( ::String id){
	HX_STACK_FRAME("lime.AssetLibrary","loadImage",0x3c6bde6b,"lime.AssetLibrary.loadImage","lime/Assets.hx",1011,0x48c77341)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_LINE(1011)
	::lime::AssetLibrary _g = hx::ObjectPtr<OBJ_>(this);		HX_STACK_VAR(_g,"_g");
	...
	::lime::graphics::Image run(){
		HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","lime/Assets.hx",1013,0x48c77341)
		{
			HX_STACK_LINE(1013)
			::String tmp = id;		HX_STACK_VAR(tmp,"tmp");
			HX_STACK_LINE(1013)
...
::lime::app::Future AssetLibrary_obj::loadText( ::String id){
	HX_STACK_FRAME("lime.AssetLibrary","loadText",0x610f9f9d,"lime.AssetLibrary.loadText","lime/Assets.hx",1018,0x48c77341)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_LINE(1020)
	::String tmp = id;		HX_STACK_VAR(tmp,"tmp");
	...
	::lime::app::Future run(::lime::utils::Bytes bytes){
		HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","lime/Assets.hx",1020,0x48c77341)
		HX_STACK_ARG(bytes,"bytes")
		{
			...
			int __ArgCount() const { return 0; }
			::String run(){
				HX_STACK_FRAME("*","_Function_2_1",0x5201af78,"*._Function_2_1","lime/Assets.hx",1022,0x48c77341)
				{
					HX_STACK_LINE(1024)
					bool tmp2 = (bytes == null());		HX_STACK_VAR(tmp2,"tmp2");
					HX_STACK_LINE(1024)
...
{
		HX_STACK_FRAME("lime.AssetLibrary","unload",0x72040429,"lime.AssetLibrary.unload","lime/Assets.hx",1041,0x48c77341)
		HX_STACK_THIS(this)
	}
return null();
}
