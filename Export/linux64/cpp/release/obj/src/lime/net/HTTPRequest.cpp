...
::lime::app::Future HTTPRequest_obj::load( ::String url){
	...
	HX_STACK_LINE(143)
	::lime::app::Promise_lime_utils_Bytes tmp4 = this->promise;		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(143)
...
int HTTPRequest_obj::curl_onProgress( Float dltotal,Float dlnow,Float uptotal,Float upnow){
	...
	if ((tmp10)){
		...
		HX_STACK_LINE(164)
		::lime::app::Promise_lime_utils_Bytes tmp23 = this->promise;		HX_STACK_VAR(tmp23,"tmp23");
		HX_STACK_LINE(164)
...
Void HTTPRequest_obj::request_onProgress( Dynamic event){
{
		...
		HX_STACK_LINE(187)
		::lime::app::Promise_lime_utils_Bytes tmp = this->promise;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(187)
