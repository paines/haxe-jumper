...
{
	onEnd= ::lime::app::_Event_lime_ui_Touch_Void_obj::__new();
	onMove= ::lime::app::_Event_lime_ui_Touch_Void_obj::__new();
	onStart= ::lime::app::_Event_lime_ui_Touch_Void_obj::__new();
}
