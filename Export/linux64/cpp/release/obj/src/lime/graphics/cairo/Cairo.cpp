...
::lime::math::Matrix3 Cairo_obj::set_matrix( ::lime::math::Matrix3 value){
	...
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(749)
	::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_set_matrix.call(hx::DynamicPtr(this->handle),value->a,value->b,value->c,value->d,value->tx,value->ty);
	HX_STACK_LINE(753)
...
Dynamic Cairo_obj::get_target( ){
	HX_STACK_FRAME("lime.graphics.cairo.Cairo","get_target",0xe79089f0,"lime.graphics.cairo.Cairo.get_target","lime/graphics/cairo/Cairo.hx",824,0x0918a4c7)
	HX_STACK_THIS(this)
	HX_STACK_LINE(827)
	Dynamic tmp;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(827)
...
Void Cairo_obj::lime_cairo_set_matrix( Dynamic handle,Float a,Float b,Float c,Float d,Float tx,Float ty){
{
		...
		HX_STACK_ARG(ty,"ty")
		HX_STACK_LINE(950)
		::lime::graphics::cairo::Cairo_obj::cffi_lime_cairo_set_matrix.call(hx::DynamicPtr(handle),a,b,c,d,tx,ty);
	}
return null();
}
...
static hx::StaticInfo sStaticStorageInfo[] = {
	...
	{hx::fsObject /*::cpp::Function< void ( ::hx::Object * ,Float ,Float ,Float ,Float ,Float ,Float ) >*/ ,(void *) &Cairo_obj::cffi_lime_cairo_set_matrix,HX_HCSTRING("cffi_lime_cairo_set_matrix","\x26","\xd2","\xbe","\x17")},
