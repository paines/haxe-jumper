									...
									if ((tmp31)){
										...
										HX_STACK_LINE(60)
										{
											...
											HX_STACK_LINE(60)
											{
												...
												HX_STACK_LINE(60)
												int tmp37 = (int(pixel) >> int((int)24));		HX_STACK_VAR(tmp37,"tmp37");
												HX_STACK_LINE(60)
											...
											HX_STACK_LINE(60)
											{
												...
												HX_STACK_LINE(60)
												int tmp39 = (int(pixel) >> int((int)8));		HX_STACK_VAR(tmp39,"tmp39");
												HX_STACK_LINE(60)
												int tmp40 = tmp39;		HX_STACK_VAR(tmp40,"tmp40");
												HX_STACK_LINE(60)
											...
											HX_STACK_LINE(60)
											int tmp46 = (int(pixel) & int((int)255));		HX_STACK_VAR(tmp46,"tmp46");
											HX_STACK_LINE(60)
								...
								if ((tmp26)){
									...
									if ((tmp29)){
										...
										if ((tmp32)){
											...
											{
												HX_STACK_LINE(62)
												int tmp34 = (int(pixel) >> int((int)24));		HX_STACK_VAR(tmp34,"tmp34");
												HX_STACK_LINE(62)
												...
												HX_STACK_LINE(62)
												int tmp43 = (int(pixel) >> int((int)16));		HX_STACK_VAR(tmp43,"tmp43");
												HX_STACK_LINE(62)
												...
												HX_STACK_LINE(62)
												int tmp52 = (int(tmp42) | int(tmp51));		HX_STACK_VAR(tmp52,"tmp52");
												HX_STACK_LINE(62)
												int tmp53 = (int(pixel) >> int((int)8));		HX_STACK_VAR(tmp53,"tmp53");
												HX_STACK_LINE(62)
												...
												HX_STACK_LINE(62)
												int tmp61 = (int(tmp60) << int((int)8));		HX_STACK_VAR(tmp61,"tmp61");
												HX_STACK_LINE(62)
												int tmp62 = (int(tmp52) | int(tmp61));		HX_STACK_VAR(tmp62,"tmp62");
												HX_STACK_LINE(62)
												int tmp63 = (int(pixel) & int((int)255));		HX_STACK_VAR(tmp63,"tmp63");
												HX_STACK_LINE(62)
									...
									if ((tmp33)){
										...
										HX_STACK_LINE(124)
										{
											...
											HX_STACK_LINE(124)
											{
												...
												::lime::utils::ArrayBufferView this1 = tmp40;		HX_STACK_VAR(this1,"this1");
												HX_STACK_LINE(124)
												int tmp41 = (int(destPixel) >> int((int)8));		HX_STACK_VAR(tmp41,"tmp41");
												HX_STACK_LINE(124)
												int tmp42 = tmp41;		HX_STACK_VAR(tmp42,"tmp42");
												HX_STACK_LINE(124)
												int tmp43 = (int(tmp42) & int((int)255));		HX_STACK_VAR(tmp43,"tmp43");
											...
											int tmp47 = (int(tmp44) | int(tmp46));		HX_STACK_VAR(tmp47,"tmp47");
											HX_STACK_LINE(124)
											int tmp48 = (int(destPixel) & int((int)255));		HX_STACK_VAR(tmp48,"tmp48");
											HX_STACK_LINE(124)
											int tmp49 = tmp48;		HX_STACK_VAR(tmp49,"tmp49");
											HX_STACK_LINE(124)
											int tmp50 = (int(tmp49) & int((int)255));		HX_STACK_VAR(tmp50,"tmp50");
							...
							switch( (int)(tmp29)){
								case (int)0: {
									HX_STACK_LINE(137)
									{
										...
										int tmp37 = (int(tmp36) << int((int)16));		HX_STACK_VAR(tmp37,"tmp37");
										HX_STACK_LINE(137)
										int tmp38 = (int(tmp31) | int(tmp37));		HX_STACK_VAR(tmp38,"tmp38");
										HX_STACK_LINE(137)
										...
										int tmp44 = (int(tmp43) << int((int)8));		HX_STACK_VAR(tmp44,"tmp44");
										HX_STACK_LINE(137)
										int tmp45 = (int(tmp38) | int(tmp44));		HX_STACK_VAR(tmp45,"tmp45");
										HX_STACK_LINE(137)
								...
								case (int)1: {
									HX_STACK_LINE(138)
									{
										...
										int tmp35 = (int(tmp34) << int((int)24));		HX_STACK_VAR(tmp35,"tmp35");
										HX_STACK_LINE(138)
										int tmp36 = (int(value) & int((int)255));		HX_STACK_VAR(tmp36,"tmp36");
										HX_STACK_LINE(138)
										int tmp37 = (int(tmp36) << int((int)16));		HX_STACK_VAR(tmp37,"tmp37");
										HX_STACK_LINE(138)
										int tmp38 = (int(tmp35) | int(tmp37));		HX_STACK_VAR(tmp38,"tmp38");
								...
								case (int)2: {
									HX_STACK_LINE(139)
									{
										...
										int tmp35 = (int(tmp34) << int((int)24));		HX_STACK_VAR(tmp35,"tmp35");
										HX_STACK_LINE(139)
										int tmp36 = (int(destPixel) >> int((int)16));		HX_STACK_VAR(tmp36,"tmp36");
										HX_STACK_LINE(139)
										int tmp37 = tmp36;		HX_STACK_VAR(tmp37,"tmp37");
										HX_STACK_LINE(139)
										...
										int tmp41 = (int(tmp40) << int((int)16));		HX_STACK_VAR(tmp41,"tmp41");
										HX_STACK_LINE(139)
										int tmp42 = (int(tmp35) | int(tmp41));		HX_STACK_VAR(tmp42,"tmp42");
										HX_STACK_LINE(139)
								...
								case (int)3: {
									HX_STACK_LINE(140)
									{
										...
										HX_STACK_LINE(140)
										int tmp49 = (int(tmp42) | int(tmp48));		HX_STACK_VAR(tmp49,"tmp49");
										HX_STACK_LINE(140)
									...
									if ((tmp33)){
										...
										if ((tmp36)){
											...
											HX_STACK_LINE(144)
											{
												...
												HX_STACK_LINE(144)
												int tmp56 = (int(tmp46) | int(tmp55));		HX_STACK_VAR(tmp56,"tmp56");
												HX_STACK_LINE(144)
												...
												HX_STACK_LINE(144)
												int tmp61 = ::lime::math::color::_RGBA::RGBA_Impl__obj::a16;		HX_STACK_VAR(tmp61,"tmp61");
												HX_STACK_LINE(144)
												...
												HX_STACK_LINE(144)
												int tmp66 = (int(tmp56) | int(tmp65));		HX_STACK_VAR(tmp66,"tmp66");
												HX_STACK_LINE(144)
												int tmp67 = (int(destPixel) & int((int)255));		HX_STACK_VAR(tmp67,"tmp67");
												HX_STACK_LINE(144)
									...
									if ((tmp36)){
										...
										HX_STACK_LINE(192)
										{
											...
											HX_STACK_LINE(192)
											{
												...
												int tmp46 = tmp45;		HX_STACK_VAR(tmp46,"tmp46");
												HX_STACK_LINE(192)
												Float tmp47 = ::lime::math::color::_RGBA::RGBA_Impl__obj::unmult;		HX_STACK_VAR(tmp47,"tmp47");
												HX_STACK_LINE(192)
												Float tmp48 = (tmp46 * tmp47);		HX_STACK_VAR(tmp48,"tmp48");
												HX_STACK_LINE(192)
												int tmp49 = ::Math_obj::round(tmp48);		HX_STACK_VAR(tmp49,"tmp49");
												HX_STACK_LINE(192)
												int idx = tmp49;		HX_STACK_VAR(idx,"idx");
												HX_STACK_LINE(192)
												int tmp50 = ::__hxcpp_memory_get_byte(this1->buffer->b,(this1->byteOffset + idx));		HX_STACK_VAR(tmp50,"tmp50");
												HX_STACK_LINE(192)
											...
											HX_STACK_LINE(192)
											{
												...
												int tmp47 = tmp46;		HX_STACK_VAR(tmp47,"tmp47");
												HX_STACK_LINE(192)
												Float tmp48 = ::lime::math::color::_RGBA::RGBA_Impl__obj::unmult;		HX_STACK_VAR(tmp48,"tmp48");
												HX_STACK_LINE(192)
												Float tmp49 = (tmp47 * tmp48);		HX_STACK_VAR(tmp49,"tmp49");
												HX_STACK_LINE(192)
												int tmp50 = ::Math_obj::round(tmp49);		HX_STACK_VAR(tmp50,"tmp50");
												HX_STACK_LINE(192)
												int idx = tmp50;		HX_STACK_VAR(idx,"idx");
												HX_STACK_LINE(192)
												int tmp51 = ::__hxcpp_memory_get_byte(this1->buffer->b,(this1->byteOffset + idx));		HX_STACK_VAR(tmp51,"tmp51");
												HX_STACK_LINE(192)
												tmp42 = (int(tmp51) & int((int)255));
											}
											HX_STACK_LINE(192)
							...
							HX_STACK_LINE(193)
							{
								...
								if ((tmp31)){
									...
									if ((tmp34)){
										...
										int tmp36 = tmp35;		HX_STACK_VAR(tmp36,"tmp36");
										HX_STACK_LINE(193)
										bool tmp37 = (tmp36 != (int)255);		HX_STACK_VAR(tmp37,"tmp37");
										HX_STACK_LINE(193)
										if ((tmp37)){
											HX_STACK_LINE(193)
											Dynamic tmp38;		HX_STACK_VAR(tmp38,"tmp38");
											...
											{
												HX_STACK_LINE(193)
												::lime::utils::ArrayBufferView tmp39 = ::lime::math::color::_RGBA::RGBA_Impl__obj::__alpha16;		HX_STACK_VAR(tmp39,"tmp39");
												HX_STACK_LINE(193)
												::lime::utils::ArrayBufferView this1 = tmp39;		HX_STACK_VAR(this1,"this1");
												HX_STACK_LINE(193)
												tmp38 = ::__hxcpp_memory_get_ui32(this1->buffer->b,(this1->byteOffset + (((int(sourcePixel) & int((int)255))) * (int)4)));
											}
											HX_STACK_LINE(193)
											::lime::math::color::_RGBA::RGBA_Impl__obj::a16 = tmp38;
											HX_STACK_LINE(193)
											{
												HX_STACK_LINE(193)
												int tmp39 = (int(sourcePixel) >> int((int)24));		HX_STACK_VAR(tmp39,"tmp39");
												HX_STACK_LINE(193)
												int tmp40 = tmp39;		HX_STACK_VAR(tmp40,"tmp40");
												HX_STACK_LINE(193)
												int tmp41 = (int(tmp40) & int((int)255));		HX_STACK_VAR(tmp41,"tmp41");
												...
												HX_STACK_LINE(193)
												int tmp48 = (int(sourcePixel) >> int((int)16));		HX_STACK_VAR(tmp48,"tmp48");
												HX_STACK_LINE(193)
												int tmp49 = tmp48;		HX_STACK_VAR(tmp49,"tmp49");
												HX_STACK_LINE(193)
												int tmp50 = (int(tmp49) & int((int)255));		HX_STACK_VAR(tmp50,"tmp50");
												...
												HX_STACK_LINE(193)
												int tmp57 = (int(tmp47) | int(tmp56));		HX_STACK_VAR(tmp57,"tmp57");
												HX_STACK_LINE(193)
												int tmp58 = (int(sourcePixel) >> int((int)8));		HX_STACK_VAR(tmp58,"tmp58");
												HX_STACK_LINE(193)
												...
												int tmp65 = (int(tmp64) & int((int)255));		HX_STACK_VAR(tmp65,"tmp65");
												HX_STACK_LINE(193)
												int tmp66 = (int(tmp65) << int((int)8));		HX_STACK_VAR(tmp66,"tmp66");
												HX_STACK_LINE(193)
												int tmp67 = (int(tmp57) | int(tmp66));		HX_STACK_VAR(tmp67,"tmp67");
												HX_STACK_LINE(193)
												int tmp68 = (int(sourcePixel) & int((int)255));		HX_STACK_VAR(tmp68,"tmp68");
												HX_STACK_LINE(193)
					...
					while((true)){
						...
						HX_STACK_LINE(214)
						{
							...
							while((true)){
								...
								HX_STACK_LINE(216)
								{
									...
									if ((tmp33)){
										...
										if ((tmp37)){
											...
											int tmp39 = tmp38;		HX_STACK_VAR(tmp39,"tmp39");
											HX_STACK_LINE(216)
											Float tmp40 = (Float(((Float)255.0)) / Float(tmp39));		HX_STACK_VAR(tmp40,"tmp40");
											HX_STACK_LINE(216)
											::lime::math::color::_RGBA::RGBA_Impl__obj::unmult = tmp40;
											HX_STACK_LINE(216)
											{
												HX_STACK_LINE(216)
												Dynamic tmp41;		HX_STACK_VAR(tmp41,"tmp41");
												...
												HX_STACK_LINE(216)
												int g = tmp42;		HX_STACK_VAR(g,"g");
												HX_STACK_LINE(216)
												Dynamic tmp43;		HX_STACK_VAR(tmp43,"tmp43");
												HX_STACK_LINE(216)
												{
													HX_STACK_LINE(216)
													::lime::utils::ArrayBufferView tmp44 = ::lime::math::color::_RGBA::RGBA_Impl__obj::__clamp;		HX_STACK_VAR(tmp44,"tmp44");
													HX_STACK_LINE(216)
													::lime::utils::ArrayBufferView this1 = tmp44;		HX_STACK_VAR(this1,"this1");
													HX_STACK_LINE(216)
													int tmp45 = (int(sourcePixel) >> int((int)8));		HX_STACK_VAR(tmp45,"tmp45");
													HX_STACK_LINE(216)
													int tmp46 = tmp45;		HX_STACK_VAR(tmp46,"tmp46");
													HX_STACK_LINE(216)
													int tmp47 = (int(tmp46) & int((int)255));		HX_STACK_VAR(tmp47,"tmp47");
													...
													int tmp48 = tmp47;		HX_STACK_VAR(tmp48,"tmp48");
													HX_STACK_LINE(216)
													Float tmp49 = ::lime::math::color::_RGBA::RGBA_Impl__obj::unmult;		HX_STACK_VAR(tmp49,"tmp49");
													HX_STACK_LINE(216)
													Float tmp50 = (tmp48 * tmp49);		HX_STACK_VAR(tmp50,"tmp50");
													HX_STACK_LINE(216)
													int tmp51 = ::Math_obj::round(tmp50);		HX_STACK_VAR(tmp51,"tmp51");
													HX_STACK_LINE(216)
													int idx = tmp51;		HX_STACK_VAR(idx,"idx");
													HX_STACK_LINE(216)
													int tmp52 = ::__hxcpp_memory_get_byte(this1->buffer->b,(this1->byteOffset + idx));		HX_STACK_VAR(tmp52,"tmp52");
													HX_STACK_LINE(216)
													tmp43 = (int(tmp52) & int((int)255));
												}
												HX_STACK_LINE(216)
												int b = tmp43;		HX_STACK_VAR(b,"b");
												HX_STACK_LINE(216)
												int tmp44 = (int(r) & int((int)255));		HX_STACK_VAR(tmp44,"tmp44");
												HX_STACK_LINE(216)
												int tmp45 = (int(tmp44) << int((int)24));		HX_STACK_VAR(tmp45,"tmp45");
												HX_STACK_LINE(216)
												int tmp46 = (int(g) & int((int)255));		HX_STACK_VAR(tmp46,"tmp46");
												HX_STACK_LINE(216)
												int tmp47 = (int(tmp46) << int((int)16));		HX_STACK_VAR(tmp47,"tmp47");
												HX_STACK_LINE(216)
												int tmp48 = (int(tmp45) | int(tmp47));		HX_STACK_VAR(tmp48,"tmp48");
												HX_STACK_LINE(216)
												int tmp49 = (int(b) & int((int)255));		HX_STACK_VAR(tmp49,"tmp49");
												HX_STACK_LINE(216)
												int tmp50 = (int(tmp49) << int((int)8));		HX_STACK_VAR(tmp50,"tmp50");
												HX_STACK_LINE(216)
												int tmp51 = (int(tmp48) | int(tmp50));		HX_STACK_VAR(tmp51,"tmp51");
												HX_STACK_LINE(216)
												int tmp52 = (int(sourcePixel) & int((int)255));		HX_STACK_VAR(tmp52,"tmp52");
												HX_STACK_LINE(216)
												int tmp53 = tmp52;		HX_STACK_VAR(tmp53,"tmp53");
												HX_STACK_LINE(216)
												int tmp54 = (int(tmp53) & int((int)255));		HX_STACK_VAR(tmp54,"tmp54");
												HX_STACK_LINE(216)
												int tmp55 = (int(tmp51) | int(tmp54));		HX_STACK_VAR(tmp55,"tmp55");
												HX_STACK_LINE(216)
												sourcePixel = tmp55;
											}
										}
								...
								int tmp36 = tmp35;		HX_STACK_VAR(tmp36,"tmp36");
								HX_STACK_LINE(220)
								Float tmp37 = (Float(tmp36) / Float(((Float)255.0)));		HX_STACK_VAR(tmp37,"tmp37");
								HX_STACK_LINE(220)
								destAlpha = tmp37;
								HX_STACK_LINE(221)
								Float tmp38 = ((int)1 - sourceAlpha);		HX_STACK_VAR(tmp38,"tmp38");
								HX_STACK_LINE(221)
								oneMinusSourceAlpha = tmp38;
								HX_STACK_LINE(222)
								Float tmp39 = sourceAlpha;		HX_STACK_VAR(tmp39,"tmp39");
								HX_STACK_LINE(222)
								Float tmp40 = (destAlpha * oneMinusSourceAlpha);		HX_STACK_VAR(tmp40,"tmp40");
								HX_STACK_LINE(222)
								Float tmp41 = (tmp39 + tmp40);		HX_STACK_VAR(tmp41,"tmp41");
								HX_STACK_LINE(222)
								blendAlpha = tmp41;
								HX_STACK_LINE(224)
								bool tmp42 = (blendAlpha == (int)0);		HX_STACK_VAR(tmp42,"tmp42");
								HX_STACK_LINE(224)
								if ((tmp42)){
									HX_STACK_LINE(226)
									destPixel = (int)0;
									...
									HX_STACK_LINE(230)
									{
										...
										HX_STACK_LINE(230)
										{
											...
											::lime::utils::ArrayBufferView this1 = tmp44;		HX_STACK_VAR(this1,"this1");
											HX_STACK_LINE(230)
											int tmp45 = (int(sourcePixel) >> int((int)24));		HX_STACK_VAR(tmp45,"tmp45");
											HX_STACK_LINE(230)
											int tmp46 = tmp45;		HX_STACK_VAR(tmp46,"tmp46");
											HX_STACK_LINE(230)
											int tmp47 = (int(tmp46) & int((int)255));		HX_STACK_VAR(tmp47,"tmp47");
											...
											int tmp48 = tmp47;		HX_STACK_VAR(tmp48,"tmp48");
											HX_STACK_LINE(230)
											Float tmp49 = sourceAlpha;		HX_STACK_VAR(tmp49,"tmp49");
											HX_STACK_LINE(230)
											Float tmp50 = (tmp48 * tmp49);		HX_STACK_VAR(tmp50,"tmp50");
											HX_STACK_LINE(230)
											...
											int tmp54 = tmp53;		HX_STACK_VAR(tmp54,"tmp54");
											HX_STACK_LINE(230)
											Float tmp55 = destAlpha;		HX_STACK_VAR(tmp55,"tmp55");
											HX_STACK_LINE(230)
											Float tmp56 = (tmp54 * tmp55);		HX_STACK_VAR(tmp56,"tmp56");
											HX_STACK_LINE(230)
											Float tmp57 = oneMinusSourceAlpha;		HX_STACK_VAR(tmp57,"tmp57");
											HX_STACK_LINE(230)
											Float tmp58 = (tmp56 * tmp57);		HX_STACK_VAR(tmp58,"tmp58");
											HX_STACK_LINE(230)
											Float tmp59 = (tmp50 + tmp58);		HX_STACK_VAR(tmp59,"tmp59");
											HX_STACK_LINE(230)
											Float tmp60 = blendAlpha;		HX_STACK_VAR(tmp60,"tmp60");
											HX_STACK_LINE(230)
											...
											HX_STACK_LINE(230)
											tmp43 = (int(tmp63) & int((int)255));
										}
										HX_STACK_LINE(230)
										int value = tmp43;		HX_STACK_VAR(value,"value");
										HX_STACK_LINE(230)
										{
											HX_STACK_LINE(230)
											...
											int tmp51 = (int(tmp50) << int((int)16));		HX_STACK_VAR(tmp51,"tmp51");
											HX_STACK_LINE(230)
											int tmp52 = (int(tmp45) | int(tmp51));		HX_STACK_VAR(tmp52,"tmp52");
											HX_STACK_LINE(230)
									...
									HX_STACK_LINE(231)
									{
										...
										HX_STACK_LINE(231)
										{
											...
											Float tmp50 = (tmp48 * tmp49);		HX_STACK_VAR(tmp50,"tmp50");
											HX_STACK_LINE(231)
											int tmp51 = (int(destPixel) >> int((int)16));		HX_STACK_VAR(tmp51,"tmp51");
											HX_STACK_LINE(231)
											int tmp52 = tmp51;		HX_STACK_VAR(tmp52,"tmp52");
											HX_STACK_LINE(231)
											int tmp53 = (int(tmp52) & int((int)255));		HX_STACK_VAR(tmp53,"tmp53");
										...
										HX_STACK_LINE(231)
										{
											...
											int tmp48 = (int(tmp47) & int((int)255));		HX_STACK_VAR(tmp48,"tmp48");
											HX_STACK_LINE(231)
											int tmp49 = (int(tmp48) << int((int)24));		HX_STACK_VAR(tmp49,"tmp49");
											HX_STACK_LINE(231)
											int tmp50 = (int(value) & int((int)255));		HX_STACK_VAR(tmp50,"tmp50");
											HX_STACK_LINE(231)
											int tmp51 = (int(tmp50) << int((int)16));		HX_STACK_VAR(tmp51,"tmp51");
									...
									HX_STACK_LINE(232)
									{
										...
										HX_STACK_LINE(232)
										{
											...
											int tmp49 = (int(tmp48) << int((int)24));		HX_STACK_VAR(tmp49,"tmp49");
											HX_STACK_LINE(232)
											int tmp50 = (int(destPixel) >> int((int)16));		HX_STACK_VAR(tmp50,"tmp50");
											HX_STACK_LINE(232)
											int tmp51 = tmp50;		HX_STACK_VAR(tmp51,"tmp51");
											HX_STACK_LINE(232)
											...
											int tmp55 = (int(tmp54) << int((int)16));		HX_STACK_VAR(tmp55,"tmp55");
											HX_STACK_LINE(232)
											int tmp56 = (int(tmp49) | int(tmp55));		HX_STACK_VAR(tmp56,"tmp56");
											HX_STACK_LINE(232)
									...
									HX_STACK_LINE(233)
									{
										...
										HX_STACK_LINE(233)
										{
											...
											::lime::utils::ArrayBufferView this1 = tmp44;		HX_STACK_VAR(this1,"this1");
											HX_STACK_LINE(233)
											Float tmp45 = (blendAlpha * ((Float)255.0));		HX_STACK_VAR(tmp45,"tmp45");
											HX_STACK_LINE(233)
											int tmp46 = ::Math_obj::round(tmp45);		HX_STACK_VAR(tmp46,"tmp46");
											HX_STACK_LINE(233)
											int idx = tmp46;		HX_STACK_VAR(idx,"idx");
										...
										HX_STACK_LINE(233)
										{
											...
											HX_STACK_LINE(233)
											int tmp64 = (int(value) & int((int)255));		HX_STACK_VAR(tmp64,"tmp64");
											HX_STACK_LINE(233)
								...
								HX_STACK_LINE(237)
								{
									...
									if ((tmp43)){
										...
										if ((tmp46)){
											HX_STACK_LINE(237)
											bool tmp47 = (destPixel != (int)0);		HX_STACK_VAR(tmp47,"tmp47");
											HX_STACK_LINE(237)
											if ((tmp47)){
												HX_STACK_LINE(237)
												destPixel = (int)0;
											...
											if ((tmp49)){
												...
												HX_STACK_LINE(237)
												{
													...
													HX_STACK_LINE(237)
													tmp50 = ::__hxcpp_memory_get_ui32(this1->buffer->b,(this1->byteOffset + (((int(destPixel) & int((int)255))) * (int)4)));
												}
												HX_STACK_LINE(237)
												...
												HX_STACK_LINE(237)
												{
													...
													HX_STACK_LINE(237)
													int tmp60 = (int(destPixel) >> int((int)16));		HX_STACK_VAR(tmp60,"tmp60");
													HX_STACK_LINE(237)
													int tmp61 = tmp60;		HX_STACK_VAR(tmp61,"tmp61");
													HX_STACK_LINE(237)
													int tmp62 = (int(tmp61) & int((int)255));		HX_STACK_VAR(tmp62,"tmp62");
													...
													HX_STACK_LINE(237)
													int tmp69 = (int(tmp59) | int(tmp68));		HX_STACK_VAR(tmp69,"tmp69");
													HX_STACK_LINE(237)
													int tmp70 = (int(destPixel) >> int((int)8));		HX_STACK_VAR(tmp70,"tmp70");
													HX_STACK_LINE(237)
													...
													HX_STACK_LINE(237)
													int tmp79 = (int(tmp69) | int(tmp78));		HX_STACK_VAR(tmp79,"tmp79");
													HX_STACK_LINE(237)
													int tmp80 = (int(destPixel) & int((int)255));		HX_STACK_VAR(tmp80,"tmp80");
													HX_STACK_LINE(237)
													int tmp81 = tmp80;		HX_STACK_VAR(tmp81,"tmp81");
													HX_STACK_LINE(237)
													int tmp82 = (int(tmp81) & int((int)255));		HX_STACK_VAR(tmp82,"tmp82");
													HX_STACK_LINE(237)
													int tmp83 = (int(tmp79) | int(tmp82));		HX_STACK_VAR(tmp83,"tmp83");
													HX_STACK_LINE(237)
													destPixel = tmp83;
												}
											}
									...
									HX_STACK_LINE(237)
									int tmp44 = destFormat;		HX_STACK_VAR(tmp44,"tmp44");
									HX_STACK_LINE(237)
									switch( (int)(tmp44)){
										case (int)2: {
											HX_STACK_LINE(237)
											...
											{
												HX_STACK_LINE(237)
												int tmp45 = (int(destPixel) >> int((int)24));		HX_STACK_VAR(tmp45,"tmp45");
												HX_STACK_LINE(237)
												int tmp46 = tmp45;		HX_STACK_VAR(tmp46,"tmp46");
												HX_STACK_LINE(237)
												int tmp47 = (int(tmp46) & int((int)255));		HX_STACK_VAR(tmp47,"tmp47");
								...
								while((true)){
									...
									HX_STACK_LINE(265)
									{
										...
										if ((tmp43)){
											...
											if ((tmp46)){
												HX_STACK_LINE(265)
												int tmp48 = (int(sourcePixel) & int((int)255));		HX_STACK_VAR(tmp48,"tmp48");
												HX_STACK_LINE(265)
												int tmp49 = tmp48;		HX_STACK_VAR(tmp49,"tmp49");
												HX_STACK_LINE(265)
												int tmp50 = tmp49;		HX_STACK_VAR(tmp50,"tmp50");
											...
											if ((tmp47)){
												...
												HX_STACK_LINE(265)
												{
													...
													HX_STACK_LINE(265)
													{
														...
														HX_STACK_LINE(265)
														int tmp54 = (int(sourcePixel) >> int((int)16));		HX_STACK_VAR(tmp54,"tmp54");
														HX_STACK_LINE(265)
													...
													HX_STACK_LINE(265)
													{
														...
														HX_STACK_LINE(265)
														int tmp55 = (int(sourcePixel) >> int((int)8));		HX_STACK_VAR(tmp55,"tmp55");
														HX_STACK_LINE(265)
														int tmp56 = tmp55;		HX_STACK_VAR(tmp56,"tmp56");
														HX_STACK_LINE(265)
														int tmp57 = (int(tmp56) & int((int)255));		HX_STACK_VAR(tmp57,"tmp57");
													...
													HX_STACK_LINE(265)
													int tmp62 = (int(sourcePixel) & int((int)255));		HX_STACK_VAR(tmp62,"tmp62");
													HX_STACK_LINE(265)
													int tmp63 = tmp62;		HX_STACK_VAR(tmp63,"tmp63");
													HX_STACK_LINE(265)
													int tmp64 = (int(tmp63) & int((int)255));		HX_STACK_VAR(tmp64,"tmp64");
											...
											if ((tmp47)){
												...
												HX_STACK_LINE(266)
												{
													...
													HX_STACK_LINE(266)
													{
														...
														::lime::utils::ArrayBufferView this1 = tmp54;		HX_STACK_VAR(this1,"this1");
														HX_STACK_LINE(266)
														int tmp55 = (int(destPixel) >> int((int)8));		HX_STACK_VAR(tmp55,"tmp55");
														HX_STACK_LINE(266)
														int tmp56 = tmp55;		HX_STACK_VAR(tmp56,"tmp56");
														HX_STACK_LINE(266)
														int tmp57 = (int(tmp56) & int((int)255));		HX_STACK_VAR(tmp57,"tmp57");
													...
													int tmp61 = (int(tmp58) | int(tmp60));		HX_STACK_VAR(tmp61,"tmp61");
													HX_STACK_LINE(266)
													int tmp62 = (int(destPixel) & int((int)255));		HX_STACK_VAR(tmp62,"tmp62");
													HX_STACK_LINE(266)
													int tmp63 = tmp62;		HX_STACK_VAR(tmp63,"tmp63");
													HX_STACK_LINE(266)
													int tmp64 = (int(tmp63) & int((int)255));		HX_STACK_VAR(tmp64,"tmp64");
									...
									HX_STACK_LINE(267)
									{
										...
										if ((tmp43)){
											...
											if ((tmp46)){
												HX_STACK_LINE(267)
												int tmp48 = (int(alphaPixel) & int((int)255));		HX_STACK_VAR(tmp48,"tmp48");
												HX_STACK_LINE(267)
												int tmp49 = tmp48;		HX_STACK_VAR(tmp49,"tmp49");
												HX_STACK_LINE(267)
												int tmp50 = tmp49;		HX_STACK_VAR(tmp50,"tmp50");
											...
											if ((tmp47)){
												...
												HX_STACK_LINE(267)
												{
													...
													HX_STACK_LINE(267)
													{
														...
														::lime::utils::ArrayBufferView this1 = tmp52;		HX_STACK_VAR(this1,"this1");
														HX_STACK_LINE(267)
														int tmp53 = (int(alphaPixel) >> int((int)24));		HX_STACK_VAR(tmp53,"tmp53");
														HX_STACK_LINE(267)
														int tmp54 = tmp53;		HX_STACK_VAR(tmp54,"tmp54");
														HX_STACK_LINE(267)
														int tmp55 = (int(tmp54) & int((int)255));		HX_STACK_VAR(tmp55,"tmp55");
													...
													HX_STACK_LINE(267)
													{
														...
														::lime::utils::ArrayBufferView this1 = tmp53;		HX_STACK_VAR(this1,"this1");
														HX_STACK_LINE(267)
														int tmp54 = (int(alphaPixel) >> int((int)16));		HX_STACK_VAR(tmp54,"tmp54");
														HX_STACK_LINE(267)
														int tmp55 = tmp54;		HX_STACK_VAR(tmp55,"tmp55");
														HX_STACK_LINE(267)
														int tmp56 = (int(tmp55) & int((int)255));		HX_STACK_VAR(tmp56,"tmp56");
													...
													HX_STACK_LINE(267)
													{
														...
														::lime::utils::ArrayBufferView this1 = tmp54;		HX_STACK_VAR(this1,"this1");
														HX_STACK_LINE(267)
														int tmp55 = (int(alphaPixel) >> int((int)8));		HX_STACK_VAR(tmp55,"tmp55");
														HX_STACK_LINE(267)
														int tmp56 = tmp55;		HX_STACK_VAR(tmp56,"tmp56");
														HX_STACK_LINE(267)
														int tmp57 = (int(tmp56) & int((int)255));		HX_STACK_VAR(tmp57,"tmp57");
													...
													int tmp61 = (int(tmp58) | int(tmp60));		HX_STACK_VAR(tmp61,"tmp61");
													HX_STACK_LINE(267)
													int tmp62 = (int(alphaPixel) & int((int)255));		HX_STACK_VAR(tmp62,"tmp62");
													HX_STACK_LINE(267)
													int tmp63 = tmp62;		HX_STACK_VAR(tmp63,"tmp63");
													HX_STACK_LINE(267)
													int tmp64 = (int(tmp63) & int((int)255));		HX_STACK_VAR(tmp64,"tmp64");
									...
									destAlpha = tmp47;
									HX_STACK_LINE(271)
									Float tmp48 = ((int)1 - sourceAlpha);		HX_STACK_VAR(tmp48,"tmp48");
									HX_STACK_LINE(271)
									oneMinusSourceAlpha = tmp48;
									HX_STACK_LINE(272)
									Float tmp49 = sourceAlpha;		HX_STACK_VAR(tmp49,"tmp49");
									HX_STACK_LINE(272)
									Float tmp50 = (destAlpha * oneMinusSourceAlpha);		HX_STACK_VAR(tmp50,"tmp50");
									HX_STACK_LINE(272)
									Float tmp51 = (tmp49 + tmp50);		HX_STACK_VAR(tmp51,"tmp51");
									HX_STACK_LINE(272)
									blendAlpha = tmp51;
									HX_STACK_LINE(274)
									bool tmp52 = (blendAlpha == (int)0);		HX_STACK_VAR(tmp52,"tmp52");
									HX_STACK_LINE(274)
									if ((tmp52)){
										HX_STACK_LINE(276)
										destPixel = (int)0;
										...
										HX_STACK_LINE(280)
										{
											...
											HX_STACK_LINE(280)
											{
												...
												::lime::utils::ArrayBufferView this1 = tmp54;		HX_STACK_VAR(this1,"this1");
												HX_STACK_LINE(280)
												int tmp55 = (int(sourcePixel) >> int((int)24));		HX_STACK_VAR(tmp55,"tmp55");
												HX_STACK_LINE(280)
												int tmp56 = tmp55;		HX_STACK_VAR(tmp56,"tmp56");
												HX_STACK_LINE(280)
												int tmp57 = (int(tmp56) & int((int)255));		HX_STACK_VAR(tmp57,"tmp57");
												...
												int tmp58 = tmp57;		HX_STACK_VAR(tmp58,"tmp58");
												HX_STACK_LINE(280)
												Float tmp59 = sourceAlpha;		HX_STACK_VAR(tmp59,"tmp59");
												HX_STACK_LINE(280)
												Float tmp60 = (tmp58 * tmp59);		HX_STACK_VAR(tmp60,"tmp60");
												HX_STACK_LINE(280)
												int tmp61 = (int(destPixel) >> int((int)24));		HX_STACK_VAR(tmp61,"tmp61");
												HX_STACK_LINE(280)
												...
												int tmp64 = tmp63;		HX_STACK_VAR(tmp64,"tmp64");
												HX_STACK_LINE(280)
												Float tmp65 = destAlpha;		HX_STACK_VAR(tmp65,"tmp65");
												HX_STACK_LINE(280)
												Float tmp66 = (tmp64 * tmp65);		HX_STACK_VAR(tmp66,"tmp66");
												HX_STACK_LINE(280)
												Float tmp67 = oneMinusSourceAlpha;		HX_STACK_VAR(tmp67,"tmp67");
												HX_STACK_LINE(280)
												Float tmp68 = (tmp66 * tmp67);		HX_STACK_VAR(tmp68,"tmp68");
												HX_STACK_LINE(280)
												Float tmp69 = (tmp60 + tmp68);		HX_STACK_VAR(tmp69,"tmp69");
												HX_STACK_LINE(280)
												Float tmp70 = blendAlpha;		HX_STACK_VAR(tmp70,"tmp70");
												HX_STACK_LINE(280)
												Float tmp71 = (Float(tmp69) / Float(tmp70));		HX_STACK_VAR(tmp71,"tmp71");
												HX_STACK_LINE(280)
												int tmp72 = ::Math_obj::round(tmp71);		HX_STACK_VAR(tmp72,"tmp72");
												HX_STACK_LINE(280)
												int idx = tmp72;		HX_STACK_VAR(idx,"idx");
												HX_STACK_LINE(280)
												int tmp73 = ::__hxcpp_memory_get_byte(this1->buffer->b,(this1->byteOffset + idx));		HX_STACK_VAR(tmp73,"tmp73");
												HX_STACK_LINE(280)
												tmp53 = (int(tmp73) & int((int)255));
											}
											HX_STACK_LINE(280)
											int value = tmp53;		HX_STACK_VAR(value,"value");
											HX_STACK_LINE(280)
											{
												HX_STACK_LINE(280)
												int tmp54 = (int(value) & int((int)255));		HX_STACK_VAR(tmp54,"tmp54");
												HX_STACK_LINE(280)
												int tmp55 = (int(tmp54) << int((int)24));		HX_STACK_VAR(tmp55,"tmp55");
												HX_STACK_LINE(280)
												...
												HX_STACK_LINE(280)
												int tmp62 = (int(tmp55) | int(tmp61));		HX_STACK_VAR(tmp62,"tmp62");
												HX_STACK_LINE(280)
												...
												int tmp72 = (int(tmp71) & int((int)255));		HX_STACK_VAR(tmp72,"tmp72");
												HX_STACK_LINE(280)
												int tmp73 = (int(tmp69) | int(tmp72));		HX_STACK_VAR(tmp73,"tmp73");
												HX_STACK_LINE(280)
												destPixel = tmp73;
											}
											HX_STACK_LINE(280)
										...
										HX_STACK_LINE(281)
										{
											...
											HX_STACK_LINE(281)
											{
												...
												::lime::utils::ArrayBufferView this1 = tmp54;		HX_STACK_VAR(this1,"this1");
												HX_STACK_LINE(281)
												int tmp55 = (int(sourcePixel) >> int((int)16));		HX_STACK_VAR(tmp55,"tmp55");
												HX_STACK_LINE(281)
												int tmp56 = tmp55;		HX_STACK_VAR(tmp56,"tmp56");
												HX_STACK_LINE(281)
												int tmp57 = (int(tmp56) & int((int)255));		HX_STACK_VAR(tmp57,"tmp57");
												...
												Float tmp60 = (tmp58 * tmp59);		HX_STACK_VAR(tmp60,"tmp60");
												HX_STACK_LINE(281)
												int tmp61 = (int(destPixel) >> int((int)16));		HX_STACK_VAR(tmp61,"tmp61");
												HX_STACK_LINE(281)
												int tmp62 = tmp61;		HX_STACK_VAR(tmp62,"tmp62");
												HX_STACK_LINE(281)
												int tmp63 = (int(tmp62) & int((int)255));		HX_STACK_VAR(tmp63,"tmp63");
											...
											{
												HX_STACK_LINE(281)
												int tmp54 = (int(destPixel) >> int((int)24));		HX_STACK_VAR(tmp54,"tmp54");
												HX_STACK_LINE(281)
												int tmp55 = tmp54;		HX_STACK_VAR(tmp55,"tmp55");
												HX_STACK_LINE(281)
												int tmp56 = (int(tmp55) & int((int)255));		HX_STACK_VAR(tmp56,"tmp56");
												...
												int tmp59 = (int(tmp58) << int((int)24));		HX_STACK_VAR(tmp59,"tmp59");
												HX_STACK_LINE(281)
												int tmp60 = (int(value) & int((int)255));		HX_STACK_VAR(tmp60,"tmp60");
												HX_STACK_LINE(281)
												int tmp61 = (int(tmp60) << int((int)16));		HX_STACK_VAR(tmp61,"tmp61");
												HX_STACK_LINE(281)
										...
										HX_STACK_LINE(282)
										{
											...
											HX_STACK_LINE(282)
											{
												...
												int tmp64 = (int(tmp63) & int((int)255));		HX_STACK_VAR(tmp64,"tmp64");
												HX_STACK_LINE(282)
												int tmp65 = (int(tmp64) << int((int)16));		HX_STACK_VAR(tmp65,"tmp65");
												HX_STACK_LINE(282)
												int tmp66 = (int(tmp59) | int(tmp65));		HX_STACK_VAR(tmp66,"tmp66");
												HX_STACK_LINE(282)
												int tmp67 = (int(value) & int((int)255));		HX_STACK_VAR(tmp67,"tmp67");
												HX_STACK_LINE(282)
												int tmp68 = (int(tmp67) << int((int)8));		HX_STACK_VAR(tmp68,"tmp68");
												HX_STACK_LINE(282)
										...
										HX_STACK_LINE(283)
										{
											...
											HX_STACK_LINE(283)
											{
												...
												::lime::utils::ArrayBufferView this1 = tmp54;		HX_STACK_VAR(this1,"this1");
												HX_STACK_LINE(283)
												Float tmp55 = (blendAlpha * ((Float)255.0));		HX_STACK_VAR(tmp55,"tmp55");
												HX_STACK_LINE(283)
											...
											HX_STACK_LINE(283)
											{
												...
												int tmp66 = (int(tmp59) | int(tmp65));		HX_STACK_VAR(tmp66,"tmp66");
												HX_STACK_LINE(283)
												int tmp67 = (int(destPixel) >> int((int)8));		HX_STACK_VAR(tmp67,"tmp67");
												HX_STACK_LINE(283)
												int tmp68 = tmp67;		HX_STACK_VAR(tmp68,"tmp68");
												HX_STACK_LINE(283)
												int tmp69 = (int(tmp68) & int((int)255));		HX_STACK_VAR(tmp69,"tmp69");
												...
												HX_STACK_LINE(283)
												int tmp74 = (int(value) & int((int)255));		HX_STACK_VAR(tmp74,"tmp74");
												HX_STACK_LINE(283)
												int tmp75 = (int(tmp73) | int(tmp74));		HX_STACK_VAR(tmp75,"tmp75");
												HX_STACK_LINE(283)
												destPixel = tmp75;
											}
											HX_STACK_LINE(283)
									...
									{
										HX_STACK_LINE(287)
										bool tmp53 = destPremultiplied;		HX_STACK_VAR(tmp53,"tmp53");
										HX_STACK_LINE(287)
										if ((tmp53)){
											HX_STACK_LINE(287)
											...
											if ((tmp56)){
												HX_STACK_LINE(287)
												bool tmp57 = (destPixel != (int)0);		HX_STACK_VAR(tmp57,"tmp57");
												HX_STACK_LINE(287)
												if ((tmp57)){
													HX_STACK_LINE(287)
													destPixel = (int)0;
												...
												int tmp58 = tmp57;		HX_STACK_VAR(tmp58,"tmp58");
												HX_STACK_LINE(287)
												bool tmp59 = (tmp58 != (int)255);		HX_STACK_VAR(tmp59,"tmp59");
												HX_STACK_LINE(287)
												if ((tmp59)){
													HX_STACK_LINE(287)
													...
													{
														HX_STACK_LINE(287)
														::lime::utils::ArrayBufferView tmp61 = ::lime::math::color::_RGBA::RGBA_Impl__obj::__alpha16;		HX_STACK_VAR(tmp61,"tmp61");
														HX_STACK_LINE(287)
														::lime::utils::ArrayBufferView this1 = tmp61;		HX_STACK_VAR(this1,"this1");
														HX_STACK_LINE(287)
														tmp60 = ::__hxcpp_memory_get_ui32(this1->buffer->b,(this1->byteOffset + (((int(destPixel) & int((int)255))) * (int)4)));
													}
													HX_STACK_LINE(287)
													::lime::math::color::_RGBA::RGBA_Impl__obj::a16 = tmp60;
													HX_STACK_LINE(287)
													{
														HX_STACK_LINE(287)
														int tmp61 = (int(destPixel) >> int((int)24));		HX_STACK_VAR(tmp61,"tmp61");
														...
														HX_STACK_LINE(287)
														int tmp69 = (int(tmp68) << int((int)24));		HX_STACK_VAR(tmp69,"tmp69");
														HX_STACK_LINE(287)
														int tmp70 = (int(destPixel) >> int((int)16));		HX_STACK_VAR(tmp70,"tmp70");
														HX_STACK_LINE(287)
														int tmp71 = tmp70;		HX_STACK_VAR(tmp71,"tmp71");
														HX_STACK_LINE(287)
														int tmp72 = (int(tmp71) & int((int)255));		HX_STACK_VAR(tmp72,"tmp72");
														...
														int tmp77 = (int(tmp76) & int((int)255));		HX_STACK_VAR(tmp77,"tmp77");
														HX_STACK_LINE(287)
														int tmp78 = (int(tmp77) << int((int)16));		HX_STACK_VAR(tmp78,"tmp78");
														HX_STACK_LINE(287)
														int tmp79 = (int(tmp69) | int(tmp78));		HX_STACK_VAR(tmp79,"tmp79");
														HX_STACK_LINE(287)
														int tmp80 = (int(destPixel) >> int((int)8));		HX_STACK_VAR(tmp80,"tmp80");
														HX_STACK_LINE(287)
														int tmp81 = tmp80;		HX_STACK_VAR(tmp81,"tmp81");
														HX_STACK_LINE(287)
														int tmp82 = (int(tmp81) & int((int)255));		HX_STACK_VAR(tmp82,"tmp82");
														...
														HX_STACK_LINE(287)
														int tmp84 = ::lime::math::color::_RGBA::RGBA_Impl__obj::a16;		HX_STACK_VAR(tmp84,"tmp84");
														HX_STACK_LINE(287)
														int tmp85 = (tmp83 * tmp84);		HX_STACK_VAR(tmp85,"tmp85");
														HX_STACK_LINE(287)
														int tmp86 = (int(tmp85) >> int((int)16));		HX_STACK_VAR(tmp86,"tmp86");
														HX_STACK_LINE(287)
														int tmp87 = (int(tmp86) & int((int)255));		HX_STACK_VAR(tmp87,"tmp87");
														HX_STACK_LINE(287)
														int tmp88 = (int(tmp87) << int((int)8));		HX_STACK_VAR(tmp88,"tmp88");
														HX_STACK_LINE(287)
														int tmp89 = (int(tmp79) | int(tmp88));		HX_STACK_VAR(tmp89,"tmp89");
														HX_STACK_LINE(287)
														int tmp90 = (int(destPixel) & int((int)255));		HX_STACK_VAR(tmp90,"tmp90");
														HX_STACK_LINE(287)
														int tmp91 = tmp90;		HX_STACK_VAR(tmp91,"tmp91");
														HX_STACK_LINE(287)
														int tmp92 = (int(tmp91) & int((int)255));		HX_STACK_VAR(tmp92,"tmp92");
														HX_STACK_LINE(287)
														int tmp93 = (int(tmp89) | int(tmp92));		HX_STACK_VAR(tmp93,"tmp93");
														HX_STACK_LINE(287)
														destPixel = tmp93;
													}
												}
										...
										HX_STACK_LINE(287)
										int tmp54 = destFormat;		HX_STACK_VAR(tmp54,"tmp54");
										HX_STACK_LINE(287)
										switch( (int)(tmp54)){
											case (int)2: {
												HX_STACK_LINE(287)
												...
												{
													HX_STACK_LINE(287)
													int tmp55 = (int(destPixel) >> int((int)24));		HX_STACK_VAR(tmp55,"tmp55");
													HX_STACK_LINE(287)
													int tmp56 = tmp55;		HX_STACK_VAR(tmp56,"tmp56");
													HX_STACK_LINE(287)
													int tmp57 = (int(tmp56) & int((int)255));		HX_STACK_VAR(tmp57,"tmp57");
												...
												HX_STACK_LINE(287)
												{
													...
													HX_STACK_LINE(287)
													int val = tmp55;		HX_STACK_VAR(val,"val");
													HX_STACK_LINE(287)
													::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + ((destPosition + (int)3))),val);
													HX_STACK_LINE(287)
													val;
...
Void ImageDataUtil_obj::fillRect( ::lime::graphics::Image image,::lime::math::Rectangle rect,int color,int format){
{
				...
				HX_STACK_LINE(314)
				{
					...
					HX_STACK_LINE(314)
					{
						...
						HX_STACK_LINE(314)
						{
							...
							HX_STACK_LINE(314)
							int tmp15 = (int(tmp8) | int(tmp14));		HX_STACK_VAR(tmp15,"tmp15");
							HX_STACK_LINE(314)
							int tmp16 = (int(argb) & int((int)255));		HX_STACK_VAR(tmp16,"tmp16");
							HX_STACK_LINE(314)
							...
							HX_STACK_LINE(314)
							int tmp21 = (int(argb) >> int((int)24));		HX_STACK_VAR(tmp21,"tmp21");
							HX_STACK_LINE(314)
							...
							HX_STACK_LINE(314)
							int tmp26 = (int(tmp20) | int(tmp25));		HX_STACK_VAR(tmp26,"tmp26");
							HX_STACK_LINE(314)
							rgba = tmp26;
						}
						HX_STACK_LINE(314)
				...
				HX_STACK_LINE(315)
				{
					...
					HX_STACK_LINE(315)
					{
						...
						HX_STACK_LINE(315)
						{
							...
							int tmp15 = (int(tmp8) | int(tmp14));		HX_STACK_VAR(tmp15,"tmp15");
							HX_STACK_LINE(315)
							int tmp16 = (int(bgra) >> int((int)24));		HX_STACK_VAR(tmp16,"tmp16");
							HX_STACK_LINE(315)
							int tmp17 = tmp16;		HX_STACK_VAR(tmp17,"tmp17");
							HX_STACK_LINE(315)
							int tmp18 = (int(tmp17) & int((int)255));		HX_STACK_VAR(tmp18,"tmp18");
							...
							HX_STACK_LINE(315)
							int tmp23 = (int(bgra) & int((int)255));		HX_STACK_VAR(tmp23,"tmp23");
							HX_STACK_LINE(315)
							int tmp24 = tmp23;		HX_STACK_VAR(tmp24,"tmp24");
							HX_STACK_LINE(315)
							int tmp25 = (int(tmp24) & int((int)255));		HX_STACK_VAR(tmp25,"tmp25");
		...
		if ((tmp2)){
			HX_STACK_LINE(322)
			{
				...
				int tmp15 = (int(tmp8) | int(tmp14));		HX_STACK_VAR(tmp15,"tmp15");
				HX_STACK_LINE(322)
				int tmp16 = (int(fillColor) >> int((int)8));		HX_STACK_VAR(tmp16,"tmp16");
				HX_STACK_LINE(322)
				int tmp17 = tmp16;		HX_STACK_VAR(tmp17,"tmp17");
				HX_STACK_LINE(322)
				int tmp18 = (int(tmp17) & int((int)255));		HX_STACK_VAR(tmp18,"tmp18");
			...
			if ((tmp8)){
				...
				if ((tmp11)){
					...
					if ((tmp14)){
						...
						{
							HX_STACK_LINE(336)
							int tmp16 = (int(fillColor) >> int((int)24));		HX_STACK_VAR(tmp16,"tmp16");
							HX_STACK_LINE(336)
							int tmp17 = tmp16;		HX_STACK_VAR(tmp17,"tmp17");
							HX_STACK_LINE(336)
							int tmp18 = (int(tmp17) & int((int)255));		HX_STACK_VAR(tmp18,"tmp18");
							...
							HX_STACK_LINE(336)
							int tmp25 = (int(fillColor) >> int((int)16));		HX_STACK_VAR(tmp25,"tmp25");
							HX_STACK_LINE(336)
							...
							HX_STACK_LINE(336)
							int tmp34 = (int(tmp24) | int(tmp33));		HX_STACK_VAR(tmp34,"tmp34");
							HX_STACK_LINE(336)
							int tmp35 = (int(fillColor) >> int((int)8));		HX_STACK_VAR(tmp35,"tmp35");
							HX_STACK_LINE(336)
							int tmp36 = tmp35;		HX_STACK_VAR(tmp36,"tmp36");
							HX_STACK_LINE(336)
							...
							int tmp43 = (int(tmp42) << int((int)8));		HX_STACK_VAR(tmp43,"tmp43");
							HX_STACK_LINE(336)
							int tmp44 = (int(tmp34) | int(tmp43));		HX_STACK_VAR(tmp44,"tmp44");
							HX_STACK_LINE(336)
...
Void ImageDataUtil_obj::floodFill( ::lime::graphics::Image image,int x,int y,int color,int format){
{
		...
		if ((tmp3)){
			...
			HX_STACK_LINE(379)
			{
				...
				if ((tmp14)){
					...
					if ((tmp18)){
						...
						int tmp20 = tmp19;		HX_STACK_VAR(tmp20,"tmp20");
						HX_STACK_LINE(379)
						Float tmp21 = (Float(((Float)255.0)) / Float(tmp20));		HX_STACK_VAR(tmp21,"tmp21");
						HX_STACK_LINE(379)
						...
						HX_STACK_LINE(379)
						{
							...
							HX_STACK_LINE(379)
							{
								...
								HX_STACK_LINE(379)
								int tmp24 = (int(hitColor) >> int((int)24));		HX_STACK_VAR(tmp24,"tmp24");
								HX_STACK_LINE(379)
							...
							HX_STACK_LINE(379)
							{
								...
								HX_STACK_LINE(379)
								int tmp25 = (int(hitColor) >> int((int)16));		HX_STACK_VAR(tmp25,"tmp25");
								HX_STACK_LINE(379)
								int tmp26 = tmp25;		HX_STACK_VAR(tmp26,"tmp26");
								HX_STACK_LINE(379)
								int tmp27 = (int(tmp26) & int((int)255));		HX_STACK_VAR(tmp27,"tmp27");
							...
							HX_STACK_LINE(379)
							{
								...
								HX_STACK_LINE(379)
								int tmp26 = (int(hitColor) >> int((int)8));		HX_STACK_VAR(tmp26,"tmp26");
								HX_STACK_LINE(379)
								int tmp27 = tmp26;		HX_STACK_VAR(tmp27,"tmp27");
								HX_STACK_LINE(379)
								...
								int tmp29 = tmp28;		HX_STACK_VAR(tmp29,"tmp29");
								HX_STACK_LINE(379)
								Float tmp30 = ::lime::math::color::_RGBA::RGBA_Impl__obj::unmult;		HX_STACK_VAR(tmp30,"tmp30");
								HX_STACK_LINE(379)
								...
								HX_STACK_LINE(379)
								int tmp33 = ::__hxcpp_memory_get_byte(this1->buffer->b,(this1->byteOffset + idx));		HX_STACK_VAR(tmp33,"tmp33");
								HX_STACK_LINE(379)
							...
							HX_STACK_LINE(379)
							int tmp33 = (int(hitColor) & int((int)255));		HX_STACK_VAR(tmp33,"tmp33");
							HX_STACK_LINE(379)
							int tmp34 = tmp33;		HX_STACK_VAR(tmp34,"tmp34");
							HX_STACK_LINE(379)
							int tmp35 = (int(tmp34) & int((int)255));		HX_STACK_VAR(tmp35,"tmp35");
			...
			if ((tmp7)){
				HX_STACK_LINE(383)
				{
					HX_STACK_LINE(383)
					{
						...
						HX_STACK_LINE(383)
						int tmp14 = (int(fillColor) >> int((int)16));		HX_STACK_VAR(tmp14,"tmp14");
						HX_STACK_LINE(383)
						...
						HX_STACK_LINE(383)
						int tmp20 = (int(tmp13) | int(tmp19));		HX_STACK_VAR(tmp20,"tmp20");
						HX_STACK_LINE(383)
						int tmp21 = (int(fillColor) >> int((int)8));		HX_STACK_VAR(tmp21,"tmp21");
						HX_STACK_LINE(383)
						int tmp22 = tmp21;		HX_STACK_VAR(tmp22,"tmp22");
						HX_STACK_LINE(383)
						int tmp23 = (int(tmp22) & int((int)255));		HX_STACK_VAR(tmp23,"tmp23");
						...
						HX_STACK_LINE(383)
						int tmp28 = (int)255;		HX_STACK_VAR(tmp28,"tmp28");
						HX_STACK_LINE(383)
				...
				HX_STACK_LINE(384)
				{
					HX_STACK_LINE(384)
					{
						...
						int tmp13 = (int(tmp12) << int((int)24));		HX_STACK_VAR(tmp13,"tmp13");
						HX_STACK_LINE(384)
						int tmp14 = (int(hitColor) >> int((int)16));		HX_STACK_VAR(tmp14,"tmp14");
						HX_STACK_LINE(384)
						int tmp15 = tmp14;		HX_STACK_VAR(tmp15,"tmp15");
						HX_STACK_LINE(384)
						int tmp16 = (int(tmp15) & int((int)255));		HX_STACK_VAR(tmp16,"tmp16");
						...
						int tmp20 = (int(tmp13) | int(tmp19));		HX_STACK_VAR(tmp20,"tmp20");
						HX_STACK_LINE(384)
						int tmp21 = (int(hitColor) >> int((int)8));		HX_STACK_VAR(tmp21,"tmp21");
						HX_STACK_LINE(384)
						int tmp22 = tmp21;		HX_STACK_VAR(tmp22,"tmp22");
						HX_STACK_LINE(384)
						int tmp23 = (int(tmp22) & int((int)255));		HX_STACK_VAR(tmp23,"tmp23");
			...
			if ((tmp9)){
				...
				if ((tmp12)){
					HX_STACK_LINE(390)
					bool tmp13 = (fillColor != (int)0);		HX_STACK_VAR(tmp13,"tmp13");
					HX_STACK_LINE(390)
					if ((tmp13)){
						HX_STACK_LINE(390)
						fillColor = (int)0;
					...
					HX_STACK_LINE(390)
					int tmp13 = (int(fillColor) & int((int)255));		HX_STACK_VAR(tmp13,"tmp13");
					HX_STACK_LINE(390)
					...
					if ((tmp15)){
						...
						{
							HX_STACK_LINE(390)
							int tmp17 = (int(fillColor) >> int((int)24));		HX_STACK_VAR(tmp17,"tmp17");
							HX_STACK_LINE(390)
							...
							HX_STACK_LINE(390)
							int tmp26 = (int(fillColor) >> int((int)16));		HX_STACK_VAR(tmp26,"tmp26");
							HX_STACK_LINE(390)
							int tmp27 = tmp26;		HX_STACK_VAR(tmp27,"tmp27");
							HX_STACK_LINE(390)
							int tmp28 = (int(tmp27) & int((int)255));		HX_STACK_VAR(tmp28,"tmp28");
							...
							HX_STACK_LINE(390)
							int tmp35 = (int(tmp25) | int(tmp34));		HX_STACK_VAR(tmp35,"tmp35");
							HX_STACK_LINE(390)
							int tmp36 = (int(fillColor) >> int((int)8));		HX_STACK_VAR(tmp36,"tmp36");
							HX_STACK_LINE(390)
							int tmp37 = tmp36;		HX_STACK_VAR(tmp37,"tmp37");
							HX_STACK_LINE(390)
							int tmp38 = (int(tmp37) & int((int)255));		HX_STACK_VAR(tmp38,"tmp38");
							...
							int tmp44 = (int(tmp43) << int((int)8));		HX_STACK_VAR(tmp44,"tmp44");
							HX_STACK_LINE(390)
							int tmp45 = (int(tmp35) | int(tmp44));		HX_STACK_VAR(tmp45,"tmp45");
							HX_STACK_LINE(390)
					...
					while((true)){
						...
						HX_STACK_LINE(423)
						{
							...
							if ((tmp45)){
								...
								if ((tmp48)){
									HX_STACK_LINE(423)
									int tmp50 = (int(readColor) & int((int)255));		HX_STACK_VAR(tmp50,"tmp50");
									HX_STACK_LINE(423)
									int tmp51 = tmp50;		HX_STACK_VAR(tmp51,"tmp51");
									HX_STACK_LINE(423)
									int tmp52 = tmp51;		HX_STACK_VAR(tmp52,"tmp52");
								...
								if ((tmp49)){
									...
									int tmp51 = tmp50;		HX_STACK_VAR(tmp51,"tmp51");
									HX_STACK_LINE(423)
									Float tmp52 = (Float(((Float)255.0)) / Float(tmp51));		HX_STACK_VAR(tmp52,"tmp52");
									HX_STACK_LINE(423)
									...
									HX_STACK_LINE(423)
									{
										...
										HX_STACK_LINE(423)
										{
											...
											::lime::utils::ArrayBufferView this1 = tmp54;		HX_STACK_VAR(this1,"this1");
											HX_STACK_LINE(423)
											int tmp55 = (int(readColor) >> int((int)24));		HX_STACK_VAR(tmp55,"tmp55");
											HX_STACK_LINE(423)
											int tmp56 = tmp55;		HX_STACK_VAR(tmp56,"tmp56");
											HX_STACK_LINE(423)
											int tmp57 = (int(tmp56) & int((int)255));		HX_STACK_VAR(tmp57,"tmp57");
										...
										HX_STACK_LINE(423)
										{
											...
											HX_STACK_LINE(423)
											int tmp56 = (int(readColor) >> int((int)16));		HX_STACK_VAR(tmp56,"tmp56");
											HX_STACK_LINE(423)
											int tmp57 = tmp56;		HX_STACK_VAR(tmp57,"tmp57");
											HX_STACK_LINE(423)
											int tmp58 = (int(tmp57) & int((int)255));		HX_STACK_VAR(tmp58,"tmp58");
										...
										HX_STACK_LINE(423)
										{
											...
											HX_STACK_LINE(423)
											int tmp57 = (int(readColor) >> int((int)8));		HX_STACK_VAR(tmp57,"tmp57");
											HX_STACK_LINE(423)
											int tmp58 = tmp57;		HX_STACK_VAR(tmp58,"tmp58");
											HX_STACK_LINE(423)
											int tmp59 = (int(tmp58) & int((int)255));		HX_STACK_VAR(tmp59,"tmp59");
											...
											int tmp60 = tmp59;		HX_STACK_VAR(tmp60,"tmp60");
											HX_STACK_LINE(423)
											Float tmp61 = ::lime::math::color::_RGBA::RGBA_Impl__obj::unmult;		HX_STACK_VAR(tmp61,"tmp61");
											HX_STACK_LINE(423)
											Float tmp62 = (tmp60 * tmp61);		HX_STACK_VAR(tmp62,"tmp62");
											HX_STACK_LINE(423)
											int tmp63 = ::Math_obj::round(tmp62);		HX_STACK_VAR(tmp63,"tmp63");
											HX_STACK_LINE(423)
											int idx = tmp63;		HX_STACK_VAR(idx,"idx");
											HX_STACK_LINE(423)
											int tmp64 = ::__hxcpp_memory_get_byte(this1->buffer->b,(this1->byteOffset + idx));		HX_STACK_VAR(tmp64,"tmp64");
											HX_STACK_LINE(423)
											tmp55 = (int(tmp64) & int((int)255));
										}
										HX_STACK_LINE(423)
										int b = tmp55;		HX_STACK_VAR(b,"b");
										HX_STACK_LINE(423)
										int tmp56 = (int(r) & int((int)255));		HX_STACK_VAR(tmp56,"tmp56");
										HX_STACK_LINE(423)
										int tmp57 = (int(tmp56) << int((int)24));		HX_STACK_VAR(tmp57,"tmp57");
										HX_STACK_LINE(423)
										int tmp58 = (int(g) & int((int)255));		HX_STACK_VAR(tmp58,"tmp58");
										HX_STACK_LINE(423)
										int tmp59 = (int(tmp58) << int((int)16));		HX_STACK_VAR(tmp59,"tmp59");
										HX_STACK_LINE(423)
										int tmp60 = (int(tmp57) | int(tmp59));		HX_STACK_VAR(tmp60,"tmp60");
										HX_STACK_LINE(423)
										int tmp61 = (int(b) & int((int)255));		HX_STACK_VAR(tmp61,"tmp61");
										HX_STACK_LINE(423)
										int tmp62 = (int(tmp61) << int((int)8));		HX_STACK_VAR(tmp62,"tmp62");
										HX_STACK_LINE(423)
										int tmp63 = (int(tmp60) | int(tmp62));		HX_STACK_VAR(tmp63,"tmp63");
										HX_STACK_LINE(423)
										int tmp64 = (int(readColor) & int((int)255));		HX_STACK_VAR(tmp64,"tmp64");
										HX_STACK_LINE(423)
										int tmp65 = tmp64;		HX_STACK_VAR(tmp65,"tmp65");
										HX_STACK_LINE(423)
										int tmp66 = (int(tmp65) & int((int)255));		HX_STACK_VAR(tmp66,"tmp66");
										HX_STACK_LINE(423)
										int tmp67 = (int(tmp63) | int(tmp66));		HX_STACK_VAR(tmp67,"tmp67");
										HX_STACK_LINE(423)
										readColor = tmp67;
									}
								}
				...
				HX_STACK_LINE(459)
				{
					...
					HX_STACK_LINE(459)
					{
						...
						HX_STACK_LINE(459)
						{
							...
							HX_STACK_LINE(459)
							int tmp11 = (int(argb) >> int((int)8));		HX_STACK_VAR(tmp11,"tmp11");
							HX_STACK_LINE(459)
							int tmp12 = tmp11;		HX_STACK_VAR(tmp12,"tmp12");
							HX_STACK_LINE(459)
							int tmp13 = (int(tmp12) & int((int)255));		HX_STACK_VAR(tmp13,"tmp13");
							...
							HX_STACK_LINE(459)
							int tmp18 = (int(argb) & int((int)255));		HX_STACK_VAR(tmp18,"tmp18");
							HX_STACK_LINE(459)
							int tmp19 = tmp18;		HX_STACK_VAR(tmp19,"tmp19");
							HX_STACK_LINE(459)
							int tmp20 = (int(tmp19) & int((int)255));		HX_STACK_VAR(tmp20,"tmp20");
							...
							HX_STACK_LINE(459)
							int tmp23 = (int(argb) >> int((int)24));		HX_STACK_VAR(tmp23,"tmp23");
							HX_STACK_LINE(459)
							int tmp24 = tmp23;		HX_STACK_VAR(tmp24,"tmp24");
							HX_STACK_LINE(459)
							int tmp25 = (int(tmp24) & int((int)255));		HX_STACK_VAR(tmp25,"tmp25");
							...
							int tmp27 = (int(tmp26) & int((int)255));		HX_STACK_VAR(tmp27,"tmp27");
							HX_STACK_LINE(459)
							int tmp28 = (int(tmp22) | int(tmp27));		HX_STACK_VAR(tmp28,"tmp28");
							HX_STACK_LINE(459)
							rgba = tmp28;
						}
						HX_STACK_LINE(459)
				...
				HX_STACK_LINE(460)
				{
					...
					HX_STACK_LINE(460)
					{
						...
						HX_STACK_LINE(460)
						{
							...
							HX_STACK_LINE(460)
							int tmp12 = (int(argb) >> int((int)8));		HX_STACK_VAR(tmp12,"tmp12");
							HX_STACK_LINE(460)
							int tmp13 = tmp12;		HX_STACK_VAR(tmp13,"tmp13");
							HX_STACK_LINE(460)
							...
							HX_STACK_LINE(460)
							int tmp18 = (int(tmp11) | int(tmp17));		HX_STACK_VAR(tmp18,"tmp18");
							HX_STACK_LINE(460)
							int tmp19 = (int(argb) & int((int)255));		HX_STACK_VAR(tmp19,"tmp19");
							HX_STACK_LINE(460)
							int tmp20 = tmp19;		HX_STACK_VAR(tmp20,"tmp20");
							HX_STACK_LINE(460)
							...
							HX_STACK_LINE(460)
							int tmp24 = (int(argb) >> int((int)24));		HX_STACK_VAR(tmp24,"tmp24");
							HX_STACK_LINE(460)
							int tmp25 = tmp24;		HX_STACK_VAR(tmp25,"tmp25");
							HX_STACK_LINE(460)
							int tmp26 = (int(tmp25) & int((int)255));		HX_STACK_VAR(tmp26,"tmp26");
				...
				HX_STACK_LINE(464)
				{
					...
					HX_STACK_LINE(464)
					{
						...
						HX_STACK_LINE(464)
						{
							...
							int tmp10 = (int(tmp9) << int((int)24));		HX_STACK_VAR(tmp10,"tmp10");
							HX_STACK_LINE(464)
							int tmp11 = (int(bgra) >> int((int)16));		HX_STACK_VAR(tmp11,"tmp11");
							HX_STACK_LINE(464)
							int tmp12 = tmp11;		HX_STACK_VAR(tmp12,"tmp12");
							HX_STACK_LINE(464)
							int tmp13 = (int(tmp12) & int((int)255));		HX_STACK_VAR(tmp13,"tmp13");
							...
							int tmp17 = (int(tmp10) | int(tmp16));		HX_STACK_VAR(tmp17,"tmp17");
							HX_STACK_LINE(464)
							int tmp18 = (int(bgra) >> int((int)24));		HX_STACK_VAR(tmp18,"tmp18");
							HX_STACK_LINE(464)
							int tmp19 = tmp18;		HX_STACK_VAR(tmp19,"tmp19");
							HX_STACK_LINE(464)
							int tmp20 = (int(tmp19) & int((int)255));		HX_STACK_VAR(tmp20,"tmp20");
							...
							HX_STACK_LINE(464)
							int tmp25 = (int(bgra) & int((int)255));		HX_STACK_VAR(tmp25,"tmp25");
							HX_STACK_LINE(464)
							int tmp26 = tmp25;		HX_STACK_VAR(tmp26,"tmp26");
							HX_STACK_LINE(464)
							int tmp27 = (int(tmp26) & int((int)255));		HX_STACK_VAR(tmp27,"tmp27");
				...
				HX_STACK_LINE(465)
				{
					...
					HX_STACK_LINE(465)
					{
						...
						HX_STACK_LINE(465)
						{
							...
							int tmp11 = (int(tmp10) << int((int)24));		HX_STACK_VAR(tmp11,"tmp11");
							HX_STACK_LINE(465)
							int tmp12 = (int(bgra) >> int((int)16));		HX_STACK_VAR(tmp12,"tmp12");
							HX_STACK_LINE(465)
							int tmp13 = tmp12;		HX_STACK_VAR(tmp13,"tmp13");
							HX_STACK_LINE(465)
							int tmp14 = (int(tmp13) & int((int)255));		HX_STACK_VAR(tmp14,"tmp14");
							...
							int tmp18 = (int(tmp11) | int(tmp17));		HX_STACK_VAR(tmp18,"tmp18");
							HX_STACK_LINE(465)
							int tmp19 = (int(bgra) >> int((int)24));		HX_STACK_VAR(tmp19,"tmp19");
							HX_STACK_LINE(465)
							int tmp20 = tmp19;		HX_STACK_VAR(tmp20,"tmp20");
							HX_STACK_LINE(465)
							int tmp21 = (int(tmp20) & int((int)255));		HX_STACK_VAR(tmp21,"tmp21");
							...
							HX_STACK_LINE(465)
							int tmp25 = (int(tmp18) | int(tmp24));		HX_STACK_VAR(tmp25,"tmp25");
							HX_STACK_LINE(465)
							int tmp26 = (int(bgra) & int((int)255));		HX_STACK_VAR(tmp26,"tmp26");
							HX_STACK_LINE(465)
							int tmp27 = tmp26;		HX_STACK_VAR(tmp27,"tmp27");
							HX_STACK_LINE(465)
							int tmp28 = (int(tmp27) & int((int)255));		HX_STACK_VAR(tmp28,"tmp28");
		...
		if ((tmp4)){
			HX_STACK_LINE(476)
			{
				HX_STACK_LINE(476)
				{
					...
					int tmp10 = (int(tmp9) << int((int)24));		HX_STACK_VAR(tmp10,"tmp10");
					HX_STACK_LINE(476)
					int tmp11 = (int(_color) >> int((int)16));		HX_STACK_VAR(tmp11,"tmp11");
					HX_STACK_LINE(476)
					int tmp12 = tmp11;		HX_STACK_VAR(tmp12,"tmp12");
					HX_STACK_LINE(476)
					int tmp13 = (int(tmp12) & int((int)255));		HX_STACK_VAR(tmp13,"tmp13");
					...
					int tmp17 = (int(tmp10) | int(tmp16));		HX_STACK_VAR(tmp17,"tmp17");
					HX_STACK_LINE(476)
					int tmp18 = (int(_color) >> int((int)8));		HX_STACK_VAR(tmp18,"tmp18");
					HX_STACK_LINE(476)
					int tmp19 = tmp18;		HX_STACK_VAR(tmp19,"tmp19");
					HX_STACK_LINE(476)
					int tmp20 = (int(tmp19) & int((int)255));		HX_STACK_VAR(tmp20,"tmp20");
					...
					int tmp24 = (int(tmp17) | int(tmp23));		HX_STACK_VAR(tmp24,"tmp24");
					HX_STACK_LINE(476)
					int tmp25 = (int)255;		HX_STACK_VAR(tmp25,"tmp25");
					HX_STACK_LINE(476)
			...
			HX_STACK_LINE(477)
			{
				HX_STACK_LINE(477)
				{
					...
					int tmp10 = (int(tmp9) << int((int)24));		HX_STACK_VAR(tmp10,"tmp10");
					HX_STACK_LINE(477)
					int tmp11 = (int(_mask) >> int((int)16));		HX_STACK_VAR(tmp11,"tmp11");
					HX_STACK_LINE(477)
					int tmp12 = tmp11;		HX_STACK_VAR(tmp12,"tmp12");
					HX_STACK_LINE(477)
					int tmp13 = (int(tmp12) & int((int)255));		HX_STACK_VAR(tmp13,"tmp13");
					...
					int tmp17 = (int(tmp10) | int(tmp16));		HX_STACK_VAR(tmp17,"tmp17");
					HX_STACK_LINE(477)
					int tmp18 = (int(_mask) >> int((int)8));		HX_STACK_VAR(tmp18,"tmp18");
					HX_STACK_LINE(477)
					int tmp19 = tmp18;		HX_STACK_VAR(tmp19,"tmp19");
					HX_STACK_LINE(477)
					int tmp20 = (int(tmp19) & int((int)255));		HX_STACK_VAR(tmp20,"tmp20");
...
int ImageDataUtil_obj::getPixel( ::lime::graphics::Image image,int x,int y,int format){
	...
	HX_STACK_LINE(618)
	{
		HX_STACK_LINE(618)
		{
			...
			HX_STACK_LINE(618)
			int tmp20 = (int)0;		HX_STACK_VAR(tmp20,"tmp20");
			HX_STACK_LINE(618)
		...
		case (int)1: {
			...
			HX_STACK_LINE(622)
			{
				...
				HX_STACK_LINE(622)
				{
					...
					HX_STACK_LINE(622)
					int tmp7 = (int(pixel) >> int((int)24));		HX_STACK_VAR(tmp7,"tmp7");
					HX_STACK_LINE(622)
					int tmp8 = tmp7;		HX_STACK_VAR(tmp8,"tmp8");
					HX_STACK_LINE(622)
					int tmp9 = (int(tmp8) & int((int)255));		HX_STACK_VAR(tmp9,"tmp9");
					...
					HX_STACK_LINE(622)
					int tmp13 = (int(tmp6) | int(tmp12));		HX_STACK_VAR(tmp13,"tmp13");
					HX_STACK_LINE(622)
		...
		case (int)2: {
			...
			HX_STACK_LINE(623)
			{
				...
				HX_STACK_LINE(623)
				{
					...
					int tmp8 = (int(tmp7) << int((int)24));		HX_STACK_VAR(tmp8,"tmp8");
					HX_STACK_LINE(623)
					int tmp9 = (int(pixel) >> int((int)16));		HX_STACK_VAR(tmp9,"tmp9");
					HX_STACK_LINE(623)
					int tmp10 = tmp9;		HX_STACK_VAR(tmp10,"tmp10");
					HX_STACK_LINE(623)
					int tmp11 = (int(tmp10) & int((int)255));		HX_STACK_VAR(tmp11,"tmp11");
						...
						HX_STACK_LINE(674)
						{
							...
							if ((tmp21)){
								...
								if ((tmp25)){
									...
									int tmp27 = tmp26;		HX_STACK_VAR(tmp27,"tmp27");
									HX_STACK_LINE(674)
									Float tmp28 = (Float(((Float)255.0)) / Float(tmp27));		HX_STACK_VAR(tmp28,"tmp28");
									HX_STACK_LINE(674)
									...
									HX_STACK_LINE(674)
									{
										...
										HX_STACK_LINE(674)
										{
											...
											int tmp34 = tmp33;		HX_STACK_VAR(tmp34,"tmp34");
											HX_STACK_LINE(674)
											Float tmp35 = ::lime::math::color::_RGBA::RGBA_Impl__obj::unmult;		HX_STACK_VAR(tmp35,"tmp35");
											HX_STACK_LINE(674)
											Float tmp36 = (tmp34 * tmp35);		HX_STACK_VAR(tmp36,"tmp36");
											HX_STACK_LINE(674)
											int tmp37 = ::Math_obj::round(tmp36);		HX_STACK_VAR(tmp37,"tmp37");
											HX_STACK_LINE(674)
											int idx = tmp37;		HX_STACK_VAR(idx,"idx");
											HX_STACK_LINE(674)
											int tmp38 = ::__hxcpp_memory_get_byte(this1->buffer->b,(this1->byteOffset + idx));		HX_STACK_VAR(tmp38,"tmp38");
											HX_STACK_LINE(674)
										...
										HX_STACK_LINE(674)
										{
											...
											int tmp35 = tmp34;		HX_STACK_VAR(tmp35,"tmp35");
											HX_STACK_LINE(674)
											Float tmp36 = ::lime::math::color::_RGBA::RGBA_Impl__obj::unmult;		HX_STACK_VAR(tmp36,"tmp36");
											HX_STACK_LINE(674)
											Float tmp37 = (tmp35 * tmp36);		HX_STACK_VAR(tmp37,"tmp37");
											HX_STACK_LINE(674)
											int tmp38 = ::Math_obj::round(tmp37);		HX_STACK_VAR(tmp38,"tmp38");
											HX_STACK_LINE(674)
											int idx = tmp38;		HX_STACK_VAR(idx,"idx");
											HX_STACK_LINE(674)
											int tmp39 = ::__hxcpp_memory_get_byte(this1->buffer->b,(this1->byteOffset + idx));		HX_STACK_VAR(tmp39,"tmp39");
											HX_STACK_LINE(674)
										...
										{
											HX_STACK_LINE(674)
											::lime::utils::ArrayBufferView tmp32 = ::lime::math::color::_RGBA::RGBA_Impl__obj::__clamp;		HX_STACK_VAR(tmp32,"tmp32");
											HX_STACK_LINE(674)
										...
										int b = tmp31;		HX_STACK_VAR(b,"b");
										HX_STACK_LINE(674)
										int tmp32 = (int(r) & int((int)255));		HX_STACK_VAR(tmp32,"tmp32");
										HX_STACK_LINE(674)
										int tmp33 = (int(tmp32) << int((int)24));		HX_STACK_VAR(tmp33,"tmp33");
										HX_STACK_LINE(674)
										int tmp34 = (int(g) & int((int)255));		HX_STACK_VAR(tmp34,"tmp34");
										HX_STACK_LINE(674)
										int tmp35 = (int(tmp34) << int((int)16));		HX_STACK_VAR(tmp35,"tmp35");
										HX_STACK_LINE(674)
										int tmp36 = (int(tmp33) | int(tmp35));		HX_STACK_VAR(tmp36,"tmp36");
										HX_STACK_LINE(674)
										int tmp37 = (int(b) & int((int)255));		HX_STACK_VAR(tmp37,"tmp37");
										HX_STACK_LINE(674)
							...
							case (int)1: {
								...
								HX_STACK_LINE(678)
								{
									...
									HX_STACK_LINE(678)
									{
										...
										int tmp32 = (int(tmp31) << int((int)16));		HX_STACK_VAR(tmp32,"tmp32");
										HX_STACK_LINE(678)
										int tmp33 = (int(tmp26) | int(tmp32));		HX_STACK_VAR(tmp33,"tmp33");
										HX_STACK_LINE(678)
										int tmp34 = (int(pixel) >> int((int)16));		HX_STACK_VAR(tmp34,"tmp34");
										HX_STACK_LINE(678)
										int tmp35 = tmp34;		HX_STACK_VAR(tmp35,"tmp35");
										HX_STACK_LINE(678)
										int tmp36 = (int(tmp35) & int((int)255));		HX_STACK_VAR(tmp36,"tmp36");
										...
										HX_STACK_LINE(678)
										int tmp40 = (int(tmp33) | int(tmp39));		HX_STACK_VAR(tmp40,"tmp40");
										HX_STACK_LINE(678)
										int tmp41 = (int(pixel) >> int((int)8));		HX_STACK_VAR(tmp41,"tmp41");
										HX_STACK_LINE(678)
										int tmp42 = tmp41;		HX_STACK_VAR(tmp42,"tmp42");
										HX_STACK_LINE(678)
										int tmp43 = (int(tmp42) & int((int)255));		HX_STACK_VAR(tmp43,"tmp43");
							...
							case (int)2: {
								...
								HX_STACK_LINE(679)
								{
									...
									HX_STACK_LINE(679)
									{
										...
										int tmp42 = (int(tmp35) | int(tmp41));		HX_STACK_VAR(tmp42,"tmp42");
										HX_STACK_LINE(679)
										int tmp43 = (int(pixel) & int((int)255));		HX_STACK_VAR(tmp43,"tmp43");
										HX_STACK_LINE(679)
										int tmp44 = tmp43;		HX_STACK_VAR(tmp44,"tmp44");
										HX_STACK_LINE(679)
										int tmp45 = (int(tmp44) & int((int)255));		HX_STACK_VAR(tmp45,"tmp45");
					...
					HX_STACK_LINE(728)
					{
						...
						while((true)){
									...
									if ((tmp32)){
										...
										HX_STACK_LINE(730)
										{
											...
											HX_STACK_LINE(730)
											{
												...
												::lime::utils::ArrayBufferView this1 = tmp38;		HX_STACK_VAR(this1,"this1");
												HX_STACK_LINE(730)
												int tmp39 = (int(sourcePixel) >> int((int)16));		HX_STACK_VAR(tmp39,"tmp39");
												HX_STACK_LINE(730)
												int tmp40 = tmp39;		HX_STACK_VAR(tmp40,"tmp40");
												HX_STACK_LINE(730)
												int tmp41 = (int(tmp40) & int((int)255));		HX_STACK_VAR(tmp41,"tmp41");
											...
											HX_STACK_LINE(730)
											{
												...
												::lime::utils::ArrayBufferView this1 = tmp39;		HX_STACK_VAR(this1,"this1");
												HX_STACK_LINE(730)
												int tmp40 = (int(sourcePixel) >> int((int)8));		HX_STACK_VAR(tmp40,"tmp40");
												HX_STACK_LINE(730)
												int tmp41 = tmp40;		HX_STACK_VAR(tmp41,"tmp41");
												HX_STACK_LINE(730)
												int tmp42 = (int(tmp41) & int((int)255));		HX_STACK_VAR(tmp42,"tmp42");
							...
							HX_STACK_LINE(733)
							{
								...
								int tmp30 = tmp29;		HX_STACK_VAR(tmp30,"tmp30");
								HX_STACK_LINE(733)
								int tmp31 = redMultiplier;		HX_STACK_VAR(tmp31,"tmp31");
								HX_STACK_LINE(733)
								int tmp32 = (tmp30 * tmp31);		HX_STACK_VAR(tmp32,"tmp32");
								HX_STACK_LINE(733)
								...
								int tmp36 = tmp35;		HX_STACK_VAR(tmp36,"tmp36");
								HX_STACK_LINE(733)
								int tmp37 = ((int)256 - redMultiplier);		HX_STACK_VAR(tmp37,"tmp37");
								HX_STACK_LINE(733)
								int tmp38 = (tmp36 * tmp37);		HX_STACK_VAR(tmp38,"tmp38");
								HX_STACK_LINE(733)
								int tmp39 = (tmp32 + tmp38);		HX_STACK_VAR(tmp39,"tmp39");
								HX_STACK_LINE(733)
								Float tmp40 = (Float(tmp39) / Float((int)256));		HX_STACK_VAR(tmp40,"tmp40");
								HX_STACK_LINE(733)
								...
								HX_STACK_LINE(733)
								{
									...
									int tmp49 = (int(tmp48) << int((int)16));		HX_STACK_VAR(tmp49,"tmp49");
									HX_STACK_LINE(733)
									int tmp50 = (int(tmp43) | int(tmp49));		HX_STACK_VAR(tmp50,"tmp50");
									HX_STACK_LINE(733)
									int tmp51 = (int(destPixel) >> int((int)8));		HX_STACK_VAR(tmp51,"tmp51");
									HX_STACK_LINE(733)
									int tmp52 = tmp51;		HX_STACK_VAR(tmp52,"tmp52");
									...
									HX_STACK_LINE(733)
									int tmp57 = (int(tmp50) | int(tmp56));		HX_STACK_VAR(tmp57,"tmp57");
									HX_STACK_LINE(733)
									int tmp58 = (int(destPixel) & int((int)255));		HX_STACK_VAR(tmp58,"tmp58");
									HX_STACK_LINE(733)
									int tmp59 = tmp58;		HX_STACK_VAR(tmp59,"tmp59");
									HX_STACK_LINE(733)
									int tmp60 = (int(tmp59) & int((int)255));		HX_STACK_VAR(tmp60,"tmp60");
							...
							HX_STACK_LINE(734)
							{
								...
								int tmp30 = tmp29;		HX_STACK_VAR(tmp30,"tmp30");
								HX_STACK_LINE(734)
								int tmp31 = greenMultiplier;		HX_STACK_VAR(tmp31,"tmp31");
								HX_STACK_LINE(734)
								int tmp32 = (tmp30 * tmp31);		HX_STACK_VAR(tmp32,"tmp32");
								HX_STACK_LINE(734)
								...
								int tmp36 = tmp35;		HX_STACK_VAR(tmp36,"tmp36");
								HX_STACK_LINE(734)
								int tmp37 = ((int)256 - greenMultiplier);		HX_STACK_VAR(tmp37,"tmp37");
								HX_STACK_LINE(734)
								int tmp38 = (tmp36 * tmp37);		HX_STACK_VAR(tmp38,"tmp38");
								HX_STACK_LINE(734)
								int tmp39 = (tmp32 + tmp38);		HX_STACK_VAR(tmp39,"tmp39");
							...
							HX_STACK_LINE(735)
							{
								...
								int tmp30 = tmp29;		HX_STACK_VAR(tmp30,"tmp30");
								HX_STACK_LINE(735)
								int tmp31 = blueMultiplier;		HX_STACK_VAR(tmp31,"tmp31");
								HX_STACK_LINE(735)
								int tmp32 = (tmp30 * tmp31);		HX_STACK_VAR(tmp32,"tmp32");
								HX_STACK_LINE(735)
								...
								int tmp36 = tmp35;		HX_STACK_VAR(tmp36,"tmp36");
								HX_STACK_LINE(735)
								int tmp37 = ((int)256 - blueMultiplier);		HX_STACK_VAR(tmp37,"tmp37");
								HX_STACK_LINE(735)
								int tmp38 = (tmp36 * tmp37);		HX_STACK_VAR(tmp38,"tmp38");
								HX_STACK_LINE(735)
								int tmp39 = (tmp32 + tmp38);		HX_STACK_VAR(tmp39,"tmp39");
								...
								HX_STACK_LINE(735)
								{
									...
									int tmp53 = (int(tmp52) << int((int)16));		HX_STACK_VAR(tmp53,"tmp53");
									HX_STACK_LINE(735)
									int tmp54 = (int(tmp47) | int(tmp53));		HX_STACK_VAR(tmp54,"tmp54");
									HX_STACK_LINE(735)
									int tmp55 = (int(value) & int((int)255));		HX_STACK_VAR(tmp55,"tmp55");
									HX_STACK_LINE(735)
									int tmp56 = (int(tmp55) << int((int)8));		HX_STACK_VAR(tmp56,"tmp56");
									HX_STACK_LINE(735)
									int tmp57 = (int(tmp54) | int(tmp56));		HX_STACK_VAR(tmp57,"tmp57");
							...
							HX_STACK_LINE(736)
							{
								...
								int tmp32 = tmp31;		HX_STACK_VAR(tmp32,"tmp32");
								HX_STACK_LINE(736)
								int tmp33 = ((int)256 - alphaMultiplier);		HX_STACK_VAR(tmp33,"tmp33");
								HX_STACK_LINE(736)
								...
								HX_STACK_LINE(736)
								{
									...
									int tmp57 = (int(tmp50) | int(tmp56));		HX_STACK_VAR(tmp57,"tmp57");
									HX_STACK_LINE(736)
									int tmp58 = (int(value) & int((int)255));		HX_STACK_VAR(tmp58,"tmp58");
									HX_STACK_LINE(736)
							...
							HX_STACK_LINE(738)
							{
								...
								if ((tmp27)){
									...
									if ((tmp30)){
										...
										int tmp32 = tmp31;		HX_STACK_VAR(tmp32,"tmp32");
										HX_STACK_LINE(738)
										bool tmp33 = (tmp32 != (int)255);		HX_STACK_VAR(tmp33,"tmp33");
										HX_STACK_LINE(738)
										if ((tmp33)){
											HX_STACK_LINE(738)
											...
											{
												HX_STACK_LINE(738)
												::lime::utils::ArrayBufferView tmp35 = ::lime::math::color::_RGBA::RGBA_Impl__obj::__alpha16;		HX_STACK_VAR(tmp35,"tmp35");
												HX_STACK_LINE(738)
											...
											{
												HX_STACK_LINE(738)
												int tmp35 = (int(destPixel) >> int((int)24));		HX_STACK_VAR(tmp35,"tmp35");
												HX_STACK_LINE(738)
												int tmp36 = tmp35;		HX_STACK_VAR(tmp36,"tmp36");
												HX_STACK_LINE(738)
												int tmp37 = (int(tmp36) & int((int)255));		HX_STACK_VAR(tmp37,"tmp37");
												...
												HX_STACK_LINE(738)
												int tmp53 = (int(tmp43) | int(tmp52));		HX_STACK_VAR(tmp53,"tmp53");
												HX_STACK_LINE(738)
												int tmp54 = (int(destPixel) >> int((int)8));		HX_STACK_VAR(tmp54,"tmp54");
												HX_STACK_LINE(738)
												int tmp55 = tmp54;		HX_STACK_VAR(tmp55,"tmp55");
												HX_STACK_LINE(738)
												int tmp56 = (int(tmp55) & int((int)255));		HX_STACK_VAR(tmp56,"tmp56");
												...
												int tmp62 = (int(tmp61) << int((int)8));		HX_STACK_VAR(tmp62,"tmp62");
												HX_STACK_LINE(738)
												int tmp63 = (int(tmp53) | int(tmp62));		HX_STACK_VAR(tmp63,"tmp63");
												HX_STACK_LINE(738)
					...
					HX_STACK_LINE(772)
					{
						...
						HX_STACK_LINE(772)
						{
							...
							if ((tmp15)){
								...
								int tmp17 = tmp16;		HX_STACK_VAR(tmp17,"tmp17");
								HX_STACK_LINE(772)
								bool tmp18 = (tmp17 != (int)255);		HX_STACK_VAR(tmp18,"tmp18");
								HX_STACK_LINE(772)
								if ((tmp18)){
									HX_STACK_LINE(772)
									Dynamic tmp19;		HX_STACK_VAR(tmp19,"tmp19");
									...
									{
										HX_STACK_LINE(772)
										::lime::utils::ArrayBufferView tmp20 = ::lime::math::color::_RGBA::RGBA_Impl__obj::__alpha16;		HX_STACK_VAR(tmp20,"tmp20");
										HX_STACK_LINE(772)
										::lime::utils::ArrayBufferView this1 = tmp20;		HX_STACK_VAR(this1,"this1");
										HX_STACK_LINE(772)
									...
									HX_STACK_LINE(772)
									{
										...
										int tmp37 = (int(tmp36) << int((int)16));		HX_STACK_VAR(tmp37,"tmp37");
										HX_STACK_LINE(772)
										int tmp38 = (int(tmp28) | int(tmp37));		HX_STACK_VAR(tmp38,"tmp38");
										HX_STACK_LINE(772)
										int tmp39 = (int(pixel) >> int((int)8));		HX_STACK_VAR(tmp39,"tmp39");
										HX_STACK_LINE(772)
										int tmp40 = tmp39;		HX_STACK_VAR(tmp40,"tmp40");
										...
										int tmp47 = (int(tmp46) << int((int)8));		HX_STACK_VAR(tmp47,"tmp47");
										HX_STACK_LINE(772)
										int tmp48 = (int(tmp38) | int(tmp47));		HX_STACK_VAR(tmp48,"tmp48");
										HX_STACK_LINE(772)
										int tmp49 = (int(pixel) & int((int)255));		HX_STACK_VAR(tmp49,"tmp49");
										HX_STACK_LINE(772)
										int tmp50 = tmp49;		HX_STACK_VAR(tmp50,"tmp50");
										HX_STACK_LINE(772)
										int tmp51 = (int(tmp50) & int((int)255));		HX_STACK_VAR(tmp51,"tmp51");
...
Void ImageDataUtil_obj::setPixel( ::lime::graphics::Image image,int x,int y,int color,int format){
{
		...
		HX_STACK_LINE(1003)
		{
			...
			if ((tmp11)){
				...
				if ((tmp14)){
					HX_STACK_LINE(1003)
					int tmp16 = (int(source) & int((int)255));		HX_STACK_VAR(tmp16,"tmp16");
					HX_STACK_LINE(1003)
					int tmp17 = tmp16;		HX_STACK_VAR(tmp17,"tmp17");
					HX_STACK_LINE(1003)
					int tmp18 = tmp17;		HX_STACK_VAR(tmp18,"tmp18");
				...
				if ((tmp15)){
					...
					int tmp17 = tmp16;		HX_STACK_VAR(tmp17,"tmp17");
					HX_STACK_LINE(1003)
					Float tmp18 = (Float(((Float)255.0)) / Float(tmp17));		HX_STACK_VAR(tmp18,"tmp18");
					HX_STACK_LINE(1003)
					...
					HX_STACK_LINE(1003)
					{
						...
						HX_STACK_LINE(1003)
						{
							...
							::lime::utils::ArrayBufferView this1 = tmp20;		HX_STACK_VAR(this1,"this1");
							HX_STACK_LINE(1003)
							int tmp21 = (int(source) >> int((int)24));		HX_STACK_VAR(tmp21,"tmp21");
							HX_STACK_LINE(1003)
							int tmp22 = tmp21;		HX_STACK_VAR(tmp22,"tmp22");
							HX_STACK_LINE(1003)
							int tmp23 = (int(tmp22) & int((int)255));		HX_STACK_VAR(tmp23,"tmp23");
						...
						HX_STACK_LINE(1003)
						{
							...
							HX_STACK_LINE(1003)
							int tmp22 = (int(source) >> int((int)16));		HX_STACK_VAR(tmp22,"tmp22");
							HX_STACK_LINE(1003)
							int tmp23 = tmp22;		HX_STACK_VAR(tmp23,"tmp23");
							HX_STACK_LINE(1003)
							int tmp24 = (int(tmp23) & int((int)255));		HX_STACK_VAR(tmp24,"tmp24");
						...
						HX_STACK_LINE(1003)
						{
							...
							HX_STACK_LINE(1003)
							int tmp23 = (int(source) >> int((int)8));		HX_STACK_VAR(tmp23,"tmp23");
							HX_STACK_LINE(1003)
							int tmp24 = tmp23;		HX_STACK_VAR(tmp24,"tmp24");
							HX_STACK_LINE(1003)
							int tmp25 = (int(tmp24) & int((int)255));		HX_STACK_VAR(tmp25,"tmp25");
						...
						int tmp29 = (int(tmp26) | int(tmp28));		HX_STACK_VAR(tmp29,"tmp29");
						HX_STACK_LINE(1003)
						int tmp30 = (int(source) & int((int)255));		HX_STACK_VAR(tmp30,"tmp30");
						HX_STACK_LINE(1003)
						int tmp31 = tmp30;		HX_STACK_VAR(tmp31,"tmp31");
						HX_STACK_LINE(1003)
						int tmp32 = (int(tmp31) & int((int)255));		HX_STACK_VAR(tmp32,"tmp32");
		...
		HX_STACK_LINE(1005)
		{
			...
			HX_STACK_LINE(1005)
			{
				...
				int tmp22 = (int(tmp15) | int(tmp21));		HX_STACK_VAR(tmp22,"tmp22");
				HX_STACK_LINE(1005)
				int tmp23 = (int(value) & int((int)255));		HX_STACK_VAR(tmp23,"tmp23");
				HX_STACK_LINE(1005)
				int tmp24 = (int(tmp22) | int(tmp23));		HX_STACK_VAR(tmp24,"tmp24");
				HX_STACK_LINE(1005)
				pixel = tmp24;
				...
				if ((tmp13)){
					...
					if ((tmp16)){
						...
						HX_STACK_LINE(1006)
						{
							...
							int tmp35 = (int(tmp34) << int((int)16));		HX_STACK_VAR(tmp35,"tmp35");
							HX_STACK_LINE(1006)
							int tmp36 = (int(tmp26) | int(tmp35));		HX_STACK_VAR(tmp36,"tmp36");
							HX_STACK_LINE(1006)
							...
							int tmp45 = (int(tmp44) << int((int)8));		HX_STACK_VAR(tmp45,"tmp45");
							HX_STACK_LINE(1006)
							int tmp46 = (int(tmp36) | int(tmp45));		HX_STACK_VAR(tmp46,"tmp46");
							HX_STACK_LINE(1006)
							int tmp47 = (int(pixel) & int((int)255));		HX_STACK_VAR(tmp47,"tmp47");
							HX_STACK_LINE(1006)
							int tmp48 = tmp47;		HX_STACK_VAR(tmp48,"tmp48");
							HX_STACK_LINE(1006)
							int tmp49 = (int(tmp48) & int((int)255));		HX_STACK_VAR(tmp49,"tmp49");
				...
				if ((tmp14)){
					...
					if ((tmp17)){
						...
						HX_STACK_LINE(1027)
						{
							...
							HX_STACK_LINE(1027)
							int tmp37 = (int(tmp27) | int(tmp36));		HX_STACK_VAR(tmp37,"tmp37");
							HX_STACK_LINE(1027)
							...
							int tmp46 = (int(tmp45) << int((int)8));		HX_STACK_VAR(tmp46,"tmp46");
							HX_STACK_LINE(1027)
							int tmp47 = (int(tmp37) | int(tmp46));		HX_STACK_VAR(tmp47,"tmp47");
							HX_STACK_LINE(1027)
							int tmp48 = (int(pixel) & int((int)255));		HX_STACK_VAR(tmp48,"tmp48");
							HX_STACK_LINE(1027)
							int tmp49 = tmp48;		HX_STACK_VAR(tmp49,"tmp49");
							HX_STACK_LINE(1027)
							int tmp50 = (int(tmp49) & int((int)255));		HX_STACK_VAR(tmp50,"tmp50");
						...
						while((true)){
									...
									HX_STACK_LINE(1064)
									{
										...
										HX_STACK_LINE(1064)
										{
											...
											HX_STACK_LINE(1064)
											{
												...
												int tmp38 = (int(tmp37) << int((int)24));		HX_STACK_VAR(tmp38,"tmp38");
												HX_STACK_LINE(1064)
												int tmp39 = (int(argb) >> int((int)8));		HX_STACK_VAR(tmp39,"tmp39");
												HX_STACK_LINE(1064)
												int tmp40 = tmp39;		HX_STACK_VAR(tmp40,"tmp40");
												HX_STACK_LINE(1064)
												int tmp41 = (int(tmp40) & int((int)255));		HX_STACK_VAR(tmp41,"tmp41");
												...
												int tmp45 = (int(tmp38) | int(tmp44));		HX_STACK_VAR(tmp45,"tmp45");
												HX_STACK_LINE(1064)
												int tmp46 = (int(argb) & int((int)255));		HX_STACK_VAR(tmp46,"tmp46");
												HX_STACK_LINE(1064)
												int tmp47 = tmp46;		HX_STACK_VAR(tmp47,"tmp47");
												HX_STACK_LINE(1064)
												int tmp48 = (int(tmp47) & int((int)255));		HX_STACK_VAR(tmp48,"tmp48");
												...
												HX_STACK_LINE(1064)
												int tmp51 = (int(argb) >> int((int)24));		HX_STACK_VAR(tmp51,"tmp51");
												HX_STACK_LINE(1064)
												int tmp52 = tmp51;		HX_STACK_VAR(tmp52,"tmp52");
												HX_STACK_LINE(1064)
												int tmp53 = (int(tmp52) & int((int)255));		HX_STACK_VAR(tmp53,"tmp53");
												...
												int tmp55 = (int(tmp54) & int((int)255));		HX_STACK_VAR(tmp55,"tmp55");
												HX_STACK_LINE(1064)
												int tmp56 = (int(tmp50) | int(tmp55));		HX_STACK_VAR(tmp56,"tmp56");
												HX_STACK_LINE(1064)
												rgba = tmp56;
											}
											HX_STACK_LINE(1064)
									...
									HX_STACK_LINE(1065)
									{
										...
										HX_STACK_LINE(1065)
										{
											...
											HX_STACK_LINE(1065)
											{
												...
												int tmp38 = (int(tmp37) << int((int)24));		HX_STACK_VAR(tmp38,"tmp38");
												HX_STACK_LINE(1065)
												int tmp39 = (int(bgra) >> int((int)16));		HX_STACK_VAR(tmp39,"tmp39");
												HX_STACK_LINE(1065)
												int tmp40 = tmp39;		HX_STACK_VAR(tmp40,"tmp40");
												HX_STACK_LINE(1065)
												int tmp41 = (int(tmp40) & int((int)255));		HX_STACK_VAR(tmp41,"tmp41");
												...
												int tmp45 = (int(tmp38) | int(tmp44));		HX_STACK_VAR(tmp45,"tmp45");
												HX_STACK_LINE(1065)
												int tmp46 = (int(bgra) >> int((int)24));		HX_STACK_VAR(tmp46,"tmp46");
												HX_STACK_LINE(1065)
												int tmp47 = tmp46;		HX_STACK_VAR(tmp47,"tmp47");
												HX_STACK_LINE(1065)
												int tmp48 = (int(tmp47) & int((int)255));		HX_STACK_VAR(tmp48,"tmp48");
												...
												int tmp52 = (int(tmp45) | int(tmp51));		HX_STACK_VAR(tmp52,"tmp52");
												HX_STACK_LINE(1065)
												int tmp53 = (int(bgra) & int((int)255));		HX_STACK_VAR(tmp53,"tmp53");
												HX_STACK_LINE(1065)
												int tmp54 = tmp53;		HX_STACK_VAR(tmp54,"tmp54");
												HX_STACK_LINE(1065)
												int tmp55 = (int(tmp54) & int((int)255));		HX_STACK_VAR(tmp55,"tmp55");
							...
							if ((tmp32)){
								HX_STACK_LINE(1070)
								{
									...
									int tmp52 = (int(tmp45) | int(tmp51));		HX_STACK_VAR(tmp52,"tmp52");
									HX_STACK_LINE(1070)
									int tmp53 = (int)255;		HX_STACK_VAR(tmp53,"tmp53");
									HX_STACK_LINE(1070)
							...
							HX_STACK_LINE(1071)
							{
								...
								if ((tmp36)){
									...
									if ((tmp39)){
										HX_STACK_LINE(1071)
										bool tmp40 = (pixel != (int)0);		HX_STACK_VAR(tmp40,"tmp40");
										HX_STACK_LINE(1071)
										if ((tmp40)){
											HX_STACK_LINE(1071)
											pixel = (int)0;
										...
										int tmp41 = tmp40;		HX_STACK_VAR(tmp41,"tmp41");
										HX_STACK_LINE(1071)
										bool tmp42 = (tmp41 != (int)255);		HX_STACK_VAR(tmp42,"tmp42");
										HX_STACK_LINE(1071)
										if ((tmp42)){
											HX_STACK_LINE(1071)
											Dynamic tmp43;		HX_STACK_VAR(tmp43,"tmp43");
											...
											{
												HX_STACK_LINE(1071)
												::lime::utils::ArrayBufferView tmp44 = ::lime::math::color::_RGBA::RGBA_Impl__obj::__alpha16;		HX_STACK_VAR(tmp44,"tmp44");
												HX_STACK_LINE(1071)
												::lime::utils::ArrayBufferView this1 = tmp44;		HX_STACK_VAR(this1,"this1");
												HX_STACK_LINE(1071)
											...
											{
												HX_STACK_LINE(1071)
												int tmp44 = (int(pixel) >> int((int)24));		HX_STACK_VAR(tmp44,"tmp44");
												HX_STACK_LINE(1071)
												int tmp45 = tmp44;		HX_STACK_VAR(tmp45,"tmp45");
												HX_STACK_LINE(1071)
												int tmp46 = (int(tmp45) & int((int)255));		HX_STACK_VAR(tmp46,"tmp46");
												...
												int tmp52 = (int(tmp51) << int((int)24));		HX_STACK_VAR(tmp52,"tmp52");
												HX_STACK_LINE(1071)
												int tmp53 = (int(pixel) >> int((int)16));		HX_STACK_VAR(tmp53,"tmp53");
												HX_STACK_LINE(1071)
												int tmp54 = tmp53;		HX_STACK_VAR(tmp54,"tmp54");
												HX_STACK_LINE(1071)
												int tmp55 = (int(tmp54) & int((int)255));		HX_STACK_VAR(tmp55,"tmp55");
												...
												int tmp62 = (int(tmp52) | int(tmp61));		HX_STACK_VAR(tmp62,"tmp62");
												HX_STACK_LINE(1071)
												int tmp63 = (int(pixel) >> int((int)8));		HX_STACK_VAR(tmp63,"tmp63");
												HX_STACK_LINE(1071)
												int tmp64 = tmp63;		HX_STACK_VAR(tmp64,"tmp64");
												HX_STACK_LINE(1071)
												int tmp65 = (int(tmp64) & int((int)255));		HX_STACK_VAR(tmp65,"tmp65");
												...
												HX_STACK_LINE(1071)
												int tmp72 = (int(tmp62) | int(tmp71));		HX_STACK_VAR(tmp72,"tmp72");
												HX_STACK_LINE(1071)
												int tmp73 = (int(pixel) & int((int)255));		HX_STACK_VAR(tmp73,"tmp73");
												HX_STACK_LINE(1071)
												int tmp74 = tmp73;		HX_STACK_VAR(tmp74,"tmp74");
												HX_STACK_LINE(1071)
												int tmp75 = (int(tmp74) & int((int)255));		HX_STACK_VAR(tmp75,"tmp75");
												HX_STACK_LINE(1071)
												int tmp76 = (int(tmp72) | int(tmp75));		HX_STACK_VAR(tmp76,"tmp76");
												HX_STACK_LINE(1071)
												pixel = tmp76;
											}
										}
			...
			HX_STACK_LINE(1094)
			{
				...
				HX_STACK_LINE(1094)
				{
					...
					HX_STACK_LINE(1094)
					{
						...
						HX_STACK_LINE(1094)
						int tmp22 = (int(argb) >> int((int)24));		HX_STACK_VAR(tmp22,"tmp22");
						HX_STACK_LINE(1094)
						int tmp23 = tmp22;		HX_STACK_VAR(tmp23,"tmp23");
						HX_STACK_LINE(1094)
						int tmp24 = (int(tmp23) & int((int)255));		HX_STACK_VAR(tmp24,"tmp24");
						...
						int tmp26 = (int(tmp25) & int((int)255));		HX_STACK_VAR(tmp26,"tmp26");
						HX_STACK_LINE(1094)
						int tmp27 = (int(tmp21) | int(tmp26));		HX_STACK_VAR(tmp27,"tmp27");
						HX_STACK_LINE(1094)
						rgba = tmp27;
					}
					HX_STACK_LINE(1094)
			...
			HX_STACK_LINE(1100)
			{
				...
				HX_STACK_LINE(1100)
				{
					...
					HX_STACK_LINE(1100)
					{
						...
						int tmp16 = (int(tmp9) | int(tmp15));		HX_STACK_VAR(tmp16,"tmp16");
						HX_STACK_LINE(1100)
						int tmp17 = (int(bgra) >> int((int)24));		HX_STACK_VAR(tmp17,"tmp17");
						HX_STACK_LINE(1100)
						int tmp18 = tmp17;		HX_STACK_VAR(tmp18,"tmp18");
						HX_STACK_LINE(1100)
						int tmp19 = (int(tmp18) & int((int)255));		HX_STACK_VAR(tmp19,"tmp19");
						...
						HX_STACK_LINE(1100)
						int tmp24 = (int(bgra) & int((int)255));		HX_STACK_VAR(tmp24,"tmp24");
						HX_STACK_LINE(1100)
						int tmp25 = tmp24;		HX_STACK_VAR(tmp25,"tmp25");
						HX_STACK_LINE(1100)
						int tmp26 = (int(tmp25) & int((int)255));		HX_STACK_VAR(tmp26,"tmp26");
					...
					while((true)){
						...
						HX_STACK_LINE(1154)
						{
							...
							if ((tmp31)){
								...
								if ((tmp34)){
									HX_STACK_LINE(1154)
									int tmp36 = (int(srcPixel) & int((int)255));		HX_STACK_VAR(tmp36,"tmp36");
									HX_STACK_LINE(1154)
									int tmp37 = tmp36;		HX_STACK_VAR(tmp37,"tmp37");
									HX_STACK_LINE(1154)
									int tmp38 = tmp37;		HX_STACK_VAR(tmp38,"tmp38");
								...
								if ((tmp35)){
									...
									HX_STACK_LINE(1154)
									{
										...
										HX_STACK_LINE(1154)
										{
											...
											::lime::utils::ArrayBufferView this1 = tmp40;		HX_STACK_VAR(this1,"this1");
											HX_STACK_LINE(1154)
											int tmp41 = (int(srcPixel) >> int((int)24));		HX_STACK_VAR(tmp41,"tmp41");
											HX_STACK_LINE(1154)
											int tmp42 = tmp41;		HX_STACK_VAR(tmp42,"tmp42");
											HX_STACK_LINE(1154)
											int tmp43 = (int(tmp42) & int((int)255));		HX_STACK_VAR(tmp43,"tmp43");
										...
										HX_STACK_LINE(1154)
										{
											...
											::lime::utils::ArrayBufferView this1 = tmp41;		HX_STACK_VAR(this1,"this1");
											HX_STACK_LINE(1154)
											int tmp42 = (int(srcPixel) >> int((int)16));		HX_STACK_VAR(tmp42,"tmp42");
											HX_STACK_LINE(1154)
											int tmp43 = tmp42;		HX_STACK_VAR(tmp43,"tmp43");
											HX_STACK_LINE(1154)
											int tmp44 = (int(tmp43) & int((int)255));		HX_STACK_VAR(tmp44,"tmp44");
										...
										HX_STACK_LINE(1154)
										{
											...
											::lime::utils::ArrayBufferView this1 = tmp42;		HX_STACK_VAR(this1,"this1");
											HX_STACK_LINE(1154)
											int tmp43 = (int(srcPixel) >> int((int)8));		HX_STACK_VAR(tmp43,"tmp43");
											HX_STACK_LINE(1154)
											int tmp44 = tmp43;		HX_STACK_VAR(tmp44,"tmp44");
											HX_STACK_LINE(1154)
											int tmp45 = (int(tmp44) & int((int)255));		HX_STACK_VAR(tmp45,"tmp45");
										...
										HX_STACK_LINE(1154)
										int tmp50 = (int(srcPixel) & int((int)255));		HX_STACK_VAR(tmp50,"tmp50");
										HX_STACK_LINE(1154)
										int tmp51 = tmp50;		HX_STACK_VAR(tmp51,"tmp51");
										HX_STACK_LINE(1154)
										int tmp52 = (int(tmp51) & int((int)255));		HX_STACK_VAR(tmp52,"tmp52");
						...
						HX_STACK_LINE(1158)
						{
							...
							tmp110 = tmp34;
							HX_STACK_LINE(1158)
							int tmp35 = (int(_threshold) >> int((int)24));		HX_STACK_VAR(tmp35,"tmp35");
							HX_STACK_LINE(1158)
							int tmp36 = tmp35;		HX_STACK_VAR(tmp36,"tmp36");
							HX_STACK_LINE(1158)
							int tmp37 = (int(tmp36) & int((int)255));		HX_STACK_VAR(tmp37,"tmp37");
							...
							tmp210 = tmp37;
							HX_STACK_LINE(1158)
							bool tmp38 = (tmp110 != tmp210);		HX_STACK_VAR(tmp38,"tmp38");
							HX_STACK_LINE(1158)
							if ((tmp38)){
								HX_STACK_LINE(1158)
								bool tmp39;		HX_STACK_VAR(tmp39,"tmp39");
								...
								{
									HX_STACK_LINE(1158)
									bool tmp40 = (tmp110 < (int)0);		HX_STACK_VAR(tmp40,"tmp40");
									HX_STACK_LINE(1158)
									bool aNeg = tmp40;		HX_STACK_VAR(aNeg,"aNeg");
									HX_STACK_LINE(1158)
									bool tmp41 = (tmp210 < (int)0);		HX_STACK_VAR(tmp41,"tmp41");
									HX_STACK_LINE(1158)
									bool bNeg = tmp41;		HX_STACK_VAR(bNeg,"bNeg");
									HX_STACK_LINE(1158)
									bool tmp42 = (aNeg != bNeg);		HX_STACK_VAR(tmp42,"tmp42");
									HX_STACK_LINE(1158)
									if ((tmp42)){
										HX_STACK_LINE(1158)
										tmp39 = aNeg;
								...
								HX_STACK_LINE(1158)
								int tmp39 = (int(pixelMask) >> int((int)16));		HX_STACK_VAR(tmp39,"tmp39");
								HX_STACK_LINE(1158)
								int tmp40 = tmp39;		HX_STACK_VAR(tmp40,"tmp40");
								HX_STACK_LINE(1158)
								int tmp41 = (int(tmp40) & int((int)255));		HX_STACK_VAR(tmp41,"tmp41");
								...
								tmp110 = tmp41;
								HX_STACK_LINE(1158)
								int tmp42 = (int(_threshold) >> int((int)16));		HX_STACK_VAR(tmp42,"tmp42");
								HX_STACK_LINE(1158)
								int tmp43 = tmp42;		HX_STACK_VAR(tmp43,"tmp43");
								HX_STACK_LINE(1158)
								int tmp44 = (int(tmp43) & int((int)255));		HX_STACK_VAR(tmp44,"tmp44");
								...
								tmp210 = tmp44;
								HX_STACK_LINE(1158)
								bool tmp45 = (tmp110 != tmp210);		HX_STACK_VAR(tmp45,"tmp45");
								HX_STACK_LINE(1158)
								if ((tmp45)){
									HX_STACK_LINE(1158)
									...
									{
										HX_STACK_LINE(1158)
										bool tmp47 = (tmp110 < (int)0);		HX_STACK_VAR(tmp47,"tmp47");
										HX_STACK_LINE(1158)
										bool aNeg = tmp47;		HX_STACK_VAR(aNeg,"aNeg");
										HX_STACK_LINE(1158)
										bool tmp48 = (tmp210 < (int)0);		HX_STACK_VAR(tmp48,"tmp48");
										HX_STACK_LINE(1158)
										bool bNeg = tmp48;		HX_STACK_VAR(bNeg,"bNeg");
										HX_STACK_LINE(1158)
										bool tmp49 = (aNeg != bNeg);		HX_STACK_VAR(tmp49,"tmp49");
										HX_STACK_LINE(1158)
										if ((tmp49)){
											HX_STACK_LINE(1158)
											tmp46 = aNeg;
									...
									HX_STACK_LINE(1158)
									int tmp46 = (int(pixelMask) >> int((int)8));		HX_STACK_VAR(tmp46,"tmp46");
									HX_STACK_LINE(1158)
									int tmp47 = tmp46;		HX_STACK_VAR(tmp47,"tmp47");
									HX_STACK_LINE(1158)
									int tmp48 = (int(tmp47) & int((int)255));		HX_STACK_VAR(tmp48,"tmp48");
									...
									tmp110 = tmp48;
									HX_STACK_LINE(1158)
									int tmp49 = (int(_threshold) >> int((int)8));		HX_STACK_VAR(tmp49,"tmp49");
									HX_STACK_LINE(1158)
									int tmp50 = tmp49;		HX_STACK_VAR(tmp50,"tmp50");
									HX_STACK_LINE(1158)
									int tmp51 = (int(tmp50) & int((int)255));		HX_STACK_VAR(tmp51,"tmp51");
									...
									tmp210 = tmp51;
									HX_STACK_LINE(1158)
									bool tmp52 = (tmp110 != tmp210);		HX_STACK_VAR(tmp52,"tmp52");
									HX_STACK_LINE(1158)
									if ((tmp52)){
										HX_STACK_LINE(1158)
										...
										{
											HX_STACK_LINE(1158)
											bool tmp54 = (tmp110 < (int)0);		HX_STACK_VAR(tmp54,"tmp54");
											HX_STACK_LINE(1158)
											bool aNeg = tmp54;		HX_STACK_VAR(aNeg,"aNeg");
											HX_STACK_LINE(1158)
											bool tmp55 = (tmp210 < (int)0);		HX_STACK_VAR(tmp55,"tmp55");
											HX_STACK_LINE(1158)
											bool bNeg = tmp55;		HX_STACK_VAR(bNeg,"bNeg");
											HX_STACK_LINE(1158)
											bool tmp56 = (aNeg != bNeg);		HX_STACK_VAR(tmp56,"tmp56");
											HX_STACK_LINE(1158)
											if ((tmp56)){
												HX_STACK_LINE(1158)
												tmp53 = aNeg;
										...
										HX_STACK_LINE(1158)
										int tmp53 = (int(pixelMask) & int((int)255));		HX_STACK_VAR(tmp53,"tmp53");
										HX_STACK_LINE(1158)
										tmp110 = tmp53;
										HX_STACK_LINE(1158)
										int tmp54 = (int(_threshold) & int((int)255));		HX_STACK_VAR(tmp54,"tmp54");
										HX_STACK_LINE(1158)
										tmp210 = tmp54;
										HX_STACK_LINE(1158)
										bool tmp55 = (tmp110 != tmp210);		HX_STACK_VAR(tmp55,"tmp55");
										HX_STACK_LINE(1158)
										if ((tmp55)){
											HX_STACK_LINE(1158)
											...
											{
												HX_STACK_LINE(1158)
												bool tmp57 = (tmp110 < (int)0);		HX_STACK_VAR(tmp57,"tmp57");
												HX_STACK_LINE(1158)
												bool aNeg = tmp57;		HX_STACK_VAR(aNeg,"aNeg");
												HX_STACK_LINE(1158)
												bool tmp58 = (tmp210 < (int)0);		HX_STACK_VAR(tmp58,"tmp58");
												HX_STACK_LINE(1158)
												bool bNeg = tmp58;		HX_STACK_VAR(bNeg,"bNeg");
												HX_STACK_LINE(1158)
												bool tmp59 = (aNeg != bNeg);		HX_STACK_VAR(tmp59,"tmp59");
												HX_STACK_LINE(1158)
												if ((tmp59)){
													HX_STACK_LINE(1158)
													tmp56 = aNeg;
						...
						if ((tmp34)){
							HX_STACK_LINE(1174)
							{
								...
								if ((tmp35)){
									...
									if ((tmp38)){
										HX_STACK_LINE(1174)
										bool tmp39 = (_color != (int)0);		HX_STACK_VAR(tmp39,"tmp39");
										HX_STACK_LINE(1174)
										if ((tmp39)){
											HX_STACK_LINE(1174)
											_color = (int)0;
										...
										HX_STACK_LINE(1174)
										int tmp39 = (int(_color) & int((int)255));		HX_STACK_VAR(tmp39,"tmp39");
										HX_STACK_LINE(1174)
										int tmp40 = tmp39;		HX_STACK_VAR(tmp40,"tmp40");
										HX_STACK_LINE(1174)
										...
										if ((tmp41)){
											...
											{
												HX_STACK_LINE(1174)
												::lime::utils::ArrayBufferView tmp43 = ::lime::math::color::_RGBA::RGBA_Impl__obj::__alpha16;		HX_STACK_VAR(tmp43,"tmp43");
												HX_STACK_LINE(1174)
												::lime::utils::ArrayBufferView this1 = tmp43;		HX_STACK_VAR(this1,"this1");
												HX_STACK_LINE(1174)
											...
											{
												HX_STACK_LINE(1174)
												int tmp43 = (int(_color) >> int((int)24));		HX_STACK_VAR(tmp43,"tmp43");
												HX_STACK_LINE(1174)
												int tmp44 = tmp43;		HX_STACK_VAR(tmp44,"tmp44");
												HX_STACK_LINE(1174)
												int tmp45 = (int(tmp44) & int((int)255));		HX_STACK_VAR(tmp45,"tmp45");
												...
												HX_STACK_LINE(1174)
												int tmp52 = (int(_color) >> int((int)16));		HX_STACK_VAR(tmp52,"tmp52");
												HX_STACK_LINE(1174)
												int tmp53 = tmp52;		HX_STACK_VAR(tmp53,"tmp53");
												HX_STACK_LINE(1174)
												int tmp54 = (int(tmp53) & int((int)255));		HX_STACK_VAR(tmp54,"tmp54");
												...
												int tmp60 = (int(tmp59) << int((int)16));		HX_STACK_VAR(tmp60,"tmp60");
												HX_STACK_LINE(1174)
												int tmp61 = (int(tmp51) | int(tmp60));		HX_STACK_VAR(tmp61,"tmp61");
												HX_STACK_LINE(1174)
												int tmp62 = (int(_color) >> int((int)8));		HX_STACK_VAR(tmp62,"tmp62");
												HX_STACK_LINE(1174)
												int tmp63 = tmp62;		HX_STACK_VAR(tmp63,"tmp63");
												HX_STACK_LINE(1174)
												int tmp64 = (int(tmp63) & int((int)255));		HX_STACK_VAR(tmp64,"tmp64");
												...
												int tmp69 = (int(tmp68) & int((int)255));		HX_STACK_VAR(tmp69,"tmp69");
												HX_STACK_LINE(1174)
												int tmp70 = (int(tmp69) << int((int)8));		HX_STACK_VAR(tmp70,"tmp70");
												HX_STACK_LINE(1174)
												int tmp71 = (int(tmp61) | int(tmp70));		HX_STACK_VAR(tmp71,"tmp71");
												HX_STACK_LINE(1174)
												int tmp72 = (int(_color) & int((int)255));		HX_STACK_VAR(tmp72,"tmp72");
												HX_STACK_LINE(1174)
												int tmp73 = tmp72;		HX_STACK_VAR(tmp73,"tmp73");
												HX_STACK_LINE(1174)
												int tmp74 = (int(tmp73) & int((int)255));		HX_STACK_VAR(tmp74,"tmp74");
												HX_STACK_LINE(1174)
												int tmp75 = (int(tmp71) | int(tmp74));		HX_STACK_VAR(tmp75,"tmp75");
												HX_STACK_LINE(1174)
												_color = tmp75;
											}
										}
							...
							if ((tmp35)){
								...
								if ((tmp36)){
									...
									if ((tmp39)){
										HX_STACK_LINE(1179)
										bool tmp40 = (srcPixel != (int)0);		HX_STACK_VAR(tmp40,"tmp40");
										HX_STACK_LINE(1179)
										if ((tmp40)){
											HX_STACK_LINE(1179)
											srcPixel = (int)0;
										...
										HX_STACK_LINE(1179)
										int tmp40 = (int(srcPixel) & int((int)255));		HX_STACK_VAR(tmp40,"tmp40");
										HX_STACK_LINE(1179)
										int tmp41 = tmp40;		HX_STACK_VAR(tmp41,"tmp41");
										HX_STACK_LINE(1179)
										bool tmp42 = (tmp41 != (int)255);		HX_STACK_VAR(tmp42,"tmp42");
										...
										if ((tmp42)){
											...
											{
												HX_STACK_LINE(1179)
												int tmp44 = (int(srcPixel) >> int((int)24));		HX_STACK_VAR(tmp44,"tmp44");
												HX_STACK_LINE(1179)
												int tmp45 = tmp44;		HX_STACK_VAR(tmp45,"tmp45");
												HX_STACK_LINE(1179)
												int tmp46 = (int(tmp45) & int((int)255));		HX_STACK_VAR(tmp46,"tmp46");
												...
												int tmp52 = (int(tmp51) << int((int)24));		HX_STACK_VAR(tmp52,"tmp52");
												HX_STACK_LINE(1179)
												int tmp53 = (int(srcPixel) >> int((int)16));		HX_STACK_VAR(tmp53,"tmp53");
												HX_STACK_LINE(1179)
												int tmp54 = tmp53;		HX_STACK_VAR(tmp54,"tmp54");
												HX_STACK_LINE(1179)
												int tmp55 = (int(tmp54) & int((int)255));		HX_STACK_VAR(tmp55,"tmp55");
												...
												int tmp62 = (int(tmp52) | int(tmp61));		HX_STACK_VAR(tmp62,"tmp62");
												HX_STACK_LINE(1179)
												int tmp63 = (int(srcPixel) >> int((int)8));		HX_STACK_VAR(tmp63,"tmp63");
												HX_STACK_LINE(1179)
												int tmp64 = tmp63;		HX_STACK_VAR(tmp64,"tmp64");
												HX_STACK_LINE(1179)
												int tmp65 = (int(tmp64) & int((int)255));		HX_STACK_VAR(tmp65,"tmp65");
												...
												int tmp72 = (int(tmp62) | int(tmp71));		HX_STACK_VAR(tmp72,"tmp72");
												HX_STACK_LINE(1179)
												int tmp73 = (int(srcPixel) & int((int)255));		HX_STACK_VAR(tmp73,"tmp73");
												HX_STACK_LINE(1179)
												int tmp74 = tmp73;		HX_STACK_VAR(tmp74,"tmp74");
												HX_STACK_LINE(1179)
												int tmp75 = (int(tmp74) & int((int)255));		HX_STACK_VAR(tmp75,"tmp75");
...
int ImageDataUtil_obj::__pixelCompare( int n1,int n2){
	...
	HX_STACK_LINE(1239)
	int tmp3 = tmp;		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(1239)
	int tmp4 = (int(tmp3) & int((int)255));		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(1239)
	tmp1 = tmp4;
	HX_STACK_LINE(1240)
	int tmp5 = (int(n2) >> int((int)24));		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(1240)
	int tmp6 = tmp5;		HX_STACK_VAR(tmp6,"tmp6");
	HX_STACK_LINE(1240)
	int tmp7 = (int(tmp6) & int((int)255));		HX_STACK_VAR(tmp7,"tmp7");
	...
	tmp2 = tmp7;
	HX_STACK_LINE(1242)
	bool tmp8 = (tmp1 != tmp2);		HX_STACK_VAR(tmp8,"tmp8");
	HX_STACK_LINE(1242)
	if ((tmp8)){
		HX_STACK_LINE(1244)
		...
		{
			HX_STACK_LINE(1244)
			bool tmp10 = (tmp1 < (int)0);		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(1244)
			bool aNeg = tmp10;		HX_STACK_VAR(aNeg,"aNeg");
			HX_STACK_LINE(1244)
			bool tmp11 = (tmp2 < (int)0);		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(1244)
		...
		HX_STACK_LINE(1248)
		int tmp9 = (int(n1) >> int((int)16));		HX_STACK_VAR(tmp9,"tmp9");
		HX_STACK_LINE(1248)
		int tmp10 = tmp9;		HX_STACK_VAR(tmp10,"tmp10");
		HX_STACK_LINE(1248)
		int tmp11 = (int(tmp10) & int((int)255));		HX_STACK_VAR(tmp11,"tmp11");
		...
		tmp1 = tmp11;
		HX_STACK_LINE(1249)
		int tmp12 = (int(n2) >> int((int)16));		HX_STACK_VAR(tmp12,"tmp12");
		HX_STACK_LINE(1249)
		int tmp13 = tmp12;		HX_STACK_VAR(tmp13,"tmp13");
		HX_STACK_LINE(1249)
		int tmp14 = (int(tmp13) & int((int)255));		HX_STACK_VAR(tmp14,"tmp14");
		...
		tmp2 = tmp14;
		HX_STACK_LINE(1251)
		bool tmp15 = (tmp1 != tmp2);		HX_STACK_VAR(tmp15,"tmp15");
		HX_STACK_LINE(1251)
		if ((tmp15)){
			HX_STACK_LINE(1253)
			...
			{
				HX_STACK_LINE(1253)
				bool tmp17 = (tmp1 < (int)0);		HX_STACK_VAR(tmp17,"tmp17");
				HX_STACK_LINE(1253)
				bool aNeg = tmp17;		HX_STACK_VAR(aNeg,"aNeg");
				HX_STACK_LINE(1253)
				bool tmp18 = (tmp2 < (int)0);		HX_STACK_VAR(tmp18,"tmp18");
				HX_STACK_LINE(1253)
			...
			HX_STACK_LINE(1257)
			int tmp16 = (int(n1) >> int((int)8));		HX_STACK_VAR(tmp16,"tmp16");
			HX_STACK_LINE(1257)
			int tmp17 = tmp16;		HX_STACK_VAR(tmp17,"tmp17");
			HX_STACK_LINE(1257)
			int tmp18 = (int(tmp17) & int((int)255));		HX_STACK_VAR(tmp18,"tmp18");
			...
			tmp1 = tmp18;
			HX_STACK_LINE(1258)
			int tmp19 = (int(n2) >> int((int)8));		HX_STACK_VAR(tmp19,"tmp19");
			HX_STACK_LINE(1258)
			int tmp20 = tmp19;		HX_STACK_VAR(tmp20,"tmp20");
			HX_STACK_LINE(1258)
			int tmp21 = (int(tmp20) & int((int)255));		HX_STACK_VAR(tmp21,"tmp21");
			...
			tmp2 = tmp21;
			HX_STACK_LINE(1260)
			bool tmp22 = (tmp1 != tmp2);		HX_STACK_VAR(tmp22,"tmp22");
			HX_STACK_LINE(1260)
			if ((tmp22)){
				HX_STACK_LINE(1262)
				...
				{
					HX_STACK_LINE(1262)
					bool tmp24 = (tmp1 < (int)0);		HX_STACK_VAR(tmp24,"tmp24");
					HX_STACK_LINE(1262)
					bool aNeg = tmp24;		HX_STACK_VAR(aNeg,"aNeg");
					HX_STACK_LINE(1262)
					bool tmp25 = (tmp2 < (int)0);		HX_STACK_VAR(tmp25,"tmp25");
					HX_STACK_LINE(1262)
					bool bNeg = tmp25;		HX_STACK_VAR(bNeg,"bNeg");
					HX_STACK_LINE(1262)
					bool tmp26 = (aNeg != bNeg);		HX_STACK_VAR(tmp26,"tmp26");
					HX_STACK_LINE(1262)
					if ((tmp26)){
						HX_STACK_LINE(1262)
						tmp23 = aNeg;
				...
				HX_STACK_LINE(1266)
				int tmp23 = (int(n1) & int((int)255));		HX_STACK_VAR(tmp23,"tmp23");
				HX_STACK_LINE(1266)
				tmp1 = tmp23;
				HX_STACK_LINE(1267)
				int tmp24 = (int(n2) & int((int)255));		HX_STACK_VAR(tmp24,"tmp24");
				HX_STACK_LINE(1267)
				tmp2 = tmp24;
				HX_STACK_LINE(1269)
				bool tmp25 = (tmp1 != tmp2);		HX_STACK_VAR(tmp25,"tmp25");
				HX_STACK_LINE(1269)
				if ((tmp25)){
					HX_STACK_LINE(1271)
					...
					{
						HX_STACK_LINE(1271)
						bool tmp27 = (tmp1 < (int)0);		HX_STACK_VAR(tmp27,"tmp27");
						HX_STACK_LINE(1271)
						bool aNeg = tmp27;		HX_STACK_VAR(aNeg,"aNeg");
						HX_STACK_LINE(1271)
						bool tmp28 = (tmp2 < (int)0);		HX_STACK_VAR(tmp28,"tmp28");
						HX_STACK_LINE(1271)
