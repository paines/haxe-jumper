...
{
	HX_STACK_LINE(15)
	this->onRender = ::lime::app::_Event_Void_Void_obj::__new();
	HX_STACK_LINE(14)
	this->onContextRestored = ::lime::app::_Event_lime_graphics_RenderContext_Void_obj::__new();
	HX_STACK_LINE(13)
	this->onContextLost = ::lime::app::_Event_Void_Void_obj::__new();
	HX_STACK_LINE(24)
	this->window = window;
	HX_STACK_LINE(26)
