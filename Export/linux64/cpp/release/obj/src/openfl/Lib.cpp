...
Dynamic Lib_obj::as( Dynamic v,::hx::Class c){
	HX_STACK_FRAME("openfl.Lib","as",0x3965ffb9,"openfl.Lib.as","openfl/Lib.hx",31,0x62fb7c98)
	HX_STACK_ARG(v,"v")
	HX_STACK_ARG(c,"c")
	HX_STACK_LINE(36)
...
::openfl::display::MovieClip Lib_obj::attach( ::String name){
	HX_STACK_FRAME("openfl.Lib","attach",0xe350160c,"openfl.Lib.attach","openfl/Lib.hx",42,0x62fb7c98)
...
int Lib_obj::getTimer( ){
	HX_STACK_FRAME("openfl.Lib","getTimer",0xd73d4956,"openfl.Lib.getTimer","openfl/Lib.hx",81,0x62fb7c98)
	HX_STACK_LINE(86)
...
{
		HX_STACK_FRAME("openfl.Lib","getURL",0xa66862c0,"openfl.Lib.getURL","openfl/Lib.hx",92,0x62fb7c98)
		...
		HX_STACK_LINE(105)
		::String tmp1 = request->url;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(105)
		::lime::tools::helpers::ProcessHelper_obj::openURL(tmp1);
	}
return null();
}
...
{
		HX_STACK_FRAME("openfl.Lib","notImplemented",0x6ff873b6,"openfl.Lib.notImplemented","openfl/Lib.hx",111,0x62fb7c98)
		HX_STACK_ARG(posInfo,"posInfo")
		HX_STACK_LINE(113)
		::String tmp = (posInfo->__Field(HX_HCSTRING("className","\xa3","\x92","\x3d","\xdc"), hx::paccDynamic ) + HX_HCSTRING(".","\x2e","\x00","\x00","\x00"));		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(113)
		::String tmp1 = posInfo->__Field(HX_HCSTRING("methodName","\xcc","\x19","\x0f","\x12"), hx::paccDynamic );		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(113)
		::String tmp2 = (tmp + tmp1);		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(113)
		::String api = tmp2;		HX_STACK_VAR(api,"api");
		HX_STACK_LINE(115)
		::haxe::ds::StringMap tmp3 = ::openfl::Lib_obj::__sentWarnings;		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(115)
		::String tmp4 = api;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(115)
		...
		if ((tmp6)){
			HX_STACK_LINE(117)
			::haxe::ds::StringMap tmp7 = ::openfl::Lib_obj::__sentWarnings;		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(117)
			::String tmp8 = api;		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(117)
			tmp7->set(tmp8,true);
			HX_STACK_LINE(119)
			::String tmp9 = (posInfo->__Field(HX_HCSTRING("methodName","\xcc","\x19","\x0f","\x12"), hx::paccDynamic ) + HX_HCSTRING(" is not implemented","\x1f","\x12","\xd2","\xb9"));		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(119)
			Dynamic tmp10 = posInfo;		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(119)
...
{
		HX_STACK_FRAME("openfl.Lib","preventDefaultTouchMove",0x0727aa40,"openfl.Lib.preventDefaultTouchMove","openfl/Lib.hx",126,0x62fb7c98)
	}
return null();
}
...
{
		HX_STACK_FRAME("openfl.Lib","trace",0xeba99a1e,"openfl.Lib.trace","openfl/Lib.hx",148,0x62fb7c98)
		HX_STACK_ARG(arg,"arg")
		HX_STACK_LINE(150)
		Dynamic tmp = arg;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(150)
		Dynamic tmp1 = hx::SourceInfo(HX_HCSTRING("Lib.hx","\xb9","\x80","\x1c","\x19"),150,HX_HCSTRING("openfl.Lib","\x47","\x43","\x57","\x2f"),HX_HCSTRING("trace","\x85","\x8e","\x1f","\x16"));		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(150)
...
struct _Function_0_1{
	inline static ::haxe::ds::StringMap Block( ){
		HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/Lib.hx",28,0x62fb7c98)
		{
			HX_STACK_LINE(28)
