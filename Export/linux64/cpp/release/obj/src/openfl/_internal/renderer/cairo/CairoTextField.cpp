...
Void CairoTextField_obj::render( ::openfl::text::TextField textField,::openfl::_internal::renderer::RenderSession renderSession,::openfl::geom::Matrix transform){
{
		...
		if ((tmp15)){
			...
			HX_STACK_LINE(318)
			int tmp16 = textField->__caretIndex;		HX_STACK_VAR(tmp16,"tmp16");
			HX_STACK_LINE(318)
			...
			if ((tmp21)){
				HX_STACK_LINE(320)
				int tmp22 = textField->get_scrollH();		HX_STACK_VAR(tmp22,"tmp22");
				HX_STACK_LINE(320)
				int tmp23 = -(tmp22);		HX_STACK_VAR(tmp23,"tmp23");
				HX_STACK_LINE(320)
				int scrollX = tmp23;		HX_STACK_VAR(scrollX,"scrollX");
				HX_STACK_LINE(321)
				Float scrollY = ((Float)0.0);		HX_STACK_VAR(scrollY,"scrollY");
				HX_STACK_LINE(323)
				{
					...
					while((true)){
						...
						HX_STACK_LINE(325)
						Float tmp29 = textEngine->lineHeights->__get(i);		HX_STACK_VAR(tmp29,"tmp29");
						HX_STACK_LINE(325)
						hx::SubEq(scrollY,tmp29);
					}
				}
				HX_STACK_LINE(329)
				::openfl::text::TextFormat tmp24 = textField->get_defaultTextFormat();		HX_STACK_VAR(tmp24,"tmp24");
				HX_STACK_LINE(329)
				Dynamic color = tmp24->color;		HX_STACK_VAR(color,"color");
				HX_STACK_LINE(330)
				int tmp25 = (int(color) & int((int)16711680));		HX_STACK_VAR(tmp25,"tmp25");
				HX_STACK_LINE(330)
				int tmp26 = hx::UShr(tmp25,(int)16);		HX_STACK_VAR(tmp26,"tmp26");
				HX_STACK_LINE(330)
				Float tmp27 = (Float(tmp26) / Float((int)255));		HX_STACK_VAR(tmp27,"tmp27");
				HX_STACK_LINE(330)
				Float r = tmp27;		HX_STACK_VAR(r,"r");
				HX_STACK_LINE(331)
				int tmp28 = (int(color) & int((int)65280));		HX_STACK_VAR(tmp28,"tmp28");
				HX_STACK_LINE(331)
				int tmp29 = hx::UShr(tmp28,(int)8);		HX_STACK_VAR(tmp29,"tmp29");
				HX_STACK_LINE(331)
				Float tmp30 = (Float(tmp29) / Float((int)255));		HX_STACK_VAR(tmp30,"tmp30");
				HX_STACK_LINE(331)
				Float g = tmp30;		HX_STACK_VAR(g,"g");
				HX_STACK_LINE(332)
				...
				HX_STACK_LINE(334)
				Float tmp33 = r;		HX_STACK_VAR(tmp33,"tmp33");
				HX_STACK_LINE(334)
				Float tmp34 = g;		HX_STACK_VAR(tmp34,"tmp34");
				HX_STACK_LINE(334)
				Float tmp35 = b;		HX_STACK_VAR(tmp35,"tmp35");
				HX_STACK_LINE(334)
				cairo->setSourceRGB(tmp33,tmp34,tmp35);
				HX_STACK_LINE(336)
				cairo->newPath();
				HX_STACK_LINE(337)
				Float tmp36 = (scrollX + ((Float)2.5));		HX_STACK_VAR(tmp36,"tmp36");
				HX_STACK_LINE(337)
				Float tmp37 = (scrollY + ((Float)2.5));		HX_STACK_VAR(tmp37,"tmp37");
				HX_STACK_LINE(337)
				cairo->moveTo(tmp36,tmp37);
				HX_STACK_LINE(338)
				cairo->set_lineWidth((int)1);
				HX_STACK_LINE(339)
				Float tmp38 = (scrollX + ((Float)2.5));		HX_STACK_VAR(tmp38,"tmp38");
				HX_STACK_LINE(339)
				Float tmp39 = scrollY;		HX_STACK_VAR(tmp39,"tmp39");
				HX_STACK_LINE(339)
				::openfl::text::TextFormat tmp40 = textField->get_defaultTextFormat();		HX_STACK_VAR(tmp40,"tmp40");
				HX_STACK_LINE(339)
				Float tmp41 = ::openfl::_internal::text::TextEngine_obj::getFormatHeight(tmp40);		HX_STACK_VAR(tmp41,"tmp41");
				HX_STACK_LINE(339)
				Float tmp42 = (tmp39 + tmp41);		HX_STACK_VAR(tmp42,"tmp42");
				HX_STACK_LINE(339)
				Float tmp43 = (tmp42 - (int)1);		HX_STACK_VAR(tmp43,"tmp43");
				HX_STACK_LINE(339)
				cairo->lineTo(tmp38,tmp43);
				HX_STACK_LINE(340)
				cairo->stroke();
				HX_STACK_LINE(341)
				cairo->closePath();
