...
{
		HX_STACK_FRAME("openfl._internal.renderer.opengl.GLStage3D","render",0x8add30de,"openfl._internal.renderer.opengl.GLStage3D.render","openfl/_internal/renderer/opengl/GLStage3D.hx",14,0x575148fa)
