					...
					if ((tmp11)){
						...
						if ((tmp12)){
							...
							if ((tmp13)){
								...
								HX_STACK_LINE(471)
								bool tmp14 = (bytes != null());		HX_STACK_VAR(tmp14,"tmp14");
								HX_STACK_LINE(471)
								if ((tmp14)){
									HX_STACK_LINE(471)
...
int surfaceSelector = __o_surfaceSelector.Default(0);
	HX_STACK_FRAME("openfl.display3D.Context3D","setRenderToTexture",0x25c5d54f,"openfl.display3D.Context3D.setRenderToTexture","openfl/display3D/Context3D.hx",609,0xc899cbb9)
	HX_STACK_THIS(this)
	...
	HX_STACK_ARG(surfaceSelector,"surfaceSelector")
{
		...
		if ((tmp7)){
			...
			if ((tmp8)){
				HX_STACK_LINE(708)
				Dynamic tmp9 = hx::SourceInfo(HX_HCSTRING("Context3D.hx","\x7e","\x2e","\xcf","\x45"),708,HX_HCSTRING("openfl.display3D.Context3D","\xa7","\xbf","\xa0","\x2f"),HX_HCSTRING("setRenderToTexture","\xe8","\x2c","\x92","\x46"));		HX_STACK_VAR(tmp9,"tmp9");
				HX_STACK_LINE(708)
...
{
		HX_STACK_FRAME("openfl.display3D.Context3D","setSamplerStateAt",0x9f8ad1f7,"openfl.display3D.Context3D.setSamplerStateAt","openfl/display3D/Context3D.hx",731,0xc899cbb9)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("openfl.display3D.Context3D","setScissorRectangle",0x712bb5ee,"openfl.display3D.Context3D.setScissorRectangle","openfl/display3D/Context3D.hx",828,0xc899cbb9)
		HX_STACK_THIS(this)
...
Dynamic actionOnDepthPassStencilFail = __o_actionOnDepthPassStencilFail.Default(5);
	HX_STACK_FRAME("openfl.display3D.Context3D","setStencilActions",0x1fe08e1c,"openfl.display3D.Context3D.setStencilActions","openfl/display3D/Context3D.hx",836,0xc899cbb9)
	HX_STACK_THIS(this)
...
int writeMask = __o_writeMask.Default(255);
	HX_STACK_FRAME("openfl.display3D.Context3D","setStencilReferenceValue",0xaa284f67,"openfl.display3D.Context3D.setStencilReferenceValue","openfl/display3D/Context3D.hx",845,0xc899cbb9)
	HX_STACK_THIS(this)
...
Dynamic format = __o_format.Default(4);
	HX_STACK_FRAME("openfl.display3D.Context3D","setVertexBufferAt",0xbb32fa52,"openfl.display3D.Context3D.setVertexBufferAt","openfl/display3D/Context3D.hx",870,0xc899cbb9)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("openfl.display3D.Context3D","__flushSamplerState",0xbb488366,"openfl.display3D.Context3D.__flushSamplerState","openfl/display3D/Context3D.hx",928,0xc899cbb9)
		HX_STACK_THIS(this)
		HX_STACK_LINE(930)
		...
		while((true)){
			...
			if ((tmp6)){
				...
				if ((tmp13)){
					...
					::openfl::_internal::stage3D::GLUtils_obj::CheckGLError();
					HX_STACK_LINE(952)
					::openfl::display3D::Program3D tmp14 = this->__program;		HX_STACK_VAR(tmp14,"tmp14");
					HX_STACK_LINE(952)
					int tmp15 = sampler;		HX_STACK_VAR(tmp15,"tmp15");
					HX_STACK_LINE(952)
					::openfl::_internal::stage3D::SamplerState tmp16 = tmp14->__getSamplerState(tmp15);		HX_STACK_VAR(tmp16,"tmp16");
					HX_STACK_LINE(952)
					::openfl::_internal::stage3D::SamplerState state = tmp16;		HX_STACK_VAR(state,"state");
					HX_STACK_LINE(954)
					bool tmp17 = (state != null());		HX_STACK_VAR(tmp17,"tmp17");
					HX_STACK_LINE(954)
					if ((tmp17)){
						HX_STACK_LINE(956)
						::openfl::_internal::stage3D::SamplerState tmp18 = state;		HX_STACK_VAR(tmp18,"tmp18");
						HX_STACK_LINE(956)
						texture->__setSamplerState(tmp18);
					}
				}
				else{
					HX_STACK_LINE(962)
...
int Context3D_obj::__getGLCompareMode( Dynamic compareMode){
	HX_STACK_FRAME("openfl.display3D.Context3D","__getGLCompareMode",0xec8b55b4,"openfl.display3D.Context3D.__getGLCompareMode","openfl/display3D/Context3D.hx",978,0xc899cbb9)
	HX_STACK_THIS(this)
	HX_STACK_ARG(compareMode,"compareMode")
	HX_STACK_LINE(980)
...
int Context3D_obj::__getGLStencilAction( Dynamic stencilAction){
	HX_STACK_FRAME("openfl.display3D.Context3D","__getGLStencilAction",0xdf4274de,"openfl.display3D.Context3D.__getGLStencilAction","openfl/display3D/Context3D.hx",997,0xc899cbb9)
	HX_STACK_THIS(this)
...
bool Context3D_obj::__hasGLExtension( ::String name){
	HX_STACK_FRAME("openfl.display3D.Context3D","__hasGLExtension",0xeedeef47,"openfl.display3D.Context3D.__hasGLExtension","openfl/display3D/Context3D.hx",1016,0xc899cbb9)
	HX_STACK_THIS(this)
	...
	struct _Function_1_1{
		inline static Array< ::String > Block( ){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","openfl/display3D/Context3D.hx",1018,0xc899cbb9)
			{
				HX_STACK_LINE(1018)
...
{
		HX_STACK_FRAME("openfl.display3D.Context3D","__setViewport",0x44998801,"openfl.display3D.Context3D.__setViewport","openfl/display3D/Context3D.hx",1023,0xc899cbb9)
		HX_STACK_THIS(this)
...
int Context3D_obj::__statsAdd( int stat,int value){
	HX_STACK_FRAME("openfl.display3D.Context3D","__statsAdd",0x9eeb6dc9,"openfl.display3D.Context3D.__statsAdd","openfl/display3D/Context3D.hx",1035,0xc899cbb9)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("openfl.display3D.Context3D","__statsClear",0xef112735,"openfl.display3D.Context3D.__statsClear","openfl/display3D/Context3D.hx",1043,0xc899cbb9)
		HX_STACK_THIS(this)
		HX_STACK_ARG(stat,"stat")
		HX_STACK_LINE(1045)
		::openfl::_Vector::IntVector tmp = this->__stats;		HX_STACK_VAR(tmp,"tmp");
...
{
		HX_STACK_FRAME("openfl.display3D.Context3D","__statsDecrement",0xf8079fbb,"openfl.display3D.Context3D.__statsDecrement","openfl/display3D/Context3D.hx",1052,0xc899cbb9)
		HX_STACK_THIS(this)
		HX_STACK_ARG(stat,"stat")
		HX_STACK_LINE(1052)
		int _g = stat;		HX_STACK_VAR(_g,"_g");
...
{
		HX_STACK_FRAME("openfl.display3D.Context3D","__statsIncrement",0x1984afd7,"openfl.display3D.Context3D.__statsIncrement","openfl/display3D/Context3D.hx",1059,0xc899cbb9)
		HX_STACK_THIS(this)
		HX_STACK_ARG(stat,"stat")
		HX_STACK_LINE(1059)
		int _g = stat;		HX_STACK_VAR(_g,"_g");
...
{
		HX_STACK_FRAME("openfl.display3D.Context3D","__statsSendToTelemetry",0x95ec20be,"openfl.display3D.Context3D.__statsSendToTelemetry","openfl/display3D/Context3D.hx",1064,0xc899cbb9)
		HX_STACK_THIS(this)
	}
return null();
}
...
int Context3D_obj::__statsSubtract( int stat,int value){
	HX_STACK_FRAME("openfl.display3D.Context3D","__statsSubtract",0xc326b86c,"openfl.display3D.Context3D.__statsSubtract","openfl/display3D/Context3D.hx",1113,0xc899cbb9)
	HX_STACK_THIS(this)
	HX_STACK_ARG(stat,"stat")
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(1115)
...
{
		HX_STACK_FRAME("openfl.display3D.Context3D","__updateDepthAndStencilState",0x7fba6d19,"openfl.display3D.Context3D.__updateDepthAndStencilState","openfl/display3D/Context3D.hx",1120,0xc899cbb9)
		HX_STACK_THIS(this)
		HX_STACK_LINE(1122)
...
{
		HX_STACK_FRAME("openfl.display3D.Context3D","__updateBlendFactors",0x00141f63,"openfl.display3D.Context3D.__updateBlendFactors","openfl/display3D/Context3D.hx",1143,0xc899cbb9)
		HX_STACK_THIS(this)
		HX_STACK_LINE(1145)
		::openfl::_internal::stage3D::Context3DStateCache tmp = ::openfl::display3D::Context3D_obj::__stateCache;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(1145)
...
{
		HX_STACK_FRAME("openfl.display3D.Context3D","__updateScissorRectangle",0x17db8763,"openfl.display3D.Context3D.__updateScissorRectangle","openfl/display3D/Context3D.hx",1191,0xc899cbb9)
		HX_STACK_THIS(this)
		HX_STACK_LINE(1193)
...
{
		HX_STACK_FRAME("openfl.display3D.Context3D","__updateBackbufferViewport",0x1ffcf0dd,"openfl.display3D.Context3D.__updateBackbufferViewport","openfl/display3D/Context3D.hx",1236,0xc899cbb9)
		HX_STACK_THIS(this)
		HX_STACK_LINE(1238)
		::openfl::display3D::textures::TextureBase tmp = this->__renderToTexture;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(1238)
...
bool Context3D_obj::set_enableErrorChecking( bool value){
	HX_STACK_FRAME("openfl.display3D.Context3D","set_enableErrorChecking",0x101dce5b,"openfl.display3D.Context3D.set_enableErrorChecking","openfl/display3D/Context3D.hx",1247,0xc899cbb9)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(1249)
