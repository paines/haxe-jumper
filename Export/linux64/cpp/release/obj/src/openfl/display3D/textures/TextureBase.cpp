...
HX_STACK_ARG(target,"target")
{
	...
	HX_STACK_LINE(51)
	Dynamic tmp3 = ::openfl::display3D::textures::TextureBase_obj::__isGLES;		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(51)
	...
	if ((tmp4)){
		...
		HX_STACK_LINE(54)
		int tmp5 = version.indexOf(HX_HCSTRING("OpenGL ES","\x5f","\xcb","\x92","\x95"),null());		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(54)
		...
		if ((tmp7)){
			HX_STACK_LINE(54)
			int tmp9 = version.indexOf(HX_HCSTRING("WebGL","\x99","\x9f","\xe9","\x5a"),null());		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(54)
		...
		HX_STACK_LINE(54)
		::openfl::display3D::textures::TextureBase_obj::__isGLES = tmp8;
	}
	HX_STACK_LINE(58)
	Dynamic tmp5 = ::openfl::display3D::textures::TextureBase_obj::__isGLES;		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(58)
