						...
						if ((tmp14)){
							...
							if ((tmp15)){
								...
								HX_STACK_LINE(63)
								{
									...
									HX_STACK_LINE(63)
									bool tmp18 = (offset < (int)0);		HX_STACK_VAR(tmp18,"tmp18");
									HX_STACK_LINE(63)
									if ((tmp18)){
										HX_STACK_LINE(63)
									...
									HX_STACK_LINE(63)
									int tmp19 = hx::Mod(offset,_this->bytesPerElement);		HX_STACK_VAR(tmp19,"tmp19");
									HX_STACK_LINE(63)
									...
									if ((tmp21)){
										HX_STACK_LINE(63)
										int tmp22 = (bufferByteLength - offset);		HX_STACK_VAR(tmp22,"tmp22");
										HX_STACK_LINE(63)
										newByteLength = tmp22;
										HX_STACK_LINE(63)
										...
										HX_STACK_LINE(63)
										int tmp22 = (length * _this->bytesPerElement);		HX_STACK_VAR(tmp22,"tmp22");
										HX_STACK_LINE(63)
										newByteLength = tmp22;
										HX_STACK_LINE(63)
										int tmp23 = (offset + newByteLength);		HX_STACK_VAR(tmp23,"tmp23");
										HX_STACK_LINE(63)
