...
Void RectangleTexture_obj::uploadFromBitmapData( ::openfl::display::BitmapData source){
{
		...
		HX_STACK_LINE(45)
		::lime::utils::ArrayBufferView tmp2 = image->get_data();		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(45)
...
{
		HX_STACK_FRAME("openfl.display3D.textures.RectangleTexture","uploadFromByteArray",0xfd7a0ae1,"openfl.display3D.textures.RectangleTexture.uploadFromByteArray","openfl/display3D/textures/RectangleTexture.hx",50,0x83565556)
		HX_STACK_THIS(this)
