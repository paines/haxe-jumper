...
{
		HX_STACK_FRAME("openfl.media.Sound","close",0xfbd9cbd1,"openfl.media.Sound.close","openfl/media/Sound.hx",50,0x46a01619)
		HX_STACK_THIS(this)
		HX_STACK_LINE(52)
...
Void Sound_obj::load( ::openfl::net::URLRequest stream,::openfl::media::SoundLoaderContext context){
{
		...
		HX_STACK_LINE(95)
		::lime::app::Future tmp1 = ::lime::audio::AudioBuffer_obj::loadFromFile(tmp);		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(95)
		...
		Void run(Dynamic _){
			HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","openfl/media/Sound.hx",95,0x46a01619)
			HX_STACK_ARG(_,"_")
			{
				HX_STACK_LINE(95)
...
bool forcePlayAsMusic = __o_forcePlayAsMusic.Default(false);
	HX_STACK_FRAME("openfl.media.Sound","loadCompressedDataFromByteArray",0x8f237f2f,"openfl.media.Sound.loadCompressedDataFromByteArray","openfl/media/Sound.hx",102,0x46a01619)
	HX_STACK_THIS(this)
...
Float sampleRate = __o_sampleRate.Default(44100);
	HX_STACK_FRAME("openfl.media.Sound","loadPCMFromByteArray",0xb6cc217a,"openfl.media.Sound.loadPCMFromByteArray","openfl/media/Sound.hx",111,0x46a01619)
	HX_STACK_THIS(this)
	HX_STACK_ARG(bytes,"bytes")
	...
	HX_STACK_ARG(sndTransform,"sndTransform")
{
		...
		HX_STACK_LINE(140)
		Float tmp13 = startTime;		HX_STACK_VAR(tmp13,"tmp13");
		HX_STACK_LINE(140)
...
::openfl::media::ID3Info Sound_obj::get_id3( ){
	HX_STACK_FRAME("openfl.media.Sound","get_id3",0xac6378e8,"openfl.media.Sound.get_id3","openfl/media/Sound.hx",162,0x46a01619)
	HX_STACK_THIS(this)
	HX_STACK_LINE(164)
...
int Sound_obj::get_length( ){
	HX_STACK_FRAME("openfl.media.Sound","get_length",0xcc37d5f6,"openfl.media.Sound.get_length","openfl/media/Sound.hx",169,0x46a01619)
	HX_STACK_THIS(this)
	HX_STACK_LINE(171)
	::lime::audio::AudioBuffer tmp = this->__buffer;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(171)
...
{
		HX_STACK_FRAME("openfl.media.Sound","AudioBuffer_onURLLoad",0x80e63186,"openfl.media.Sound.AudioBuffer_onURLLoad","openfl/media/Sound.hx",190,0x46a01619)
		HX_STACK_THIS(this)
...
::openfl::media::Sound Sound_obj::fromFile( ::String path){
	HX_STACK_FRAME("openfl.media.Sound","fromFile",0x06bfbe8d,"openfl.media.Sound.fromFile","openfl/media/Sound.hx",70,0x46a01619)
