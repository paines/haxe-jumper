...
{
HX_STACK_FRAME("openfl.filters.BitmapFilter","new",0x22686a4a,"openfl.filters.BitmapFilter.new","openfl/filters/BitmapFilter.hx",14,0x1697f5a4)
HX_STACK_THIS(this)
{
}
;
...
::openfl::filters::BitmapFilter BitmapFilter_obj::clone( ){
	HX_STACK_FRAME("openfl.filters.BitmapFilter","clone",0x8c417bc7,"openfl.filters.BitmapFilter.clone","openfl/filters/BitmapFilter.hx",21,0x1697f5a4)
	HX_STACK_THIS(this)
	HX_STACK_LINE(23)
...
{
		HX_STACK_FRAME("openfl.filters.BitmapFilter","__applyFilter",0xc6240310,"openfl.filters.BitmapFilter.__applyFilter","openfl/filters/BitmapFilter.hx",28,0x1697f5a4)
		HX_STACK_THIS(this)
...
::openfl::display::Shader BitmapFilter_obj::__initShader( ::openfl::_internal::renderer::RenderSession renderSession){
	HX_STACK_FRAME("openfl.filters.BitmapFilter","__initShader",0x9b1b6e4b,"openfl.filters.BitmapFilter.__initShader","openfl/filters/BitmapFilter.hx",35,0x1697f5a4)
	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC1(BitmapFilter_obj,__initShader,return )
