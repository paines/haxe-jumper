...
{
		HX_STACK_FRAME("openfl.display.Graphics","drawRoundRectComplex",0x06fa4dbb,"openfl.display.Graphics.drawRoundRectComplex","openfl/display/Graphics.hx",442,0x8d299ce7)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_ARG(y,"y")
		HX_STACK_ARG(width,"width")
		...
		HX_STACK_LINE(444)
		Dynamic tmp = hx::SourceInfo(HX_HCSTRING("Graphics.hx","\xb3","\x32","\x67","\x7f"),444,HX_HCSTRING("openfl.display.Graphics","\x35","\x67","\x20","\x87"),HX_HCSTRING("drawRoundRectComplex","\xe2","\x43","\x2c","\x11"));		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(444)
...
Void Graphics_obj::__update( ){
{
		...
		if ((tmp9)){
			HX_STACK_LINE(825)
			Float tmp10 = parentTransform->a;		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(825)
		...
		if ((tmp10)){
			HX_STACK_LINE(835)
			Float tmp11 = parentTransform->d;		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(835)
		...
		this->__height = tmp29;
		HX_STACK_LINE(860)
		int tmp30 = this->__width;		HX_STACK_VAR(tmp30,"tmp30");
		HX_STACK_LINE(860)
		...
		if ((tmp32)){
			HX_STACK_LINE(860)
			int tmp34 = this->__height;		HX_STACK_VAR(tmp34,"tmp34");
			HX_STACK_LINE(860)
		...
		HX_STACK_LINE(862)
		int tmp34 = this->__width;		HX_STACK_VAR(tmp34,"tmp34");
		HX_STACK_LINE(862)
		::openfl::geom::Rectangle tmp35 = this->__bounds;		HX_STACK_VAR(tmp35,"tmp35");
		HX_STACK_LINE(862)
		Float tmp36 = tmp35->width;		HX_STACK_VAR(tmp36,"tmp36");
		HX_STACK_LINE(862)
		Float tmp37 = (Float(tmp34) / Float(tmp36));		HX_STACK_VAR(tmp37,"tmp37");
		HX_STACK_LINE(862)
		::openfl::geom::Matrix tmp38 = this->__renderTransform;		HX_STACK_VAR(tmp38,"tmp38");
		HX_STACK_LINE(862)
		tmp38->a = tmp37;
		HX_STACK_LINE(863)
		int tmp39 = this->__height;		HX_STACK_VAR(tmp39,"tmp39");
		HX_STACK_LINE(863)
		::openfl::geom::Rectangle tmp40 = this->__bounds;		HX_STACK_VAR(tmp40,"tmp40");
		HX_STACK_LINE(863)
		Float tmp41 = tmp40->height;		HX_STACK_VAR(tmp41,"tmp41");
		HX_STACK_LINE(863)
		Float tmp42 = (Float(tmp39) / Float(tmp41));		HX_STACK_VAR(tmp42,"tmp42");
		HX_STACK_LINE(863)
		::openfl::geom::Matrix tmp43 = this->__renderTransform;		HX_STACK_VAR(tmp43,"tmp43");
		HX_STACK_LINE(863)
		tmp43->d = tmp42;
		HX_STACK_LINE(865)
		...
		HX_STACK_LINE(865)
		Float tmp46 = (Float((int)1) / Float(tmp45));		HX_STACK_VAR(tmp46,"tmp46");
		HX_STACK_LINE(865)
		::openfl::geom::Matrix tmp47 = this->__worldTransform;		HX_STACK_VAR(tmp47,"tmp47");
		HX_STACK_LINE(865)
		tmp47->a = tmp46;
		HX_STACK_LINE(866)
		::openfl::geom::Matrix tmp48 = this->__worldTransform;		HX_STACK_VAR(tmp48,"tmp48");
		HX_STACK_LINE(866)
		tmp48->b = (int)0;
		HX_STACK_LINE(867)
		...
		tmp49->c = (int)0;
		HX_STACK_LINE(868)
		::openfl::geom::Matrix tmp50 = this->__renderTransform;		HX_STACK_VAR(tmp50,"tmp50");
		HX_STACK_LINE(868)
		Float tmp51 = tmp50->d;		HX_STACK_VAR(tmp51,"tmp51");
		HX_STACK_LINE(868)
		...
		tmp53->d = tmp52;
		HX_STACK_LINE(869)
		::openfl::geom::Rectangle tmp54 = this->__bounds;		HX_STACK_VAR(tmp54,"tmp54");
		HX_STACK_LINE(869)
		::openfl::geom::Matrix tmp55 = this->__worldTransform;		HX_STACK_VAR(tmp55,"tmp55");
		HX_STACK_LINE(869)
		tmp55->tx = tmp54->x;
		HX_STACK_LINE(870)
		::openfl::geom::Rectangle tmp56 = this->__bounds;		HX_STACK_VAR(tmp56,"tmp56");
		HX_STACK_LINE(870)
		::openfl::geom::Matrix tmp57 = this->__worldTransform;		HX_STACK_VAR(tmp57,"tmp57");
		HX_STACK_LINE(870)
		tmp57->ty = tmp56->y;
		HX_STACK_LINE(871)
		::openfl::geom::Matrix tmp58 = this->__worldTransform;		HX_STACK_VAR(tmp58,"tmp58");
		HX_STACK_LINE(871)
		::openfl::display::DisplayObject tmp59 = this->__owner;		HX_STACK_VAR(tmp59,"tmp59");
		HX_STACK_LINE(871)
		::openfl::geom::Matrix tmp60 = tmp59->__renderTransform;		HX_STACK_VAR(tmp60,"tmp60");
		HX_STACK_LINE(871)
		tmp58->concat(tmp60);
	}
return null();
