...
bool InteractiveObject_obj::requestSoftKeyboard( ){
	...
	HX_STACK_THIS(this)
	HX_STACK_LINE(37)
	Dynamic tmp = hx::SourceInfo(HX_HCSTRING("InteractiveObject.hx","\x3d","\x87","\x79","\x89"),37,HX_HCSTRING("openfl.display.InteractiveObject","\x97","\x3a","\xcb","\xf4"),HX_HCSTRING("requestSoftKeyboard","\xa0","\xf5","\xa9","\xd4"));		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(37)
