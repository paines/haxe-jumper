		...
		if ((tmp4)){
			...
			if ((tmp7)){
				...
				if ((tmp12)){
					...
					HX_STACK_LINE(116)
					bool tmp16 = renderSession->allowSmoothing;		HX_STACK_VAR(tmp16,"tmp16");
					HX_STACK_LINE(116)
					bool tmp17;		HX_STACK_VAR(tmp17,"tmp17");
					HX_STACK_LINE(116)
					if ((tmp16)){
...
Void Bitmap_obj::__renderGL( ::openfl::_internal::renderer::RenderSession renderSession){
{
		...
		if ((tmp4)){
			...
			if ((tmp7)){
				...
				HX_STACK_LINE(151)
				Dynamic tmp8 = this->get_blendMode();		HX_STACK_VAR(tmp8,"tmp8");
				HX_STACK_LINE(151)
				renderSession->blendModeManager->setBlendMode(tmp8);
				HX_STACK_LINE(151)
				renderSession->maskManager->pushObject(hx::ObjectPtr<OBJ_>(this),null());
				HX_STACK_LINE(151)
				::openfl::display::Shader tmp9 = renderSession->filterManager->pushObject(hx::ObjectPtr<OBJ_>(this));		HX_STACK_VAR(tmp9,"tmp9");
				HX_STACK_LINE(151)
				::openfl::display::Shader shader = tmp9;		HX_STACK_VAR(shader,"shader");
				HX_STACK_LINE(151)
				::openfl::display::BitmapData tmp10 = this->bitmapData;		HX_STACK_VAR(tmp10,"tmp10");
				HX_STACK_LINE(151)
				...
				{
					HX_STACK_LINE(151)
					::openfl::display::BitmapData tmp18 = this->bitmapData;		HX_STACK_VAR(tmp18,"tmp18");
					HX_STACK_LINE(151)
					::lime::graphics::GLRenderContext tmp19 = gl;		HX_STACK_VAR(tmp19,"tmp19");
					HX_STACK_LINE(151)
					Float tmp20 = this->__worldAlpha;		HX_STACK_VAR(tmp20,"tmp20");
					HX_STACK_LINE(151)
					::lime::graphics::opengl::GLBuffer tmp21 = tmp18->getBuffer(tmp19,tmp20);		HX_STACK_VAR(tmp21,"tmp21");
					HX_STACK_LINE(151)
					::lime::graphics::opengl::GLBuffer buffer = tmp21;		HX_STACK_VAR(buffer,"buffer");
					HX_STACK_LINE(151)
...
Float Bitmap_obj::get_height( ){
	HX_STACK_FRAME("openfl.display.Bitmap","get_height",0x5901da25,"openfl.display.Bitmap.get_height","openfl/display/Bitmap.hx",203,0x461b2743)
	HX_STACK_THIS(this)
	HX_STACK_LINE(205)
	::openfl::display::BitmapData tmp = this->bitmapData;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(205)
...
Float Bitmap_obj::set_height( Float value){
	HX_STACK_FRAME("openfl.display.Bitmap","set_height",0x5c7f7899,"openfl.display.Bitmap.set_height","openfl/display/Bitmap.hx",216,0x461b2743)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(218)
	::openfl::display::BitmapData tmp = this->bitmapData;		HX_STACK_VAR(tmp,"tmp");
...
Float Bitmap_obj::get_width( ){
	HX_STACK_FRAME("openfl.display.Bitmap","get_width",0x2b347588,"openfl.display.Bitmap.get_width","openfl/display/Bitmap.hx",235,0x461b2743)
	HX_STACK_THIS(this)
	HX_STACK_LINE(237)
	::openfl::display::BitmapData tmp = this->bitmapData;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(237)
...
Float Bitmap_obj::set_width( Float value){
	HX_STACK_FRAME("openfl.display.Bitmap","set_width",0x0e856194,"openfl.display.Bitmap.set_width","openfl/display/Bitmap.hx",248,0x461b2743)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(250)
	::openfl::display::BitmapData tmp = this->bitmapData;		HX_STACK_VAR(tmp,"tmp");
