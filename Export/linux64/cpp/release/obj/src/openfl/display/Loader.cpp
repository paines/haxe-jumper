...
{
		HX_STACK_FRAME("openfl.display.Loader","close",0xeefbb487,"openfl.display.Loader.close","openfl/display/Loader.hx",37,0x7a569d9f)
		HX_STACK_THIS(this)
		HX_STACK_LINE(39)
		Dynamic tmp = hx::SourceInfo(HX_HCSTRING("Loader.hx","\x6b","\xe8","\xd2","\x9c"),39,HX_HCSTRING("openfl.display.Loader","\xfd","\x67","\xb0","\xe2"),HX_HCSTRING("close","\xb8","\x17","\x63","\x48"));		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(39)
...
bool gc = __o_gc.Default(true);
	HX_STACK_FRAME("openfl.display.Loader","unloadAndStop",0x25cb8709,"openfl.display.Loader.unloadAndStop","openfl/display/Loader.hx",178,0x7a569d9f)
	HX_STACK_THIS(this)
	HX_STACK_ARG(gc,"gc")
{
		HX_STACK_LINE(180)
		Dynamic tmp = hx::SourceInfo(HX_HCSTRING("Loader.hx","\x6b","\xe8","\xd2","\x9c"),180,HX_HCSTRING("openfl.display.Loader","\xfd","\x67","\xb0","\xe2"),HX_HCSTRING("unloadAndStop","\x3a","\x03","\x03","\x7a"));		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(180)
		::openfl::Lib_obj::notImplemented(tmp);
	}
return null();
