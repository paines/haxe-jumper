...
bool Sprite_obj::__hitTest( Float x,Float y,bool shapeFlag,Array< ::Dynamic > stack,bool interactiveOnly,::openfl::display::DisplayObject hitObject){
	...
	if ((tmp1)){
		...
		if ((tmp14)){
			HX_STACK_LINE(94)
			::openfl::geom::Point tmp15 = ::openfl::geom::Point_obj::__temp;		HX_STACK_VAR(tmp15,"tmp15");
			HX_STACK_LINE(94)
			::openfl::geom::Point point = tmp15;		HX_STACK_VAR(point,"point");
			HX_STACK_LINE(95)
			Float tmp16 = x;		HX_STACK_VAR(tmp16,"tmp16");
			HX_STACK_LINE(95)
			Float tmp17 = y;		HX_STACK_VAR(tmp17,"tmp17");
			HX_STACK_LINE(95)
			point->setTo(tmp16,tmp17);
			HX_STACK_LINE(96)
			{
				HX_STACK_LINE(96)
				::openfl::geom::Matrix tmp18 = this->__getRenderTransform();		HX_STACK_VAR(tmp18,"tmp18");
				HX_STACK_LINE(96)
				::openfl::geom::Matrix _this = tmp18;		HX_STACK_VAR(_this,"_this");
				HX_STACK_LINE(96)
				Float tmp19 = (_this->a * _this->d);		HX_STACK_VAR(tmp19,"tmp19");
				HX_STACK_LINE(96)
				Float tmp20 = (_this->b * _this->c);		HX_STACK_VAR(tmp20,"tmp20");
				HX_STACK_LINE(96)
				Float tmp21 = (tmp19 - tmp20);		HX_STACK_VAR(tmp21,"tmp21");
				HX_STACK_LINE(96)
				Float norm = tmp21;		HX_STACK_VAR(norm,"norm");
				HX_STACK_LINE(96)
				bool tmp22 = (norm == (int)0);		HX_STACK_VAR(tmp22,"tmp22");
				HX_STACK_LINE(96)
				if ((tmp22)){
					HX_STACK_LINE(96)
					...
					HX_STACK_LINE(96)
					Float tmp24 = _this->c;		HX_STACK_VAR(tmp24,"tmp24");
					HX_STACK_LINE(96)
					Float tmp25 = (_this->ty - point->y);		HX_STACK_VAR(tmp25,"tmp25");
					HX_STACK_LINE(96)
					Float tmp26 = (tmp24 * tmp25);		HX_STACK_VAR(tmp26,"tmp26");
					HX_STACK_LINE(96)
					Float tmp27 = _this->d;		HX_STACK_VAR(tmp27,"tmp27");
					HX_STACK_LINE(96)
					Float tmp28 = (point->x - _this->tx);		HX_STACK_VAR(tmp28,"tmp28");
					HX_STACK_LINE(96)
					...
					HX_STACK_LINE(96)
					Float px = tmp31;		HX_STACK_VAR(px,"px");
					HX_STACK_LINE(96)
					Float tmp32 = (Float(((Float)1.0)) / Float(norm));		HX_STACK_VAR(tmp32,"tmp32");
					HX_STACK_LINE(96)
					Float tmp33 = _this->a;		HX_STACK_VAR(tmp33,"tmp33");
					HX_STACK_LINE(96)
					Float tmp34 = (point->y - _this->ty);		HX_STACK_VAR(tmp34,"tmp34");
					HX_STACK_LINE(96)
					Float tmp35 = (tmp33 * tmp34);		HX_STACK_VAR(tmp35,"tmp35");
					HX_STACK_LINE(96)
					Float tmp36 = _this->b;		HX_STACK_VAR(tmp36,"tmp36");
					HX_STACK_LINE(96)
					Float tmp37 = (_this->tx - point->x);		HX_STACK_VAR(tmp37,"tmp37");
					HX_STACK_LINE(96)
			...
			HX_STACK_LINE(98)
			::openfl::geom::Rectangle tmp18 = this->__scrollRect;		HX_STACK_VAR(tmp18,"tmp18");
			HX_STACK_LINE(98)
			::openfl::geom::Point tmp19 = point;		HX_STACK_VAR(tmp19,"tmp19");
			HX_STACK_LINE(98)
			bool tmp20 = tmp18->containsPoint(tmp19);		HX_STACK_VAR(tmp20,"tmp20");
			HX_STACK_LINE(98)
			bool tmp21 = !(tmp20);		HX_STACK_VAR(tmp21,"tmp21");
			HX_STACK_LINE(98)
			if ((tmp21)){
		...
		Float tmp16 = y;		HX_STACK_VAR(tmp16,"tmp16");
		HX_STACK_LINE(106)
		bool tmp17 = shapeFlag;		HX_STACK_VAR(tmp17,"tmp17");
		HX_STACK_LINE(106)
		bool tmp18 = interactiveOnly;		HX_STACK_VAR(tmp18,"tmp18");
		HX_STACK_LINE(106)
		::openfl::display::DisplayObject tmp19 = hitObject;		HX_STACK_VAR(tmp19,"tmp19");
		HX_STACK_LINE(106)
		bool tmp20 = this->super::__hitTest(tmp15,tmp16,tmp17,stack,tmp18,tmp19);		HX_STACK_VAR(tmp20,"tmp20");
		HX_STACK_LINE(106)
		if ((tmp20)){
			HX_STACK_LINE(108)
			...
			if ((tmp27)){
				HX_STACK_LINE(110)
				::openfl::display::Graphics tmp29 = this->__graphics;		HX_STACK_VAR(tmp29,"tmp29");
				HX_STACK_LINE(110)
				::openfl::display::Graphics tmp30 = tmp29;		HX_STACK_VAR(tmp30,"tmp30");
				HX_STACK_LINE(110)
				::openfl::display::Graphics tmp31 = tmp30;		HX_STACK_VAR(tmp31,"tmp31");
				HX_STACK_LINE(110)
				tmp28 = (tmp31 != null());
			}
			else{
			...
			if ((tmp28)){
				HX_STACK_LINE(110)
				::openfl::display::Graphics tmp30 = this->__graphics;		HX_STACK_VAR(tmp30,"tmp30");
				HX_STACK_LINE(110)
				::openfl::display::Graphics tmp31 = tmp30;		HX_STACK_VAR(tmp31,"tmp31");
				HX_STACK_LINE(110)
				...
				HX_STACK_LINE(110)
				bool tmp34 = shapeFlag;		HX_STACK_VAR(tmp34,"tmp34");
				HX_STACK_LINE(110)
				::openfl::geom::Matrix tmp35 = this->__getRenderTransform();		HX_STACK_VAR(tmp35,"tmp35");
				HX_STACK_LINE(110)
				::openfl::geom::Matrix tmp36 = tmp35;		HX_STACK_VAR(tmp36,"tmp36");
				HX_STACK_LINE(110)
				Float tmp37 = tmp32;		HX_STACK_VAR(tmp37,"tmp37");
				HX_STACK_LINE(110)
				Float tmp38 = tmp33;		HX_STACK_VAR(tmp38,"tmp38");
				HX_STACK_LINE(110)
				bool tmp39 = tmp34;		HX_STACK_VAR(tmp39,"tmp39");
				HX_STACK_LINE(110)
				::openfl::geom::Matrix tmp40 = tmp36;		HX_STACK_VAR(tmp40,"tmp40");
				HX_STACK_LINE(110)
			...
			if ((tmp29)){
				HX_STACK_LINE(112)
				bool tmp30 = (stack != null());		HX_STACK_VAR(tmp30,"tmp30");
				HX_STACK_LINE(112)
				if ((tmp30)){
					HX_STACK_LINE(114)
					::openfl::display::DisplayObject tmp31 = hitObject;		HX_STACK_VAR(tmp31,"tmp31");
					HX_STACK_LINE(114)
					stack->push(tmp31);
				}
				HX_STACK_LINE(118)
...
bool Sprite_obj::__hitTestMask( Float x,Float y){
	...
	if ((tmp2)){
		...
		if ((tmp4)){
			...
			HX_STACK_LINE(135)
			::openfl::geom::Matrix tmp10 = this->__getRenderTransform();		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(135)
...
bool Sprite_obj::get_tabEnabled( ){
	HX_STACK_FRAME("openfl.display.Sprite","get_tabEnabled",0x5c66fc94,"openfl.display.Sprite.get_tabEnabled","openfl/display/Sprite.hx",166,0xd5438ced)
	HX_STACK_THIS(this)
	HX_STACK_LINE(168)
