...
{
		HX_STACK_FRAME("openfl.display.Preloader","start",0xb00e4140,"openfl.display.Preloader.start","openfl/display/Preloader.hx",41,0xc399db74)
		HX_STACK_THIS(this)
		HX_STACK_LINE(43)
...
{
		HX_STACK_FRAME("openfl.display.Preloader","update",0xdd75fb6b,"openfl.display.Preloader.update","openfl/display/Preloader.hx",57,0xc399db74)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("openfl.display.Preloader","display_onComplete",0x4bd0fb77,"openfl.display.Preloader.display_onComplete","openfl/display/Preloader.hx",75,0xc399db74)
		HX_STACK_THIS(this)
