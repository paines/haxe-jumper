...
::String Path_obj::toString( ){
	HX_STACK_FRAME("haxe.io.Path","toString",0xc0ab5735,"haxe.io.Path.toString","/usr/share/haxe/std/haxe/io/Path.hx",114,0x457392de)
	HX_STACK_THIS(this)
	HX_STACK_LINE(115)
...
::String Path_obj::withoutDirectory( ::String path){
	HX_STACK_FRAME("haxe.io.Path","withoutDirectory",0xdf35ce8e,"haxe.io.Path.withoutDirectory","/usr/share/haxe/std/haxe/io/Path.hx",134,0x457392de)
	HX_STACK_ARG(path,"path")
	HX_STACK_LINE(135)
...
::String Path_obj::extension( ::String path){
	HX_STACK_FRAME("haxe.io.Path","extension",0x91c9c4d6,"haxe.io.Path.extension","/usr/share/haxe/std/haxe/io/Path.hx",161,0x457392de)
	HX_STACK_ARG(path,"path")
	HX_STACK_LINE(162)
	::haxe::io::Path tmp = ::haxe::io::Path_obj::__new(path);		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(162)
...
::String Path_obj::addTrailingSlash( ::String path){
	HX_STACK_FRAME("haxe.io.Path","addTrailingSlash",0x8b4f8e69,"haxe.io.Path.addTrailingSlash","/usr/share/haxe/std/haxe/io/Path.hx",265,0x457392de)
	HX_STACK_ARG(path,"path")
	HX_STACK_LINE(266)
