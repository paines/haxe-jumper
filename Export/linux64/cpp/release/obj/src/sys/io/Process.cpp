...
int Process_obj::exitCode( ){
	HX_STACK_FRAME("sys.io.Process","exitCode",0x41e72111,"sys.io.Process.exitCode","/usr/share/haxe/std/cpp/_std/sys/io/Process.hx",111,0x2d961692)
	HX_STACK_THIS(this)
	HX_STACK_LINE(112)
	Dynamic tmp = this->p;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(112)
	int tmp1 = ::sys::io::Process_obj::_exit(tmp);		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(112)
	return tmp1;
}
...
bool Process_obj::__GetStatic(const ::String &inName, Dynamic &outValue, hx::PropertyAccess inCallProp)
{
	...
	case 4:
		...
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"_exit") ) { outValue = _exit; return true;  }
		break;
	case 6:
...
bool Process_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	...
	case 4:
		...
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"_exit") ) { _exit=ioValue.Cast< Dynamic >(); return true; }
		break;
	case 6:
...
static hx::StaticInfo sStaticStorageInfo[] = {
	...
	{hx::fsObject /*Dynamic*/ ,(void *) &Process_obj::_exit,HX_HCSTRING("_exit","\xfd","\x12","\x2f","\xf6")},
...
static ::String sStaticFields[] = {
	...
	HX_HCSTRING("_exit","\xfd","\x12","\x2f","\xf6"),
...
void Process_obj::__boot()
{
	...
	_exit= ::cpp::Lib_obj::load(HX_HCSTRING("std","\xa3","\xa8","\x57","\x00"),HX_HCSTRING("process_exit","\x2e","\x3e","\xb6","\x4a"),(int)1);
