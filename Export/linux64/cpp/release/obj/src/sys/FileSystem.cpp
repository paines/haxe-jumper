...
{
		HX_STACK_FRAME("sys.FileSystem","createDirectory",0x63bad3cf,"sys.FileSystem.createDirectory","/usr/share/haxe/std/cpp/_std/sys/FileSystem.hx",74,0xcabeeced)
		HX_STACK_ARG(path,"path")
		HX_STACK_LINE(75)
		::String tmp = path;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(75)
...
{
		HX_STACK_FRAME("sys.FileSystem","deleteFile",0x4bd48509,"sys.FileSystem.deleteFile","/usr/share/haxe/std/cpp/_std/sys/FileSystem.hx",88,0xcabeeced)
		HX_STACK_ARG(path,"path")
		HX_STACK_LINE(89)
		::String tmp = path;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(89)
...
{
		HX_STACK_FRAME("sys.FileSystem","deleteDirectory",0x052a5cc0,"sys.FileSystem.deleteDirectory","/usr/share/haxe/std/cpp/_std/sys/FileSystem.hx",93,0xcabeeced)
		HX_STACK_ARG(path,"path")
		HX_STACK_LINE(94)
		::String tmp = path;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(94)
