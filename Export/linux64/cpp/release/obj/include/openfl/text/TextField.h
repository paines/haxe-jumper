...
class HXCPP_CLASS_ATTRIBUTES  TextField_obj : public ::openfl::display::InteractiveObject_obj{
	...
	public:
		...
		static ::EReg __regexAlign;
		static ::EReg __regexColor;
		static ::EReg __regexBlockIndent;
		static ::EReg __regexBreakTag;
		static Array< ::Dynamic > __regexEntities;
		static ::EReg __regexFace;
		static ::EReg __regexHTMLTag;
		static ::EReg __regexIndent;
		static ::EReg __regexLeading;
		static ::EReg __regexLeftMargin;
		static ::EReg __regexRightMargin;
		static ::EReg __regexTabStops;
		static ::EReg __regexSize;
		...
		virtual ::String __getAttributeMatch( ::EReg regex);
		Dynamic __getAttributeMatch_dyn();
		...
		virtual Void __updateText( ::String value);
		Dynamic __updateText_dyn();
		...
		virtual bool get_mouseWheelEnabled( );
		Dynamic get_mouseWheelEnabled_dyn();

		virtual bool set_mouseWheelEnabled( bool value);
