...
class HXCPP_CLASS_ATTRIBUTES  ColorMatrix_Impl__obj : public hx::Object{
	...
	public:
		...
		static void __boot();
		static ::lime::utils::ArrayBufferView __alphaTable;
		static ::lime::utils::ArrayBufferView __blueTable;
		static ::lime::utils::ArrayBufferView __greenTable;
		static Array< Float > __identity;
		static ::lime::utils::ArrayBufferView __redTable;
